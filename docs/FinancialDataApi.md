...
# **get_statement_file**
> file get_statement_file(consent, account_id, statement_id, raw=raw)
...
# **get_statements**
> ApiListResponseOfAccountStatement get_statements(consent, account_id, _from=_from, before=before, limit=limit, sort=sort, offset=offset, raw=raw)
...
# **get_transactions**
> ApiListResponseOfTransaction get_transactions(account_id, consent, psu_id=psu_id, psu_corporate_id=psu_corporate_id, psu_ip_address=psu_ip_address, _with=_with, _from=_from, before=before, limit=limit, sort=sort, offset=offset, cursor=cursor, raw=raw)
