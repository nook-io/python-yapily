...
class PaymentEmbeddedAuthorisationRequestResponse(BaseModel):
    ...
    id: Annotated[
        StrictStr | None, Field(description="Unique identifier for the embedded payment authorisation request.")
    ] = None
    user_uuid: Annotated[
        StrictStr | None,
    ...
    created_at: Annotated[
        datetime | None,
        Field(alias="createdAt", description="Date and time the embedded payment authorisation was created."),
    ] = None
    ...
    sca_methods: Annotated[list[ScaMethod] | None, Field(alias="scaMethods")] = None
