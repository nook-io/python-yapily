...
class PaymentEmbeddedAuthorisationRequestResponse(BaseModel):
    ...
    """
    id: Optional[StrictStr] = Field(None, description="Unique identifier for the embedded payment authorisation request.")
    ...
    created_at: Optional[datetime] = Field(None, alias="createdAt", description="Date and time the embedded payment authorisation was created.")
