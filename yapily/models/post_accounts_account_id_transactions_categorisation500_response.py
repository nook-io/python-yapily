...
class PostAccountsAccountIdTransactionsCategorisation500Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: dict) -> "PostAccountsAccountIdTransactionsCategorisation500Response":
        ...
        if not isinstance(obj, dict):
            return PostAccountsAccountIdTransactionsCategorisation500Response.model_validate(obj)

        return PostAccountsAccountIdTransactionsCategorisation500Response.model_validate(
            {
