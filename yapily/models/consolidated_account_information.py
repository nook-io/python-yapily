...
class ConsolidatedAccountInformation(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ConsolidatedAccountInformation":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ConsolidatedAccountInformation":
        """Create an instance of ConsolidatedAccountInformation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ConsolidatedAccountInformation.model_validate(obj)

        return ConsolidatedAccountInformation.model_validate(
            {
                "id": obj.get("id"),
