...
class Country(BaseModel):
    ...
    """
    display_name: Optional[StrictStr] = Field(None, alias="displayName", description="Country name.")
    country_code2: Optional[StrictStr] = Field(None, alias="countryCode2", description="Two character ISO 3166 country code.")
