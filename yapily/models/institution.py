...
class Institution(BaseModel):
    ...
    Institution
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The Yapily Id for the `Institution`")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "fullName", "countries", "environmentType", "credentialsType", "media", "features", "monitoring"]
