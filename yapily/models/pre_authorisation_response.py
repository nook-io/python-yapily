...
class PreAuthorisationResponse(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the pre-authorisation request.")
    ...
    state: Optional[StrictStr] = Field(default=None, description="Corellation ID used with the `Institution` during the authorisation process.")
    ...
    __properties: ClassVar[List[str]] = ["id", "userUuid", "applicationUserId", "referenceId", "institutionId", "status", "createdAt", "transactionFrom", "transactionTo", "expiresAt", "timeToExpireInMillis", "timeToExpire", "featureScope", "consentToken", "state", "authorizedAt", "institutionConsentId", "authorisationUrl", "qrCodeUrl"]
