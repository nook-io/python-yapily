...
class PreAuthorisationResponse(BaseModel):
    ...
    state: Annotated[StrictStr | None, Field(description='Corellation ID used with the `Institution` during the authorisation process.')] = None
    ...
    qr_code_url: Annotated[StrictStr | None, Field(alias='qrCodeUrl', description='The URL link for the QR code that may be scanned via a mobile device to make a authorisation redirect to the bank (authURL encoded).')] = None
    __properties = [
        "id",
        "userUuid",
        "applicationUserId",
