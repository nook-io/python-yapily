...
class ApiListResponseOfVirtualAccountPayment(BaseModel):
    """
    ApiListResponseOfVirtualAccountPayment
    """
    meta: Optional[ResponseListMeta] = None
    links: Optional[Links] = None
    data: Optional[conlist(VirtualAccountPayment)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiListResponseOfVirtualAccountPayment:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiListResponseOfVirtualAccountPayment:
        """Create an instance of ApiListResponseOfVirtualAccountPayment from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiListResponseOfVirtualAccountPayment.parse_obj(obj)

        _obj = ApiListResponseOfVirtualAccountPayment.parse_obj({
            ...
            "data": [VirtualAccountPayment.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
