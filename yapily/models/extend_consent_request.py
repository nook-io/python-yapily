...
class ExtendConsentRequest(BaseModel):
    ...
    """
    last_confirmed_at: datetime = Field(..., alias="lastConfirmedAt", description="__Mandatory__. The time that the user confirmed access to their account information")
    ...
    def from_dict(cls, obj: dict) -> ExtendConsentRequest:
        ...
        _obj = ExtendConsentRequest.parse_obj({
