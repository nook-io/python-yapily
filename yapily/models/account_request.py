...
class AccountRequest(BaseModel):
    ...
    """ # noqa: E501
    transaction_from: Optional[datetime] = Field(default=None, description="__Optional__. Specifies the earliest date of the transaction records to be returned.<br><br> You must supply this field to retrieve transactions older than 90 days for banks accessed via the the [CBI Globe Gateway](https://docs.yapily.com/pages/data/financial-data-resources/data-restrictions/#cbi-globe-gateway).", alias="transactionFrom")
    transaction_to: Optional[datetime] = Field(default=None, description="__Optional__. Specifies the latest date of the transaction records to be returned.", alias="transactionTo")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.account_identifiers_for_transaction:
            for _item_account_identifiers_for_transaction in self.account_identifiers_for_transaction:
        ...
        if self.account_identifiers_for_balance:
            for _item_account_identifiers_for_balance in self.account_identifiers_for_balance:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "accountIdentifiers": AccountInfo.from_dict(obj["accountIdentifiers"]) if obj.get("accountIdentifiers") is not None else None,
            "accountIdentifiersForTransaction": [AccountInfo.from_dict(_item) for _item in obj["accountIdentifiersForTransaction"]] if obj.get("accountIdentifiersForTransaction") is not None else None,
            "accountIdentifiersForBalance": [AccountInfo.from_dict(_item) for _item in obj["accountIdentifiersForBalance"]] if obj.get("accountIdentifiersForBalance") is not None else None,
