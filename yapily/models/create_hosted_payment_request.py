...
class CreateHostedPaymentRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["userId", "applicationUserId", "institutionIdentifiers", "userSettings", "redirectUrl", "paymentRequestDetails"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "paymentRequestDetails": HostedPaymentRequestDetails.from_dict(obj["paymentRequestDetails"]) if obj.get("paymentRequestDetails") is not None else None
        })
        return _obj
