...
class RequestConstraints(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "headers": ModelSchema.from_dict(obj["headers"]) if obj.get("headers") is not None else None,
            "body": ModelSchema.from_dict(obj["body"]) if obj.get("body") is not None else None
        })
        return _obj
