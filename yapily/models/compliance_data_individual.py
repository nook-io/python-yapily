...
class ComplianceDataIndividual(BaseModel):
    ...
    """
    name: StrictStr = Field(..., description="This is the first and last name of your end user.")
    birth_date: date = Field(..., alias="birthDate", description="This is the date of birth of your end user.")
    ...
    def from_dict(cls, obj: dict) -> ComplianceDataIndividual:
        ...
        _obj = ComplianceDataIndividual.parse_obj({
            "name": obj.get("name"),
