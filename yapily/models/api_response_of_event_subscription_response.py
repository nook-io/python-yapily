...
class ApiResponseOfEventSubscriptionResponse(BaseModel):
    ...
    data: EventSubscriptionResponse | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiResponseOfEventSubscriptionResponse":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiResponseOfEventSubscriptionResponse":
        """Create an instance of ApiResponseOfEventSubscriptionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfEventSubscriptionResponse.model_validate(obj)

        return ApiResponseOfEventSubscriptionResponse.model_validate(
            {
                "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
                "data": EventSubscriptionResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None,
                "links": obj.get("links"),
