...
class IsoBankTransactionCode(BaseModel):
    ...
    """
    domain_code: Optional[IsoCodeDetails] = Field(None, alias="domainCode")
    family_code: Optional[IsoCodeDetails] = Field(None, alias="familyCode")
    sub_family_code: Optional[IsoCodeDetails] = Field(None, alias="subFamilyCode")
    ...
    def from_dict(cls, obj: dict) -> IsoBankTransactionCode:
        ...
        _obj = IsoBankTransactionCode.parse_obj({
            "domain_code": IsoCodeDetails.from_dict(obj.get("domainCode")) if obj.get("domainCode") is not None else None,
            "family_code": IsoCodeDetails.from_dict(obj.get("familyCode")) if obj.get("familyCode") is not None else None,
            "sub_family_code": IsoCodeDetails.from_dict(obj.get("subFamilyCode")) if obj.get("subFamilyCode") is not None else None
        })
        return _obj
