...
class IsoBankTransactionCode(BaseModel):
    ...
    sub_family_code: Optional[IsoCodeDetails] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "domainCode": IsoCodeDetails.from_dict(obj["domainCode"])
                if obj.get("domainCode") is not None
                else None,
                "familyCode": IsoCodeDetails.from_dict(obj["familyCode"])
                if obj.get("familyCode") is not None
                else None,
                "subFamilyCode": IsoCodeDetails.from_dict(obj["subFamilyCode"])
