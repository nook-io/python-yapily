...
class ApiResponseOfVirtualAccountPayInDetails(BaseModel):
    """
    ApiResponseOfVirtualAccountPayInDetails
    """
    meta: Optional[ResponseMeta] = None
    links: Optional[Dict[str, StrictStr]] = None
    data: Optional[VirtualAccountPayInDetails] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiResponseOfVirtualAccountPayInDetails:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiResponseOfVirtualAccountPayInDetails:
        """Create an instance of ApiResponseOfVirtualAccountPayInDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfVirtualAccountPayInDetails.parse_obj(obj)

        _obj = ApiResponseOfVirtualAccountPayInDetails.parse_obj({
            "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "links": obj.get("links"),
            "data": VirtualAccountPayInDetails.from_dict(obj.get("data")) if obj.get("data") is not None else None,
