...
class RegisterWebhookRequest(BaseModel):
    ...
    """ # noqa: E501
    application_id: StrictStr = Field(description="user application id", alias="applicationId")
    categories: List[StrictStr]
    callback_url: RegisterWebhookRequestCallbackUrl = Field(alias="callbackUrl")
    metadata: Optional[Dict[str, StrictStr]] = None
    __properties: ClassVar[List[str]] = ["applicationId", "categories", "callbackUrl", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "callbackUrl": RegisterWebhookRequestCallbackUrl.from_dict(obj["callbackUrl"]) if obj.get("callbackUrl") is not None else None,
