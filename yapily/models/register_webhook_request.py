...
class RegisterWebhookRequest(BaseModel):
    ...
    """
    application_id: StrictStr = Field(..., alias="applicationId", description="user application id")
    ...
    def from_dict(cls, obj: dict) -> RegisterWebhookRequest:
        ...
        _obj = RegisterWebhookRequest.parse_obj({
            ...
            "callback_url": RegisterWebhookRequestCallbackUrl.from_dict(obj.get("callbackUrl")) if obj.get("callbackUrl") is not None else None,
