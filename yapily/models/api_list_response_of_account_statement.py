...
class ApiListResponseOfAccountStatement(BaseModel):
    ...
    data: list[AccountStatement] | None = None
    ...
    paging: FilteredClientPayloadListAccountStatement | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiListResponseOfAccountStatement":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiListResponseOfAccountStatement":
        """Create an instance of ApiListResponseOfAccountStatement from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiListResponseOfAccountStatement.model_validate(obj)

        return ApiListResponseOfAccountStatement.model_validate(
            {
                "meta": ResponseListMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
                "data": [AccountStatement.from_dict(_item) for _item in obj.get("data")]
                ...
                "paging": FilteredClientPayloadListAccountStatement.from_dict(obj.get("paging"))
