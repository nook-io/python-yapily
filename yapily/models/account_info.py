...
class AccountInfo(BaseModel):
    ...
    """ # noqa: E501
    account_id: StrictStr = Field(description="__Mandatory__. Unique identifier of the account.", alias="accountId")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "accountIdentification": AccountIdentification.from_dict(obj.get("accountIdentification")) if obj.get("accountIdentification") is not None else None
        })
        return _obj
