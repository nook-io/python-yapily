...
class AccountInfo(BaseModel):
    ...
    """ # noqa: E501
    account_id: Optional[StrictStr] = Field(default=None, description="__Conditional__. Unique identifier of the account.", alias="accountId")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "accountIdentification": AccountIdentification.from_dict(obj["accountIdentification"]) if obj.get("accountIdentification") is not None else None
        })
        return _obj
