...
class AccountInfo(object):
    ...
    def account_id(self):
        ...
        __Mandatory__. The `Institution` account identifier for the account  # noqa: E501
    ...
    def account_identification(self, account_identification):
        ...
        """
        if self.local_vars_configuration.client_side_validation and account_identification is None:  # noqa: E501
            raise ValueError("Invalid value for `account_identification`, must not be `None`")  # noqa: E501
