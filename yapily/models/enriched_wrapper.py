...
class EnrichedWrapper(BaseModel):
    ...
    """
    income_streams: conlist(TransactionStream) = Field(..., alias="incomeStreams", description="Lists all possible income streams identified for the `Application User`.")
    expenditure_streams: conlist(TransactionStream) = Field(..., alias="expenditureStreams", description="Lists all possible expenditure streams identified for the `Application User`.")
