...
class FilteredClientPayloadListFeatureDetails(BaseModel):
    ...
    data: Optional[conlist(FeatureDetails)] = None
    ...
    def from_dict(cls, obj: dict) -> FilteredClientPayloadListFeatureDetails:
        ...
        _obj = FilteredClientPayloadListFeatureDetails.parse_obj({
            "api_call": obj.get("apiCall"),
            "data": [FeatureDetails.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
