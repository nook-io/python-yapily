...
class ExchangeRateInformationResponse(BaseModel):
    ...
    exchange_rate_expiry_date: Optional[datetime] = Field(default=None, alias="exchangeRateExpiryDate")
    __properties: ClassVar[List[str]] = ["unitCurrency", "rate", "rateType", "foreignExchangeContractReference", "exchangeRateExpiryDate"]
