...
class ExchangeRateInformationResponse(object):
    ...
    def __init__(self, unit_currency=None, rate=None, rate_type=None, foreign_exchange_contract_reference=None, exchange_rate_expiry_date=None, local_vars_configuration=None):  # noqa: E501
