...
class ApiListResponseOfEventSubscriptionResponse(BaseModel):
    ...
    data: Optional[conlist(EventSubscriptionResponse)] = None
    ...
    def from_dict(cls, obj: dict) -> ApiListResponseOfEventSubscriptionResponse:
        ...
        _obj = ApiListResponseOfEventSubscriptionResponse.parse_obj({
            "meta": ResponseListMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [EventSubscriptionResponse.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
            "links": obj.get("links"),
            ...
            "paging": FilteredClientPayloadListTransaction.from_dict(obj.get("paging")) if obj.get("paging") is not None else None,
