...
class ApiListResponseOfEventSubscriptionResponse(BaseModel):
    """
    ApiListResponseOfEventSubscriptionResponse
    """

    meta: ResponseListMeta | None = None
    data: list[EventSubscriptionResponse] | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiListResponseOfEventSubscriptionResponse":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiListResponseOfEventSubscriptionResponse":
        """Create an instance of ApiListResponseOfEventSubscriptionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiListResponseOfEventSubscriptionResponse.model_validate(obj)

        return ApiListResponseOfEventSubscriptionResponse.model_validate(
            {
                "meta": ResponseListMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
                "data": [EventSubscriptionResponse.from_dict(_item) for _item in obj.get("data")]
                ...
                "paging": FilteredClientPayloadListTransaction.from_dict(obj.get("paging"))
