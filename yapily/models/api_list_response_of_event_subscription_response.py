...
class ApiListResponseOfEventSubscriptionResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [EventSubscriptionResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "links": obj.get("links"),
            ...
            "paging": FilteredClientPayloadListTransaction.from_dict(obj["paging"]) if obj.get("paging") is not None else None,
