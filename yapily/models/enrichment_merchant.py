...
class EnrichmentMerchant(BaseModel):
    ...
    """ # noqa: E501
    merchant_name: Optional[StrictStr] = Field(default=None, description="The name of the indivdual merchant involved in the transaction e.g. (TESCO Petrol).", alias="merchantName")
    parent_group: Optional[StrictStr] = Field(default=None, description="The parent organisation that the merchant belongs to e.g. (TESCO).", alias="parentGroup")
