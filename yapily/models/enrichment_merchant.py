...
class EnrichmentMerchant(BaseModel):
    ...
    """
    merchant_name: Optional[StrictStr] = Field(None, alias="merchantName", description="The name of the indivdual merchant involved in the transaction e.g. (TESCO Petrol).")
    parent_group: Optional[StrictStr] = Field(None, alias="parentGroup", description="The parent organisation that the merchant belongs to e.g. (TESCO).")
