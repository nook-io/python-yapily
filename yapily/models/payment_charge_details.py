...
class PaymentChargeDetails(BaseModel):
    ...
    charge_to: Annotated[
        StrictStr | None,
        Field(alias="chargeTo", description="__Mandatory__. States which party of the payment bears the charges."),
    ] = None
    ...
    def from_dict(cls, obj: dict) -> "PaymentChargeDetails":
        ...
        if not isinstance(obj, dict):
            return PaymentChargeDetails.model_validate(obj)

        return PaymentChargeDetails.model_validate(
            {
