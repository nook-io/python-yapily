...
class PaymentChargeDetails(BaseModel):
    ...
    charge_type: Optional[StrictStr] = Field(None, alias="chargeType", description="Type of charge")
    charge_to: Optional[StrictStr] = Field(None, alias="chargeTo", description="Charge bearer")
