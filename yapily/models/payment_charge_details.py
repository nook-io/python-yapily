...
class PaymentChargeDetails(BaseModel):
    ...
    charge_type: Optional[StrictStr] = Field(default=None, description="__Mandatory__. Specifies the nature of the transaction charge e.g. (Bank transfer fees).", alias="chargeType")
    charge_to: Optional[StrictStr] = Field(default=None, description="__Mandatory__. States which party of the payment bears the charges.", alias="chargeTo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chargeAmount": Amount.from_dict(obj["chargeAmount"]) if obj.get("chargeAmount") is not None else None,
