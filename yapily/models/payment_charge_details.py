...
class PaymentChargeDetails(BaseModel):
    ...
    """
    charge_amount: Optional[Amount] = Field(None, alias="chargeAmount")
    charge_type: Optional[StrictStr] = Field(None, alias="chargeType", description="__Mandatory__. Specifies the nature of the transaction charge e.g. (Bank transfer fees).")
    charge_to: Optional[StrictStr] = Field(None, alias="chargeTo", description="__Mandatory__. States which party of the payment bears the charges.")
    ...
    def from_dict(cls, obj: dict) -> PaymentChargeDetails:
        ...
        _obj = PaymentChargeDetails.parse_obj({
            "charge_amount": Amount.from_dict(obj.get("chargeAmount")) if obj.get("chargeAmount") is not None else None,
