...
class MultiAuthorisation(BaseModel):
    ...
    number_of_authorisation_required: Optional[StrictInt] = Field(None, alias="numberOfAuthorisationRequired")
    number_of_authorisation_received: Optional[StrictInt] = Field(None, alias="numberOfAuthorisationReceived")
    last_updated_date_time: Optional[datetime] = Field(None, alias="lastUpdatedDateTime")
