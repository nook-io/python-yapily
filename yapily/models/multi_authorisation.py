...
class MultiAuthorisation(BaseModel):
    ...
    number_of_authorisation_required: Optional[StrictInt] = Field(default=None, alias="numberOfAuthorisationRequired")
    number_of_authorisation_received: Optional[StrictInt] = Field(default=None, alias="numberOfAuthorisationReceived")
    last_updated_date_time: Optional[datetime] = Field(default=None, alias="lastUpdatedDateTime")
    expiration_date_time: Optional[datetime] = Field(default=None, alias="expirationDateTime")
