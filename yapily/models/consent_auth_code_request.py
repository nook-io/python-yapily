...
class ConsentAuthCodeRequest(BaseModel):
    ...
    """
    auth_code: StrictStr = Field(..., alias="authCode", description="__Mandatory__. The authorisation code")
    auth_state: StrictStr = Field(..., alias="authState", description="__Mandatory__. The authorisation state")
