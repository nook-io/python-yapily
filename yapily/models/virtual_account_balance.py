...
class VirtualAccountBalance(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VirtualAccountBalance:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VirtualAccountBalance:
        """Create an instance of VirtualAccountBalance from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VirtualAccountBalance.parse_obj(obj)

        _obj = VirtualAccountBalance.parse_obj({
            "type": obj.get("type"),
