...
class OneTimeTokenRequest(BaseModel):
    ...
    """
    one_time_token: StrictStr = Field(..., alias="oneTimeToken", description="__Mandatory__. The one time token to exchange for a consent token.")
    ...
    def from_dict(cls, obj: dict) -> OneTimeTokenRequest:
        ...
        _obj = OneTimeTokenRequest.parse_obj({
