...
class AccountBalance(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "balanceAmount": Amount.from_dict(obj["balanceAmount"]) if obj.get("balanceAmount") is not None else None,
            "creditLineIncluded": obj.get("creditLineIncluded"),
            "creditLines": [CreditLine.from_dict(_item) for _item in obj["creditLines"]] if obj.get("creditLines") is not None else None
        })
        return _obj
