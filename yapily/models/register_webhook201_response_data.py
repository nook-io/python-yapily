...
class RegisterWebhook201ResponseData(BaseModel):
    ...
    webhook_secret: Optional[StrictStr] = Field(None, alias="webhookSecret", description="HMAC secret needed to validate that the request payload is genuine")
    ...
    def from_dict(cls, obj: dict) -> RegisterWebhook201ResponseData:
        ...
        _obj = RegisterWebhook201ResponseData.parse_obj({
            "id": obj.get("id"),
