...
class EnrichedTransaction(BaseModel):
    ...
    """
    transaction_id: Optional[StrictStr] = Field(None, alias="transactionId", description="Unique identifier of the transaction")
    ...
    institution: Optional[StrictStr] = Field(None, description="The `Institution` that the transaction is sent to.")
    booking_date_time: Optional[datetime] = Field(None, alias="bookingDateTime", description="Date and time of when a transaction entry occured and was posted to the account servicer's books.")
