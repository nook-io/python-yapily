...
class GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerEnrichmentTransactionHash(BaseModel):
    ...
    def from_dict(
        ...
        if not isinstance(obj, dict):
            return (
                GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerEnrichmentTransactionHash.model_validate(
                    obj
                )
            )

        return GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerEnrichmentTransactionHash.model_validate(
            {"hash": obj.get("hash")}
        )
