...
class ProfileConsent(BaseModel):
    ...
    """
    id: Optional[StrictStr] = Field(None, description="Unique identifier of the `consent` in context of a user's profile.")
    ...
    reference_consent_id: Optional[StrictStr] = Field(None, alias="referenceConsentId", description="Unique identifier of the consent.")
