...
class NonSweepingAuthorisationResponse(BaseModel):
    ...
    control_parameters: Optional[NonSweepingControlParameters] = Field(default=None, alias="controlParameters")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "controlParameters": NonSweepingControlParameters.from_dict(obj["controlParameters"]) if obj.get("controlParameters") is not None else None,
            "payer": Payer.from_dict(obj["payer"]) if obj.get("payer") is not None else None,
            "initiationDetails": InitiationDetails.from_dict(obj["initiationDetails"]) if obj.get("initiationDetails") is not None else None
        })
        return _obj
