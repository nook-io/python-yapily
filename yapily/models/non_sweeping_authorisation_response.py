...
class NonSweepingAuthorisationResponse(BaseModel):
    ...
    control_parameters: Annotated[NonSweepingControlParameters | None, Field(alias="controlParameters")] = None
    ...
    def from_dict(cls, obj: dict) -> "NonSweepingAuthorisationResponse":
        ...
        if not isinstance(obj, dict):
            return NonSweepingAuthorisationResponse.model_validate(obj)

        return NonSweepingAuthorisationResponse.model_validate(
            {
                "id": obj.get("id"),
