...
class NonSweepingAuthorisationResponse(BaseModel):
    ...
    institution_id: Optional[StrictStr] = Field(None, alias="institutionId", description="The reference to the Institution which identifies which institution the authorisation request is sent to.")
    ...
    consent_token: Optional[StrictStr] = Field(None, alias="consentToken", description="The `consent-token` containing the user's authorisation to make the payment request.")
    ...
    qr_code_url: Optional[StrictStr] = Field(None, alias="qrCodeUrl")
    control_parameters: Optional[NonSweepingControlParameters] = Field(None, alias="controlParameters")
    payer: Optional[Payer] = None
    initiation_details: Optional[InitiationDetails] = Field(None, alias="initiationDetails")
    __properties = ["id", "userId", "applicationUserId", "institutionId", "status", "createdAt", "featureScope", "consentToken", "state", "authorizedAt", "institutionConsentId", "authorisationUrl", "qrCodeUrl", "controlParameters", "payer", "initiationDetails"]
    ...
    def from_dict(cls, obj: dict) -> NonSweepingAuthorisationResponse:
        ...
        _obj = NonSweepingAuthorisationResponse.parse_obj({
            ...
            "control_parameters": NonSweepingControlParameters.from_dict(obj.get("controlParameters")) if obj.get("controlParameters") is not None else None,
