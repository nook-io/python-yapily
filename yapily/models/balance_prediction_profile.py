...
class BalancePredictionProfile(BaseModel):
    ...
    """
    status: Optional[StrictStr] = Field(None, description="The status, will be COMPLETED which represents successful retreival of profile.")
    profile_consents: Optional[conlist(ProfileConsent)] = Field(None, alias="profileConsents", description="A list of ProfileConsents used in the Balance Prediction profile.")
    enriched_balances: Optional[conlist(EnrichedBalances)] = Field(None, alias="enrichedBalances", description="A list of Balances returned by Balance Prediction profile.")
    ...
    def from_dict(cls, obj: dict) -> BalancePredictionProfile:
        ...
        _obj = BalancePredictionProfile.parse_obj({
            ...
            "enriched_balances": [EnrichedBalances.from_dict(_item) for _item in obj.get("enrichedBalances")] if obj.get("enrichedBalances") is not None else None
        })
        return _obj
