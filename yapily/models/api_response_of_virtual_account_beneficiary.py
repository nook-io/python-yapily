...
class ApiResponseOfVirtualAccountBeneficiary(BaseModel):
    ...
    __properties = ["meta", "data", "forwardedData", "tracingId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiResponseOfVirtualAccountBeneficiary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiResponseOfVirtualAccountBeneficiary:
        """Create an instance of ApiResponseOfVirtualAccountBeneficiary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfVirtualAccountBeneficiary.parse_obj(obj)

        _obj = ApiResponseOfVirtualAccountBeneficiary.parse_obj({
