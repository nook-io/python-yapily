...
class CredentialsType(object):
    ...
    allowable_values = [OAUTH1, OAUTH2, OAUTH2_NOSECRET, OAUTH2_SIGNATURE, OPEN_BANKING_UK_MANUAL, OPEN_BANKING_UK_AUTO, OPEN_BANKING_IBM, OPEN_BANKING_AUTO, OPEN_BANKING_AUTO_EMAIL, OPEN_BANKING_MANUAL, OPEN_BANKING_WITH_TPP_ID_AND_SECRET, API_KEY, OPEN_BANKING_NO_KEY, OPEN_BANKING_NO_TRANSPORT, TOKEN_IO]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """CredentialsType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CredentialsType):
            return False
