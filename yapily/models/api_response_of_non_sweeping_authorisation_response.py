...
class ApiResponseOfNonSweepingAuthorisationResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ApiResponseOfNonSweepingAuthorisationResponse:
        ...
        _obj = ApiResponseOfNonSweepingAuthorisationResponse.parse_obj({
            "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": NonSweepingAuthorisationResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "links": obj.get("links"),
