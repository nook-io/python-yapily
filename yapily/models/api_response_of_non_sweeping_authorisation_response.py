...
class ApiResponseOfNonSweepingAuthorisationResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiResponseOfNonSweepingAuthorisationResponse":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiResponseOfNonSweepingAuthorisationResponse":
        """Create an instance of ApiResponseOfNonSweepingAuthorisationResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfNonSweepingAuthorisationResponse.model_validate(obj)

        return ApiResponseOfNonSweepingAuthorisationResponse.model_validate(
            {
