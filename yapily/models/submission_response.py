...
class SubmissionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "paymentIdempotencyId", "paymentLifecycleId", "institutionConsentId", "status", "statusDetails", "initiationDetails", "submissionDetails", "payer", "refundAccount", "expectedExecutionTime", "expectedSettlementTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "submissionDetails": SubmissionDetails.from_dict(obj["submissionDetails"]) if obj.get("submissionDetails") is not None else None,
