...
class SubmissionResponse(BaseModel):
    ...
    __properties = ["id", "paymentIdempotencyId", "paymentLifecycleId", "institutionConsentId", "status", "statusDetails", "initiationDetails", "submissionDetails", "payer", "refundAccount", "expectedExecutionTime", "expectedSettlementTime"]
    ...
    def from_dict(cls, obj: dict) -> SubmissionResponse:
        ...
        _obj = SubmissionResponse.parse_obj({
            ...
            "submission_details": SubmissionDetails.from_dict(obj.get("submissionDetails")) if obj.get("submissionDetails") is not None else None,
