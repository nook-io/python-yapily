...
class TransactionPayeeDetails(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The account holder name of the Payee.")
    account_identifications: Optional[List[TransactionPayeeDetailsAccountIdentificationsInner]] = Field(default=None, description="The account identifications that identify the Payee's bank account.", alias="accountIdentifications")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "accountIdentifications": [TransactionPayeeDetailsAccountIdentificationsInner.from_dict(_item) for _item in obj["accountIdentifications"]] if obj.get("accountIdentifications") is not None else None
        })
        return _obj
