...
class TransactionPayeeDetails(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "TransactionPayeeDetails":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "TransactionPayeeDetails":
        """Create an instance of TransactionPayeeDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransactionPayeeDetails.model_validate(obj)

        return TransactionPayeeDetails.model_validate(
            {
                "name": obj.get("name"),
