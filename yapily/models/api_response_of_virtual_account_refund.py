...
class ApiResponseOfVirtualAccountRefund(BaseModel):
    """
    ApiResponseOfVirtualAccountRefund
    """
    meta: Optional[ResponseMeta] = None
    data: Optional[VirtualAccountRefund] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiResponseOfVirtualAccountRefund:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiResponseOfVirtualAccountRefund:
        """Create an instance of ApiResponseOfVirtualAccountRefund from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfVirtualAccountRefund.parse_obj(obj)

        _obj = ApiResponseOfVirtualAccountRefund.parse_obj({
            "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": VirtualAccountRefund.from_dict(obj.get("data")) if obj.get("data") is not None else None,
