...
class ApiResponseOfPaymentAuthorisationRequestResponse(BaseModel):
    ...
    data: PaymentAuthorisationRequestResponse | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiResponseOfPaymentAuthorisationRequestResponse":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiResponseOfPaymentAuthorisationRequestResponse":
        """Create an instance of ApiResponseOfPaymentAuthorisationRequestResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfPaymentAuthorisationRequestResponse.model_validate(obj)

        return ApiResponseOfPaymentAuthorisationRequestResponse.model_validate(
            {
                "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
                "data": PaymentAuthorisationRequestResponse.from_dict(obj.get("data"))
