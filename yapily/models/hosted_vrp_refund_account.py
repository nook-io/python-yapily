...
class HostedVrpRefundAccount(BaseModel):
    """
    ...
    account_identifications: Annotated[
        list[HostedVrpAccountIdentification] | None, Field(alias="accountIdentifications")
    ] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "HostedVrpRefundAccount":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "HostedVrpRefundAccount":
