...
class HostedVrpRefundAccount(BaseModel):
    ...
    account_identifications: Optional[conlist(HostedVrpAccountIdentification, unique_items=True)] = Field(None, alias="accountIdentifications")
    ...
    def from_dict(cls, obj: dict) -> HostedVrpRefundAccount:
        ...
        _obj = HostedVrpRefundAccount.parse_obj({
            "name": obj.get("name"),
