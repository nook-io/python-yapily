...
class BulkPaymentEmbeddedAuthorisationRequest(BaseModel):
    ...
    """
    user_uuid: Optional[StrictStr] = Field(None, alias="userUuid", description="__Conditional__. The reference to the `User` that will authorise the authorisation request using the Yapily generated UUID. Either the `userUuid` or `applicationUserId` must be provided.")
    ...
    payment_request: Optional[BulkPaymentRequest] = Field(None, alias="paymentRequest")
    ...
    def from_dict(cls, obj: dict) -> BulkPaymentEmbeddedAuthorisationRequest:
        ...
        _obj = BulkPaymentEmbeddedAuthorisationRequest.parse_obj({
            ...
            "payment_request": BulkPaymentRequest.from_dict(obj.get("paymentRequest")) if obj.get("paymentRequest") is not None else None,
