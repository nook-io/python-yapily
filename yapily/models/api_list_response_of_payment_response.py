...
class ApiListResponseOfPaymentResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> "ApiListResponseOfPaymentResponse":
        ...
        if not isinstance(obj, dict):
            return ApiListResponseOfPaymentResponse.model_validate(obj)

        return ApiListResponseOfPaymentResponse.model_validate(
            {
                "meta": ResponseListMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
                "data": [PaymentResponse.from_dict(_item) for _item in obj.get("data")]
                ...
                "paging": FilteredClientPayloadListPaymentResponse.from_dict(obj.get("paging"))
