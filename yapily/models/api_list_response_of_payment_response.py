...
class ApiListResponseOfPaymentResponse(BaseModel):
    ...
    data: Optional[List[PaymentResponse]] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": [PaymentResponse.from_dict(_item) for _item in obj["data"]]
                ...
                "paging": FilteredClientPayloadListPaymentResponse.from_dict(
                    obj["paging"]
                )
