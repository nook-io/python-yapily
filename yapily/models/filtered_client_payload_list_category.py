...
class FilteredClientPayloadListCategory(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "FilteredClientPayloadListCategory":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "FilteredClientPayloadListCategory":
        """Create an instance of FilteredClientPayloadListCategory from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FilteredClientPayloadListCategory.model_validate(obj)

        return FilteredClientPayloadListCategory.model_validate(
            {
