...
class FundsConfirmationRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "FundsConfirmationRequest":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "FundsConfirmationRequest":
        """Create an instance of FundsConfirmationRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FundsConfirmationRequest.model_validate(obj)

        return FundsConfirmationRequest.model_validate(
            {
