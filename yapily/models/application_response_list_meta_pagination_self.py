...
class ApplicationResponseListMetaPaginationSelf(BaseModel):
    ...
    """
    offset: Optional[conint(strict=True, ge=0)] = Field(None, description="The number of skipped applications.")
    limit: Optional[conint(strict=True, ge=0)] = Field(None, description="The maximum number of applications for the current page.")
    sort: Optional[StrictStr] = Field(None, description="The field by which results are sorted by. Default direction is ascending, descending is identified by a \"-\" prefix.")
    ...
    def from_dict(cls, obj: dict) -> ApplicationResponseListMetaPaginationSelf:
        ...
        _obj = ApplicationResponseListMetaPaginationSelf.parse_obj({
