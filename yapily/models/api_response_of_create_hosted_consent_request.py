...
class ApiResponseOfCreateHostedConsentRequest(BaseModel):
    """
    ApiResponseOfCreateHostedConsentRequest
    """

    meta: ResponseMeta | None = None
    data: HostedConsentRequestResponse | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiResponseOfCreateHostedConsentRequest":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiResponseOfCreateHostedConsentRequest":
        """Create an instance of ApiResponseOfCreateHostedConsentRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfCreateHostedConsentRequest.model_validate(obj)

        return ApiResponseOfCreateHostedConsentRequest.model_validate(
            {
                "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
                "data": HostedConsentRequestResponse.from_dict(obj.get("data"))
