...
class Consent(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the consent.")
    ...
    created_at: Optional[datetime] = Field(default=None, description="Date and time of when the consent was created.", alias="createdAt")
    ...
    expires_at: Optional[datetime] = Field(default=None, description="Date and time of when the authorisation will expire by. Reauthorisation will be needed to retain access.", alias="expiresAt")
    ...
    is_deleted_by_institution: Optional[StrictBool] = Field(default=None, description="Denotes whether the consent has been deleted on the institution side or not when a DELETE method is executed on a Yapily consent if that functionality is provided by the institution", alias="isDeletedByInstitution")
    __properties: ClassVar[List[str]] = ["id", "userUuid", "applicationUserId", "referenceId", "institutionId", "status", "createdAt", "transactionFrom", "transactionTo", "expiresAt", "timeToExpireInMillis", "timeToExpire", "featureScope", "consentToken", "state", "authorizedAt", "lastConfirmedAt", "reconfirmBy", "institutionConsentId", "isDeletedByInstitution"]
