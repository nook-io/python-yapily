...
class ProprietaryBankTransactionCode(BaseModel):
    ...
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="__Mandatory__. Properietary code used to identify the underlying transaction.")
    issuer: Optional[StrictStr] = Field(default=None, description="__Mandatory__. Issuer of the properitary code.")
