...
class ProprietaryBankTransactionCode(BaseModel):
    ...
    """
    code: Optional[StrictStr] = Field(None, description="__Mandatory__. Properietary code used to identify the underlying transaction.")
    issuer: Optional[StrictStr] = Field(None, description="__Mandatory__. Issuer of the properitary code.")
    ...
    def from_dict(cls, obj: dict) -> ProprietaryBankTransactionCode:
        ...
        _obj = ProprietaryBankTransactionCode.parse_obj({
            "code": obj.get("code"),
