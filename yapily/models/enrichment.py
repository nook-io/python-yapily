...
class Enrichment(BaseModel):
    ...
    cleansed_description: Optional[StrictStr] = Field(default=None, alias="cleansedDescription")
    ...
    corrected_date: Optional[datetime] = Field(default=None, alias="correctedDate")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "transactionHash": TransactionHash.from_dict(obj.get("transactionHash")) if obj.get("transactionHash") is not None else None,
