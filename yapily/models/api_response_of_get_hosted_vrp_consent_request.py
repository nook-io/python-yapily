...
class ApiResponseOfGetHostedVRPConsentRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiResponseOfGetHostedVRPConsentRequest":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiResponseOfGetHostedVRPConsentRequest":
        """Create an instance of ApiResponseOfGetHostedVRPConsentRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfGetHostedVRPConsentRequest.model_validate(obj)

        return ApiResponseOfGetHostedVRPConsentRequest.model_validate(
            {
