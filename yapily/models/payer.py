...
class Payer(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="__Mandatory__. The account holder name of the Payer.")
    account_identifications: List[AccountIdentification] = Field(description="__Mandatory__. The account identifications that identify the `Payer` bank account.", alias="accountIdentifications")
