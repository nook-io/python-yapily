...
class HostedVrpAccountIdentification(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="Used to describe the format of the account.<br><br> Allowed values: <br>MASKED_ACCOUNT_NUMBER<br>SORT_CODE<br>ACCOUNT_NUMBER ")
