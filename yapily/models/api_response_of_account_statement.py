...
class ApiResponseOfAccountStatement(BaseModel):
    ...
    data: AccountStatement | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiResponseOfAccountStatement":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiResponseOfAccountStatement":
        """Create an instance of ApiResponseOfAccountStatement from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfAccountStatement.model_validate(obj)

        return ApiResponseOfAccountStatement.model_validate(
            {
                "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
                "data": AccountStatement.from_dict(obj.get("data")) if obj.get("data") is not None else None,
                "links": obj.get("links"),
