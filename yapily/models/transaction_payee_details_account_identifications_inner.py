...
class TransactionPayeeDetailsAccountIdentificationsInner(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[AccountIdentificationType] = Field(default=None, description="Describes the format of the account.")
    identification: Optional[StrictStr] = Field(default=None, description="The value associated with the account identification type.")
