...
class ApiResponseOfVirtualAccount(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiResponseOfVirtualAccount:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiResponseOfVirtualAccount:
        """Create an instance of ApiResponseOfVirtualAccount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfVirtualAccount.parse_obj(obj)

        _obj = ApiResponseOfVirtualAccount.parse_obj({
            "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": VirtualAccount.from_dict(obj.get("data")) if obj.get("data") is not None else None,
