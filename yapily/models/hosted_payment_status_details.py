...
class HostedPaymentStatusDetails(BaseModel):
    ...
    status_update_date: Optional[datetime] = Field(None, alias="statusUpdateDate", description="Date and time the status was updated.")
    iso_status: Optional[HostedPaymentIsoStatus] = Field(None, alias="isoStatus")
    ...
    def from_dict(cls, obj: dict) -> HostedPaymentStatusDetails:
        ...
        _obj = HostedPaymentStatusDetails.parse_obj({
            "status": obj.get("status"),
            "status_update_date": obj.get("statusUpdateDate"),
            "iso_status": HostedPaymentIsoStatus.from_dict(obj.get("isoStatus")) if obj.get("isoStatus") is not None else None
        })
        return _obj
