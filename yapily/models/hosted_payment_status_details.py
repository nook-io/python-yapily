...
class HostedPaymentStatusDetails(BaseModel):
    ...
    status_update_date: Optional[datetime] = Field(default=None, description="Date and time the status was updated.", alias="statusUpdateDate")
    iso_status: Optional[HostedPaymentIsoStatus] = Field(default=None, alias="isoStatus")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isoStatus": HostedPaymentIsoStatus.from_dict(obj["isoStatus"]) if obj.get("isoStatus") is not None else None
        })
        return _obj
