...
class Model500VirtualAccountsApiErrorResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "Model500VirtualAccountsApiErrorResponse":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "Model500VirtualAccountsApiErrorResponse":
        """Create an instance of Model500VirtualAccountsApiErrorResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Model500VirtualAccountsApiErrorResponse.model_validate(obj)

        return Model500VirtualAccountsApiErrorResponse.model_validate(
            {
