...
class ApiResponseOfGetHostedPaymentRequest(BaseModel):
    """
    ApiResponseOfGetHostedPaymentRequest
    """

    meta: ResponseMeta | None = None
    data: HostedPaymentDetails | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiResponseOfGetHostedPaymentRequest":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiResponseOfGetHostedPaymentRequest":
        """Create an instance of ApiResponseOfGetHostedPaymentRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfGetHostedPaymentRequest.model_validate(obj)

        return ApiResponseOfGetHostedPaymentRequest.model_validate(
            {
