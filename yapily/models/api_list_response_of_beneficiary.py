...
class ApiListResponseOfBeneficiary(BaseModel):
    ...
    data: Optional[conlist(Beneficiary)] = None
    ...
    def from_dict(cls, obj: dict) -> ApiListResponseOfBeneficiary:
        ...
        _obj = ApiListResponseOfBeneficiary.parse_obj({
            "meta": ResponseListMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [Beneficiary.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
            "links": obj.get("links"),
