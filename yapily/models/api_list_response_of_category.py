...
class ApiListResponseOfCategory(BaseModel):
    ...
    paging: FilteredClientPayloadListCategory | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiListResponseOfCategory":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiListResponseOfCategory":
        """Create an instance of ApiListResponseOfCategory from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiListResponseOfCategory.model_validate(obj)

        return ApiListResponseOfCategory.model_validate(
            {
                ...
                "paging": FilteredClientPayloadListCategory.from_dict(obj.get("paging"))
