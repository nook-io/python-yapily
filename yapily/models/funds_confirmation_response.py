...
class FundsConfirmationResponse(BaseModel):
    ...
    reference: Optional[StrictStr] = Field(default=None, description="The payment reference or description. Limited to a maximum of 18 characters long.")
    payment_amount: Amount = Field(alias="paymentAmount")
    funds_available: FundsAvailable = Field(alias="fundsAvailable")
    __properties: ClassVar[List[str]] = ["id", "reference", "paymentAmount", "fundsAvailable"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "paymentAmount": Amount.from_dict(obj["paymentAmount"]) if obj.get("paymentAmount") is not None else None,
            "fundsAvailable": FundsAvailable.from_dict(obj["fundsAvailable"]) if obj.get("fundsAvailable") is not None else None
        })
        return _obj
