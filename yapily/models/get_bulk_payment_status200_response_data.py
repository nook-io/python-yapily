...
class GetBulkPaymentStatus200ResponseData(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the Bulk Payment")
    consent_id: Optional[StrictStr] = Field(default=None, description="Identification of the consent.", alias="consentId")
    status_details: Optional[GetBulkPaymentStatus200ResponseDataStatusDetails] = Field(default=None, alias="statusDetails")
    created_at: Optional[StrictStr] = Field(default=None, alias="createdAt")
    __properties: ClassVar[List[str]] = ["id", "consentId", "statusDetails", "createdAt"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "statusDetails": GetBulkPaymentStatus200ResponseDataStatusDetails.from_dict(obj["statusDetails"]) if obj.get("statusDetails") is not None else None,
