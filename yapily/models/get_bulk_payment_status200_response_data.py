...
class GetBulkPaymentStatus200ResponseData(BaseModel):
    ...
    status_details: Annotated[GetBulkPaymentStatus200ResponseDataStatusDetails | None, Field(alias="statusDetails")] = (
        None
    )
    ...
    def from_dict(cls, obj: dict) -> "GetBulkPaymentStatus200ResponseData":
        ...
        if not isinstance(obj, dict):
            return GetBulkPaymentStatus200ResponseData.model_validate(obj)

        return GetBulkPaymentStatus200ResponseData.model_validate(
            {
                "id": obj.get("id"),
