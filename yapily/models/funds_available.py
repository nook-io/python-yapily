...
class FundsAvailable(BaseModel):
    ...
    FundsAvailable
    """ # noqa: E501
    funds_available: StrictBool = Field(description="__Mandatory__. Indicates whether funds are available or not.", alias="fundsAvailable")
    funds_available_at: datetime = Field(description="__Mandatory__. Date and Time when the funds availability is checked.", alias="fundsAvailableAt")
