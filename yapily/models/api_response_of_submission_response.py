...
class ApiResponseOfSubmissionResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiResponseOfSubmissionResponse":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiResponseOfSubmissionResponse":
        """Create an instance of ApiResponseOfSubmissionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfSubmissionResponse.model_validate(obj)

        return ApiResponseOfSubmissionResponse.model_validate(
            {
                "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
                "data": SubmissionResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None,
                "links": obj.get("links"),
