...
class RawRequest(BaseModel):
    ...
    body_parameters: Optional[Dict[str, StrictStr]] = Field(default=None, alias="bodyParameters")
    start_time: Optional[datetime] = Field(default=None, alias="startTime")
    started_at: Optional[datetime] = Field(default=None, alias="startedAt")
    __properties: ClassVar[List[str]] = ["method", "url", "requestInstant", "headers", "body", "bodyParameters", "startTime", "startedAt"]
