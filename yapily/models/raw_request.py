...
class RawRequest(BaseModel):
    ...
    request_instant: Optional[datetime] = Field(None, alias="requestInstant")
    headers: Optional[Dict[str, StrictStr]] = None
    body: Optional[Dict[str, Any]] = None
    body_parameters: Optional[Dict[str, StrictStr]] = Field(None, alias="bodyParameters")
