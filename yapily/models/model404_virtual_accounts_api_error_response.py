...
class Model404VirtualAccountsApiErrorResponse(BaseModel):
    """
    ...
    monitoring: Annotated[list[MonitoringEndpointStatus], Field()] | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "Model404VirtualAccountsApiErrorResponse":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "Model404VirtualAccountsApiErrorResponse":
        """Create an instance of Model404VirtualAccountsApiErrorResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Model404VirtualAccountsApiErrorResponse.model_validate(obj)

        return Model404VirtualAccountsApiErrorResponse.model_validate(
            {
