...
class Merchant(BaseModel):
    ...
    """
    merchant_name: Optional[StrictStr] = Field(None, alias="merchantName", description="The name of the merchant involved in the transaction.")
    merchant_category_code: Optional[StrictStr] = Field(None, alias="merchantCategoryCode", description="Defines the underlying services and goods that the merchant provides. Specified as a 3-letter ISO 18245 code ")
