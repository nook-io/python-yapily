...
class ApiResponseOfFundsConfirmationResponse(BaseModel):
    """
    ApiResponseOfFundsConfirmationResponse
    """

    meta: ResponseMeta | None = None
    data: FundsConfirmationResponse | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiResponseOfFundsConfirmationResponse":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiResponseOfFundsConfirmationResponse":
        """Create an instance of ApiResponseOfFundsConfirmationResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfFundsConfirmationResponse.model_validate(obj)

        return ApiResponseOfFundsConfirmationResponse.model_validate(
            {
                "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
                "data": FundsConfirmationResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None,
                "links": obj.get("links"),
