...
class RegisteredWebhookCallbackUrl(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "main": RegisteredWebhookCallbackUrlMain.from_dict(obj["main"]) if obj.get("main") is not None else None,
            "backup": RegisterWebhookRequestCallbackUrlBackup.from_dict(obj["backup"]) if obj.get("backup") is not None else None
        })
        return _obj
