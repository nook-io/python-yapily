...
class RegisteredWebhookCallbackUrl(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> RegisteredWebhookCallbackUrl:
        ...
        _obj = RegisteredWebhookCallbackUrl.parse_obj({
            "main": RegisteredWebhookCallbackUrlMain.from_dict(obj.get("main")) if obj.get("main") is not None else None,
            "backup": RegisterWebhookRequestCallbackUrlBackup.from_dict(obj.get("backup")) if obj.get("backup") is not None else None
        })
        return _obj
