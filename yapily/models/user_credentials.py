...
class UserCredentials(BaseModel):
    ...
    corporate_id: Optional[StrictStr] = Field(default=None, description="__Conditional__. The corporate login for the user for a particular corporate `Institution`.", alias="corporateId")
