...
class PostAccountsAccountIdTransactionsCategorisation400ResponseError(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> "PostAccountsAccountIdTransactionsCategorisation400ResponseError":
        ...
        if not isinstance(obj, dict):
            return PostAccountsAccountIdTransactionsCategorisation400ResponseError.model_validate(obj)

        return PostAccountsAccountIdTransactionsCategorisation400ResponseError.model_validate(
            {
