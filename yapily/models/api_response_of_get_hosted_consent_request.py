...
class ApiResponseOfGetHostedConsentRequest(BaseModel):
    """
    ApiResponseOfGetHostedConsentRequest
    """

    meta: ResponseMeta | None = None
    data: HostedGetConsentRequestResponse | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiResponseOfGetHostedConsentRequest":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiResponseOfGetHostedConsentRequest":
        """Create an instance of ApiResponseOfGetHostedConsentRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfGetHostedConsentRequest.model_validate(obj)

        return ApiResponseOfGetHostedConsentRequest.model_validate(
            {
