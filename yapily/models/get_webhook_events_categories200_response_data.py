...
class GetWebhookEventsCategories200ResponseData(BaseModel):
    ...
    """
    categories: Optional[conlist(CategoryStructure)] = None
    ...
    def from_dict(cls, obj: dict) -> GetWebhookEventsCategories200ResponseData:
        ...
        _obj = GetWebhookEventsCategories200ResponseData.parse_obj({
            "categories": [CategoryStructure.from_dict(_item) for _item in obj.get("categories")] if obj.get("categories") is not None else None
        })
        return _obj
