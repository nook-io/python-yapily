...
class DirectDebitPayee(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "DirectDebitPayee":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "DirectDebitPayee":
        """Create an instance of DirectDebitPayee from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DirectDebitPayee.model_validate(obj)

        return DirectDebitPayee.model_validate({"name": obj.get("name")})
