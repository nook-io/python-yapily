...
class ApiResponseOfVirtualAccountClient(BaseModel):
    """
    ApiResponseOfVirtualAccountClient
    """
    meta: Optional[ResponseMeta] = None
    data: Optional[VirtualAccountClient] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiResponseOfVirtualAccountClient:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiResponseOfVirtualAccountClient:
        """Create an instance of ApiResponseOfVirtualAccountClient from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfVirtualAccountClient.parse_obj(obj)

        _obj = ApiResponseOfVirtualAccountClient.parse_obj({
            "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": VirtualAccountClient.from_dict(obj.get("data")) if obj.get("data") is not None else None,
