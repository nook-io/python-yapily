...
class VirtualAccountPayment(BaseModel):
    ...
    payment_scheme: Optional[StrictStr] = Field(None, alias="paymentScheme", description="Method of settlement to complete the payment. One of: <br> FASTER_PAYMENTS <br> SEPA_CREDIT <br> SEPA_INSTANT <br> SWIFT <br> SWIFT_EXPRESS <br> CHAPS <br> IAT <br> WIRE")
