...
class PaymentPreAuthorisationRequest(BaseModel):
    ...
    payee: Annotated[PayeeDetails, Field()]
    payer: Annotated[PayerDetails, Field()]
    ...
    def from_dict(cls, obj: dict) -> "PaymentPreAuthorisationRequest":
        ...
        if not isinstance(obj, dict):
            return PaymentPreAuthorisationRequest.model_validate(obj)

        return PaymentPreAuthorisationRequest.model_validate(
            {
