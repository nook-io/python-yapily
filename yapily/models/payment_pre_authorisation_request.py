...
class PaymentPreAuthorisationRequest(BaseModel):
    ...
    forward_parameters: Optional[List[StrictStr]] = Field(default=None, description="Extra parameters to be forwarded in the redirect back to the client after the user authorisation flow has been completed.", alias="forwardParameters")
    ...
    __properties: ClassVar[List[str]] = ["userUuid", "applicationUserId", "forwardParameters", "institutionId", "callback", "redirect", "oneTimeToken", "scope", "payee", "payer", "amount", "reference"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scope": obj.get("scope"),
            "payee": PayeeDetails.from_dict(obj["payee"]) if obj.get("payee") is not None else None,
            "payer": PayerDetails.from_dict(obj["payer"]) if obj.get("payer") is not None else None,
