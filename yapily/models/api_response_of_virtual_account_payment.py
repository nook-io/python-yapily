...
class ApiResponseOfVirtualAccountPayment(BaseModel):
    """
    ApiResponseOfVirtualAccountPayment
    """
    meta: Optional[ResponseMeta] = None
    data: Optional[VirtualAccountPayment] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiResponseOfVirtualAccountPayment:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiResponseOfVirtualAccountPayment:
        """Create an instance of ApiResponseOfVirtualAccountPayment from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfVirtualAccountPayment.parse_obj(obj)

        _obj = ApiResponseOfVirtualAccountPayment.parse_obj({
            "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": VirtualAccountPayment.from_dict(obj.get("data")) if obj.get("data") is not None else None,
