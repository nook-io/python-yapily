...
class Payee(BaseModel):
    """
    __Mandatory__. The `Payee` object contains details of the beneficiary [person or business]. You must define this in your payment request alongwith all of the nested mandatory properties.  # noqa: E501
    """
    ...
    merchant_category_code: Optional[StrictStr] = Field(None, alias="merchantCategoryCode", description="__Optional__. The category code of the merchant in case the `Payee` is a business.")
