...
class Payee(BaseModel):
    ...
    merchant_category_code: Optional[StrictStr] = Field(default=None, description="__Optional__. The category code of the merchant in case the `Payee` is a business.", alias="merchantCategoryCode")
