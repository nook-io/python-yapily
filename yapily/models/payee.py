...
class Payee(BaseModel):
    ...
    account_identifications: conlist(AccountIdentification, unique_items=True) = Field(..., alias="accountIdentifications", description="__Mandatory__. The account identifications that identify the `Payee` bank account.")
    account_type: Optional[StrictStr] = Field(None, alias="accountType", description="__Optional__. The payee account type. <br><br>Allowed values: BUSINESS, BUSINESS_SAVING, CHARITY, COLLECTION, CORPORATE, E_WALLET, GOVERNMENT, INVESTMENT, INVESTMENT_ISA, JOINT_PERSONAL, PENSION, PERSONAL, PERSONAL_SAVING, PREMIER, WEALTH .")
    address: Optional[Address] = None
    merchant_id: Optional[StrictStr] = Field(None, alias="merchantId", description="__Optional__. The merchant ID is a unique code provided by the payment processor to the merchant.")
    merchant_category_code: Optional[StrictStr] = Field(None, alias="merchantCategoryCode", description="__Optional__. The category code of the merchant in case the `Payee` is a business. Specified as a 3-letter ISO 18245 code.")
