...
class HostedGetConsentRequestResponse(BaseModel):
    ...
    consent_id: Optional[StrictStr] = Field(default=None, description="Identification of the consent.", alias="consentId")
    ...
    status: Optional[StrictStr] = Field(default=None, description="Current status of the consent request. Allowed values are [AWAITING_AUTHORIZATION, AUTHORIZED, REJECTED, REVOKED, FAILED, EXPIRED, AWAITING_DECOUPLED_AUTHORIZATION]")
    phases: Optional[List[HostedConsentPhase]] = Field(default=None, description="The phase reached by the consent and its timestamp.")
    ...
    __properties: ClassVar[List[str]] = ["consentRequestId", "consentId", "userId", "applicationUserId", "applicationId", "institutionIdentifiers", "userSettings", "redirectUrl", "createdAt", "authorisationExpiresAt", "status", "phases", "consentToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "phases": [HostedConsentPhase.from_dict(_item) for _item in obj["phases"]] if obj.get("phases") is not None else None,
