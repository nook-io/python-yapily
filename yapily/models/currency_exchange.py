...
class CurrencyExchange(BaseModel):
    ...
    """ # noqa: E501
    source_currency: Optional[StrictStr] = Field(default=None, description="Currency from which an amount is to be converted.", alias="sourceCurrency")
    target_currency: Optional[StrictStr] = Field(default=None, description="Currency to which an amount is to be converted.", alias="targetCurrency")
    unit_currency: Optional[StrictStr] = Field(default=None, description="The currency in which the rate of exchange is expressed in a currency exchange. In the example 1GBP = xxxCUR, the unit currency is GBP.", alias="unitCurrency")
    ...
    __properties: ClassVar[List[str]] = ["sourceCurrency", "targetCurrency", "unitCurrency", "exchangeRate"]
