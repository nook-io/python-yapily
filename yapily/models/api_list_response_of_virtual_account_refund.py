...
class ApiListResponseOfVirtualAccountRefund(BaseModel):
    """
    ApiListResponseOfVirtualAccountRefund
    """
    meta: Optional[ResponseMeta] = None
    links: Optional[ApiListResponseOfVirtualAccountRefundLinks] = None
    data: Optional[conlist(VirtualAccountRefund)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiListResponseOfVirtualAccountRefund:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiListResponseOfVirtualAccountRefund:
        """Create an instance of ApiListResponseOfVirtualAccountRefund from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiListResponseOfVirtualAccountRefund.parse_obj(obj)

        _obj = ApiListResponseOfVirtualAccountRefund.parse_obj({
            "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "links": ApiListResponseOfVirtualAccountRefundLinks.from_dict(obj.get("links")) if obj.get("links") is not None else None,
            "data": [VirtualAccountRefund.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
