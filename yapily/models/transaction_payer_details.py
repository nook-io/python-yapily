...
class TransactionPayerDetails(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The account holder name of the Payer.")
    account_identifications: Optional[List[TransactionPayeeDetailsAccountIdentificationsInner]] = Field(default=None, description="The account identifications that identify the Payer's bank account.", alias="accountIdentifications")
