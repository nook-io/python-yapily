...
class TransactionPayerDetails(BaseModel):
    ...
    account_identifications: Optional[conlist(TransactionPayeeDetailsAccountIdentificationsInner)] = Field(None, alias="accountIdentifications", description="The account identifications that identify the Payer's bank account.")
    ...
    def from_dict(cls, obj: dict) -> TransactionPayerDetails:
        ...
        _obj = TransactionPayerDetails.parse_obj({
            "name": obj.get("name"),
