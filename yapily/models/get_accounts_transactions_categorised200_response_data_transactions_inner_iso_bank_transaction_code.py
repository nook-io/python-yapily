...
class GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerIsoBankTransactionCode(BaseModel):
    ...
    """ # noqa: E501
    domain_code: Optional[GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerIsoBankTransactionCodeDomainCode] = Field(default=None, alias="domainCode")
    family_code: Optional[GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerIsoBankTransactionCodeDomainCode] = Field(default=None, alias="familyCode")
    sub_family_code: Optional[GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerIsoBankTransactionCodeDomainCode] = Field(default=None, alias="subFamilyCode")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "domainCode": GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerIsoBankTransactionCodeDomainCode.from_dict(obj["domainCode"]) if obj.get("domainCode") is not None else None,
            "familyCode": GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerIsoBankTransactionCodeDomainCode.from_dict(obj["familyCode"]) if obj.get("familyCode") is not None else None,
            "subFamilyCode": GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerIsoBankTransactionCodeDomainCode.from_dict(obj["subFamilyCode"]) if obj.get("subFamilyCode") is not None else None
        })
        return _obj
