...
class VrpPeriodicLimit(BaseModel):
    ...
    VrpPeriodicLimit
    """ # noqa: E501
    maximum_amount: Amount = Field(description="__Mandatory__. Maximum amount that can be specified in all payment instructions in a given period under this VRP consent. If the Alignment is Calendar, the limit is pro-rated in the first period to the remaining number of days.", alias="maximumAmount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "maximumAmount": Amount.from_dict(obj["maximumAmount"]) if obj.get("maximumAmount") is not None else None,
