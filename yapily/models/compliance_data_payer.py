...
class ComplianceDataPayer(BaseModel):
    ...
    """
    type: StrictStr = Field(..., description="The payer type. Allowed values: INDIVIDUAL, BUSINESS. The corresponding object must be included.")
    ...
    def from_dict(cls, obj: dict) -> ComplianceDataPayer:
        ...
        _obj = ComplianceDataPayer.parse_obj({
            "type": obj.get("type"),
            "individual": ComplianceDataIndividual.from_dict(obj.get("individual")) if obj.get("individual") is not None else None,
            "business": ComplianceDataBusiness.from_dict(obj.get("business")) if obj.get("business") is not None else None
        })
        return _obj
