...
class ComplianceDataPayer(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "individual": ComplianceDataIndividual.from_dict(obj["individual"]) if obj.get("individual") is not None else None,
            "business": ComplianceDataBusiness.from_dict(obj["business"]) if obj.get("business") is not None else None
        })
        return _obj
