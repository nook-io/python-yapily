...
class BeneficiaryPayee(BaseModel):
    """
    __Mandatory__. The `BeneficiaryPayee` object contains details of the beneficiary [person or business]. You must define this in your payment request along with all of the nested mandatory properties.  # noqa: E501
    """
    name: Optional[StrictStr] = Field(None, description="The account holder name of the beneficiary.")
    account_identifications: conlist(AccountIdentification, unique_items=True) = Field(..., alias="accountIdentifications", description="__Mandatory__. The account identifications that identify the `BeneficiaryPayee` bank account.")
