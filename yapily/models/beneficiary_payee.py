...
class BeneficiaryPayee(BaseModel):
    ...
    account_identifications: List[AccountIdentification] = Field(description="__Mandatory__. The account identifications that identify the `BeneficiaryPayee` bank account.", alias="accountIdentifications")
