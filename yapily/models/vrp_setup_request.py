...
class VRPSetupRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "VRPSetupRequest":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "VRPSetupRequest":
        """Create an instance of VRPSetupRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VRPSetupRequest.model_validate(obj)

        return VRPSetupRequest.model_validate(
            {
