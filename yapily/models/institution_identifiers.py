...
class InstitutionIdentifiers(BaseModel):
    ...
    institution_country_code: StrictStr = Field(description="2 letter ISO Country code of the `Institution` the payment request is sent to.", alias="institutionCountryCode")
