...
class HostedAccountRequestDetailsResponse(BaseModel):
    ...
    transaction_to: Annotated[
        datetime | None,
        Field(
            alias="transactionTo", description="Specifies the latest date of the transaction records to be returned."
        ),
    ] = None
    ...
    def from_dict(cls, obj: dict) -> "HostedAccountRequestDetailsResponse":
        ...
        if not isinstance(obj, dict):
            return HostedAccountRequestDetailsResponse.model_validate(obj)

        return HostedAccountRequestDetailsResponse.model_validate(
            {
