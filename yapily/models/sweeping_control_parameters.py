...
class SweepingControlParameters(BaseModel):
    ...
    periodic_limits: conlist(SweepingPeriodicLimits) = Field(..., alias="periodicLimits")
    ...
    def from_dict(cls, obj: dict) -> SweepingControlParameters:
        ...
        _obj = SweepingControlParameters.parse_obj({
            ...
            "periodic_limits": [SweepingPeriodicLimits.from_dict(_item) for _item in obj.get("periodicLimits")] if obj.get("periodicLimits") is not None else None,
