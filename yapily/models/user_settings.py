...
class UserSettings(BaseModel):
    ...
    """
    language: Optional[StrictStr] = Field(None, description="2 letter ISO Language code which denotes the language preference for the `User`.")
    location: Optional[StrictStr] = Field(None, description="2 letter ISO Country code which denotes the location preference for the `User`.")
