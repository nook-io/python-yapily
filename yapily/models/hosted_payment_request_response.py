...
class HostedPaymentRequestResponse(BaseModel):
    ...
    """ # noqa: E501
    payment_request_id: Optional[StrictStr] = Field(default=None, description="Unique Id of the payment request.", alias="paymentRequestId")
    ...
    redirect_url: Optional[StrictStr] = Field(default=None, description="URL of payment server to redirect the user after completion of the payment flow.", alias="redirectUrl")
    payment_request_details: Optional[HostedPaymentResponseDetails] = Field(default=None, alias="paymentRequestDetails")
    hosted_url: Optional[StrictStr] = Field(default=None, description="The URL of Hosted UI page for the applicationId which initiates the user journey for the payment. <br> URL would be appended with authToken, applicationId and userSettings.", alias="hostedUrl")
    created_at: Optional[datetime] = Field(default=None, description="The date and time at which the payment was created.", alias="createdAt")
    ...
    status: Optional[StrictStr] = Field(default=None, description="Current status of the payment request.")
    __properties: ClassVar[List[str]] = ["paymentRequestId", "userId", "applicationUserId", "applicationId", "institutionIdentifiers", "userSettings", "redirectUrl", "paymentRequestDetails", "hostedUrl", "createdAt", "authorisationExpiresAt", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "paymentRequestDetails": HostedPaymentResponseDetails.from_dict(obj["paymentRequestDetails"]) if obj.get("paymentRequestDetails") is not None else None,
