...
class HostedPaymentRequestResponse(BaseModel):
    ...
    """
    payment_request_id: Optional[StrictStr] = Field(None, alias="paymentRequestId", description="Unique Id of the payment request.")
    user_id: Optional[StrictStr] = Field(None, alias="userId", description="Unique Id for the `User` assigned by Yapily.")
    application_user_id: Optional[StrictStr] = Field(None, alias="applicationUserId", description="Your reference to the `User`.")
    application_id: Optional[StrictStr] = Field(None, alias="applicationId", description="Unique Id of the `Application` the user is associated with.")
    ...
    redirect_url: Optional[StrictStr] = Field(None, alias="redirectUrl", description="URL of payment server to redirect the user after completion of the payment flow.")
    payment_request_details: Optional[HostedPaymentResponseDetails] = Field(None, alias="paymentRequestDetails")
    hosted_url: Optional[StrictStr] = Field(None, alias="hostedUrl", description="The URL of Hosted UI page for the applicationId which initiates the user journey for the payment. <br> URL would be appended with authToken, applicationId and userSettings.")
    auth_token: Optional[StrictStr] = Field(None, alias="authToken", description="The JWT Token signed by the certificate-vault using Yapily's keys.")
    created_at: Optional[datetime] = Field(None, alias="createdAt", description="The date and time at which the payment was created.")
    ...
    __properties = ["paymentRequestId", "userId", "applicationUserId", "applicationId", "institutionIdentifiers", "userSettings", "redirectUrl", "paymentRequestDetails", "hostedUrl", "authToken", "createdAt", "authorisationExpiresAt", "status"]
    ...
    def from_dict(cls, obj: dict) -> HostedPaymentRequestResponse:
        ...
        _obj = HostedPaymentRequestResponse.parse_obj({
            ...
            "payment_request_details": HostedPaymentResponseDetails.from_dict(obj.get("paymentRequestDetails")) if obj.get("paymentRequestDetails") is not None else None,
