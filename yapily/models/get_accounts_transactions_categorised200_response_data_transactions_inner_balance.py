...
class GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerBalance(BaseModel):
    ...
    balance_amount: Optional[GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerTransactionAmount] = Field(default=None, alias="balanceAmount")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "balanceAmount": GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerTransactionAmount.from_dict(obj["balanceAmount"]) if obj.get("balanceAmount") is not None else None
        })
        return _obj
