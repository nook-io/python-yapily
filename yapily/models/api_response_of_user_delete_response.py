...
class ApiResponseOfUserDeleteResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiResponseOfUserDeleteResponse":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiResponseOfUserDeleteResponse":
        """Create an instance of ApiResponseOfUserDeleteResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfUserDeleteResponse.model_validate(obj)

        return ApiResponseOfUserDeleteResponse.model_validate(
            {
                "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
                "data": UserDeleteResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None,
                "links": obj.get("links"),
