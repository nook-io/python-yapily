...
class FilteredClientPayloadListDirectDebitResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "FilteredClientPayloadListDirectDebitResponse":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "FilteredClientPayloadListDirectDebitResponse":
        """Create an instance of FilteredClientPayloadListDirectDebitResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FilteredClientPayloadListDirectDebitResponse.model_validate(obj)

        return FilteredClientPayloadListDirectDebitResponse.model_validate(
            {
