...
class FilteredClientPayloadListDirectDebitResponse(BaseModel):
        ...
        if self.paging_map:
            for _key_paging_map in self.paging_map:
                if self.paging_map[_key_paging_map]:
                    _field_dict[_key_paging_map] = self.paging_map[_key_paging_map].to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [DirectDebitResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
