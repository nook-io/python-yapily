...
class RawResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["request", "duration", "headers", "resultCode", "result"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": RawRequest.from_dict(obj["request"]) if obj.get("request") is not None else None,
