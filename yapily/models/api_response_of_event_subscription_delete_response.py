...
class ApiResponseOfEventSubscriptionDeleteResponse(BaseModel):
    """
    ApiResponseOfEventSubscriptionDeleteResponse
    """

    meta: ResponseMeta | None = None
    data: EventSubscriptionDeleteResponse | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiResponseOfEventSubscriptionDeleteResponse":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiResponseOfEventSubscriptionDeleteResponse":
