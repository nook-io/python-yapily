...
class ApiResponseOfEventSubscriptionDeleteResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ApiResponseOfEventSubscriptionDeleteResponse:
        ...
        _obj = ApiResponseOfEventSubscriptionDeleteResponse.parse_obj({
            "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": EventSubscriptionDeleteResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "links": obj.get("links"),
