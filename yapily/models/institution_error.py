...
class InstitutionError(BaseModel):
    ...
    """
    error_message: Optional[StrictStr] = Field(None, alias="errorMessage", description="Textual description of the `Institution` error.")
    http_status_code: Optional[StrictInt] = Field(None, alias="httpStatusCode", description="Numeric HTTP status code associated with the `Institution` error.")
    ...
    def from_dict(cls, obj: dict) -> InstitutionError:
        ...
        _obj = InstitutionError.parse_obj({
