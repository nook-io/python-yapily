...
class InstitutionError(BaseModel):
    ...
    """ # noqa: E501
    error_message: Optional[StrictStr] = Field(default=None, description="Textual description of the `Institution` error.", alias="errorMessage")
    http_status_code: Optional[StrictInt] = Field(default=None, description="Numeric HTTP status code associated with the `Institution` error.", alias="httpStatusCode")
