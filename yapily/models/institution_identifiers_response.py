...
class InstitutionIdentifiersResponse(BaseModel):
    ...
    institution_country_code: Optional[StrictStr] = Field(None, alias="institutionCountryCode", description="2 letter ISO Country code of the `Institution` the payment request is sent to.")
    ...
    def from_dict(cls, obj: dict) -> InstitutionIdentifiersResponse:
        ...
        _obj = InstitutionIdentifiersResponse.parse_obj({
