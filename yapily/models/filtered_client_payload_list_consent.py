...
class FilteredClientPayloadListConsent(BaseModel):
    ...
    data: Optional[conlist(Consent)] = None
    ...
    def from_dict(cls, obj: dict) -> FilteredClientPayloadListConsent:
        ...
        _obj = FilteredClientPayloadListConsent.parse_obj({
            "api_call": obj.get("apiCall"),
            "data": [Consent.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
