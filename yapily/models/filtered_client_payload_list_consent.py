...
class FilteredClientPayloadListConsent(BaseModel):
    ...
    data: Annotated[list[Consent], Field()] | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "FilteredClientPayloadListConsent":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "FilteredClientPayloadListConsent":
        """Create an instance of FilteredClientPayloadListConsent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FilteredClientPayloadListConsent.model_validate(obj)

        return FilteredClientPayloadListConsent.model_validate(
            {
