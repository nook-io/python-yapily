...
class GetHostedVRPConsentsResponseInner(BaseModel):
    ...
    updated_at: Optional[datetime] = Field(default=None, description="Represents the date and time at which the Consent was updated.", alias="updatedAt")
    consent_status: Optional[StrictStr] = Field(default=None, description="Current status of the authorisation. Can be one of [AWAITING_AUTHORIZATION, AUTHORIZED, REJECTED, REVOKED, FAILED, EXPIRED]", alias="consentStatus")
    __properties: ClassVar[List[str]] = ["id", "applicationId", "institutionIdentifiers", "vrpSetup", "updatedAt", "consentStatus"]
