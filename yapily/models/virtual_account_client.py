...
class VirtualAccountClient(BaseModel):
    ...
    """
    id: Optional[StrictStr] = Field(None, description="The id generated in the on-boarding process, it will be used as client-id for virtual accounts request")
    type: Optional[VirtualAccountClientType] = None
    kyc_status: Optional[VirtualAccountKycStatus] = Field(None, alias="kycStatus")
    ...
    __properties = ["id", "type", "kycStatus", "status", "createdDateTime", "individual", "business"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VirtualAccountClient:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VirtualAccountClient:
        """Create an instance of VirtualAccountClient from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VirtualAccountClient.parse_obj(obj)

        _obj = VirtualAccountClient.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
