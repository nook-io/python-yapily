...
class FilteredClientPayloadListAccount(BaseModel):
    ...
    data: Annotated[list[Account], Field()] | None = None
    ...
    def from_dict(cls, obj: dict) -> "FilteredClientPayloadListAccount":
        ...
        if not isinstance(obj, dict):
            return FilteredClientPayloadListAccount.model_validate(obj)

        return FilteredClientPayloadListAccount.model_validate(
            {
