...
class ConsentDeleteResponse(BaseModel):
    ...
    creation_date: Optional[datetime] = Field(default=None, description="Date and time of when the consent was authorised.", alias="creationDate")
    __properties: ClassVar[List[str]] = ["id", "deleteStatus", "institutionId", "institutionConsentId", "creationDate"]
