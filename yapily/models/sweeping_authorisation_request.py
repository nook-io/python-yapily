...
class SweepingAuthorisationRequest(object):
    ...
    def __init__(self, user_id=None, application_user_id=None, forward_parameters=None, context_type=None, institution_id=None, callback=None, redirect=None, one_time_token=None, control_parameters=None, initiation_details=None, local_vars_configuration=None):  # noqa: E501
        """SweepingAuthorisationRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def user_id(self):
        """Gets the user_id of this SweepingAuthorisationRequest.  # noqa: E501

        This is the Yapily user identifier for the user returned by the create user step POST ../users  # noqa: E501

        :return: The user_id of this SweepingAuthorisationRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def user_id(self, user_id):
        """Sets the user_id of this SweepingAuthorisationRequest.

        This is the Yapily user identifier for the user returned by the create user step POST ../users  # noqa: E501

        :param user_id: The user_id of this SweepingAuthorisationRequest.  # noqa: E501
        :type: str
        """
    ...
    def application_user_id(self):
        """Gets the application_user_id of this SweepingAuthorisationRequest.  # noqa: E501
        ...
        :return: The application_user_id of this SweepingAuthorisationRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def application_user_id(self, application_user_id):
        """Sets the application_user_id of this SweepingAuthorisationRequest.

        A client's own user reference. If the client wants to work with their own unique references for individual PSUs then they can use the applicationUserId property to provide that value. Where Yapily does not already have a Yapily userId that matches the supplied applicationUserId, then a new Yapily userId is created automatically and linked to the applicationUserId value.  Clients can then use either their own applicationUserId or the Yapily userId to reference the same user in future calls.  # noqa: E501

        :param application_user_id: The application_user_id of this SweepingAuthorisationRequest.  # noqa: E501
        :type: str
        """
    ...
    def forward_parameters(self):
        """Gets the forward_parameters of this SweepingAuthorisationRequest.  # noqa: E501

        Extra parameters the TPP may want to get forwarded in the callback request after the PSU redirect.  # noqa: E501

        :return: The forward_parameters of this SweepingAuthorisationRequest.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def forward_parameters(self, forward_parameters):
        """Sets the forward_parameters of this SweepingAuthorisationRequest.

        Extra parameters the TPP may want to get forwarded in the callback request after the PSU redirect.  # noqa: E501

        :param forward_parameters: The forward_parameters of this SweepingAuthorisationRequest.  # noqa: E501
        :type: list[str]
        """
    ...
    def context_type(self):
        """Gets the context_type of this SweepingAuthorisationRequest.  # noqa: E501


        :return: The context_type of this SweepingAuthorisationRequest.  # noqa: E501
    ...
    def context_type(self, context_type):
        """Sets the context_type of this SweepingAuthorisationRequest.


        :param context_type: The context_type of this SweepingAuthorisationRequest.  # noqa: E501
    ...
    def institution_id(self):
        """Gets the institution_id of this SweepingAuthorisationRequest.  # noqa: E501
        ...
        :return: The institution_id of this SweepingAuthorisationRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def institution_id(self, institution_id):
        """Sets the institution_id of this SweepingAuthorisationRequest.

        __Mandatory__. The reference to the `Institution` which identifies which institution the authorisation request is sent to.  # noqa: E501

        :param institution_id: The institution_id of this SweepingAuthorisationRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def callback(self):
        """Gets the callback of this SweepingAuthorisationRequest.  # noqa: E501
        ...
        :return: The callback of this SweepingAuthorisationRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def callback(self, callback):
        """Sets the callback of this SweepingAuthorisationRequest.

        __Optional__. The server to redirect the user to after the user complete the authorisation at the `Institution`. <br><br>See [Using a callback (Optional)](https://docs.yapily.com/knowledge/callback_url/#using-a-callback-optional) for more information.  # noqa: E501

        :param callback: The callback of this SweepingAuthorisationRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def redirect(self):
        """Gets the redirect of this SweepingAuthorisationRequest.  # noqa: E501


        :return: The redirect of this SweepingAuthorisationRequest.  # noqa: E501
    ...
    def redirect(self, redirect):
        """Sets the redirect of this SweepingAuthorisationRequest.


        :param redirect: The redirect of this SweepingAuthorisationRequest.  # noqa: E501
    ...
    def one_time_token(self):
        """Gets the one_time_token of this SweepingAuthorisationRequest.  # noqa: E501
        ...
        :return: The one_time_token of this SweepingAuthorisationRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def one_time_token(self, one_time_token):
        """Sets the one_time_token of this SweepingAuthorisationRequest.

        __Conditional__. Used to receive a `oneTimeToken` rather than a `consentToken` at the `callback` for additional security. This can only be used when the `callback` is set. <br><br>See [Using a callback with an OTT (Optional)](https://docs.yapily.com/knowledge/callback_url/#using-a-callback-with-an-ott-optional) for more information.  # noqa: E501

        :param one_time_token: The one_time_token of this SweepingAuthorisationRequest.  # noqa: E501
        :type: bool
        """
    ...
    def control_parameters(self):
        """Gets the control_parameters of this SweepingAuthorisationRequest.  # noqa: E501


        :return: The control_parameters of this SweepingAuthorisationRequest.  # noqa: E501
    ...
    def control_parameters(self, control_parameters):
        """Sets the control_parameters of this SweepingAuthorisationRequest.


        :param control_parameters: The control_parameters of this SweepingAuthorisationRequest.  # noqa: E501
    ...
    def initiation_details(self):
        """Gets the initiation_details of this SweepingAuthorisationRequest.  # noqa: E501


        :return: The initiation_details of this SweepingAuthorisationRequest.  # noqa: E501
    ...
    def initiation_details(self, initiation_details):
        """Sets the initiation_details of this SweepingAuthorisationRequest.


        :param initiation_details: The initiation_details of this SweepingAuthorisationRequest.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SweepingAuthorisationRequest):
            return False
