...
class ApplicationResponseListMeta(BaseModel):
    ...
    count: Optional[conint(strict=True, ge=0)] = Field(None, description="The number of applications in the current page.")
    ...
    def from_dict(cls, obj: dict) -> ApplicationResponseListMeta:
        ...
        _obj = ApplicationResponseListMeta.parse_obj({
            ...
            "count": obj.get("count"),
            "pagination": ApplicationResponseListMetaPagination.from_dict(obj.get("pagination")) if obj.get("pagination") is not None else None
        })
        return _obj
