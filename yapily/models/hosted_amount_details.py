...
class HostedAmountDetails(BaseModel):
    ...
    """
    amount_to_pay: Union[confloat(ge=0.01, strict=True), conint(ge=1, strict=True)] = Field(..., alias="amountToPay", description="The payment amount")
    currency: StrictStr = Field(..., description="The [ISO 4217](https://www.xe.com/iso4217.php) currency code")
    ...
    def from_dict(cls, obj: dict) -> HostedAmountDetails:
        ...
        _obj = HostedAmountDetails.parse_obj({
            "amount_to_pay": obj.get("amountToPay"),
