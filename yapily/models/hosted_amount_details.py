...
class HostedAmountDetails(BaseModel):
    ...
    amount_to_pay: Annotated[Annotated[float, Field(ge=0.01, strict=True)] | Annotated[int, Field(ge=1, strict=True)], Field(alias='amountToPay', description='The payment amount')] = ...
