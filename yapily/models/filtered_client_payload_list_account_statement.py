...
class FilteredClientPayloadListAccountStatement(BaseModel):
    ...
    data: Annotated[list[AccountStatement], Field()] | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "FilteredClientPayloadListAccountStatement":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "FilteredClientPayloadListAccountStatement":
        """Create an instance of FilteredClientPayloadListAccountStatement from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FilteredClientPayloadListAccountStatement.model_validate(obj)

        return FilteredClientPayloadListAccountStatement.model_validate(
            {
