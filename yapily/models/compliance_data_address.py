...
class ComplianceDataAddress(BaseModel):
    ...
    """
    address_line1: StrictStr = Field(..., alias="addressLine1", description="__Mandatory__. AddressLine1 of the business.")
    address_line2: Optional[StrictStr] = Field(None, alias="addressLine2", description="__Optional__. AddressLine2 of the business.")
    town_name: StrictStr = Field(..., alias="townName", description="__Mandatory__. Town name of the business.")
    post_code: StrictStr = Field(..., alias="postCode", description="__Mandatory__. Post code of the business.")
