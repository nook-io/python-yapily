...
class ApiResponseOfCreateHostedPaymentRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiResponseOfCreateHostedPaymentRequest":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiResponseOfCreateHostedPaymentRequest":
        """Create an instance of ApiResponseOfCreateHostedPaymentRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfCreateHostedPaymentRequest.model_validate(obj)

        return ApiResponseOfCreateHostedPaymentRequest.model_validate(
            {
