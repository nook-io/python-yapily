...
class FilteredClientPayloadListTransaction(BaseModel):
    ...
    data: Optional[conlist(Transaction)] = None
    ...
    def from_dict(cls, obj: dict) -> FilteredClientPayloadListTransaction:
        ...
        _obj = FilteredClientPayloadListTransaction.parse_obj({
            "api_call": obj.get("apiCall"),
            "data": [Transaction.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
