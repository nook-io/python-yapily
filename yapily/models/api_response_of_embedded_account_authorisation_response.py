...
class ApiResponseOfEmbeddedAccountAuthorisationResponse(BaseModel):
    """
    ApiResponseOfEmbeddedAccountAuthorisationResponse
    """

    meta: ResponseMeta | None = None
    data: EmbeddedAccountAuthorisationResponse | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiResponseOfEmbeddedAccountAuthorisationResponse":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiResponseOfEmbeddedAccountAuthorisationResponse":
        """Create an instance of ApiResponseOfEmbeddedAccountAuthorisationResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfEmbeddedAccountAuthorisationResponse.model_validate(obj)

        return ApiResponseOfEmbeddedAccountAuthorisationResponse.model_validate(
            {
                "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
                "data": EmbeddedAccountAuthorisationResponse.from_dict(obj.get("data"))
