...
class AccountAuthorisationResponse(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the account authorisation request.<br><br>The `consentID` used to [retrieve a consent](/api/reference/#operation/getConsentById).")
    ...
    last_confirmed_at: Optional[datetime] = Field(default=None, description="The time the PSU last confirmed access to their account information, either through full authentication with the institution, or through reconfirmation with the TPP.", alias="lastConfirmedAt")
    reconfirm_by: Optional[datetime] = Field(default=None, description="The date and time the consent must be reconfirmed by to ensure continued access to the account information.", alias="reconfirmBy")
