...
class GetAccountsTransactionsCategorised200Response(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "meta": GetAccountsTransactionsCategorised200ResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": GetAccountsTransactionsCategorised200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "links": GetAccountsTransactionsCategorised200ResponseLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
