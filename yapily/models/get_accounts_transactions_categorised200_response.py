...
class GetAccountsTransactionsCategorised200Response(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> GetAccountsTransactionsCategorised200Response:
        ...
        _obj = GetAccountsTransactionsCategorised200Response.parse_obj({
            "meta": GetAccountsTransactionsCategorised200ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": GetAccountsTransactionsCategorised200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "links": GetAccountsTransactionsCategorised200ResponseLinks.from_dict(obj.get("links")) if obj.get("links") is not None else None
        })
        return _obj
