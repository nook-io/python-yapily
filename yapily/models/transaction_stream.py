...
class TransactionStream(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="The name of the Transaction Stream.")
    transactions: Optional[List[EnrichedTransaction]] = Field(default=None, description="A list of transaction details, identified by Yapily data services.")
