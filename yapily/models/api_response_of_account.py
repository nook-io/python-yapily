...
class ApiResponseOfAccount(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiResponseOfAccount":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiResponseOfAccount":
        """Create an instance of ApiResponseOfAccount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfAccount.model_validate(obj)

        return ApiResponseOfAccount.model_validate(
            {
