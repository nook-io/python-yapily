...
class CategoryStructure(BaseModel):
    ...
    CategoryStructure
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="webhook event category name")
    description: Optional[StrictStr] = Field(default=None, description="description of the webhook event category")
