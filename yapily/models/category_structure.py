...
class CategoryStructure(BaseModel):
    ...
    CategoryStructure
    """
    name: Optional[StrictStr] = Field(None, description="webhook event category name")
    description: Optional[StrictStr] = Field(None, description="description of the webhook event category")
    ...
    def from_dict(cls, obj: dict) -> CategoryStructure:
        ...
        _obj = CategoryStructure.parse_obj({
            "name": obj.get("name"),
