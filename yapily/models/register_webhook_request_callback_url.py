...
class RegisterWebhookRequestCallbackUrl(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> RegisterWebhookRequestCallbackUrl:
        ...
        _obj = RegisterWebhookRequestCallbackUrl.parse_obj({
            "main": RegisterWebhookRequestCallbackUrlMain.from_dict(obj.get("main")) if obj.get("main") is not None else None,
