...
class NonSweepingControlParameters(BaseModel):
    ...
    periodic_limits: List[NonSweepingPeriodicLimits] = Field(alias="periodicLimits")
    max_amount_per_payment: Amount = Field(alias="maxAmountPerPayment")
    max_cumulative_amount: Optional[Amount] = Field(default=None, alias="maxCumulativeAmount")
    ...
    __properties: ClassVar[List[str]] = ["psuAuthenticationMethods", "periodicLimits", "maxAmountPerPayment", "maxCumulativeAmount", "maxCumulativeNumberOfPayments", "validFrom", "validTo"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "periodicLimits": [NonSweepingPeriodicLimits.from_dict(_item) for _item in obj.get("periodicLimits")] if obj.get("periodicLimits") is not None else None,
            "maxAmountPerPayment": Amount.from_dict(obj.get("maxAmountPerPayment")) if obj.get("maxAmountPerPayment") is not None else None,
            "maxCumulativeAmount": Amount.from_dict(obj.get("maxCumulativeAmount")) if obj.get("maxCumulativeAmount") is not None else None,
