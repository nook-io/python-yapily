...
class PaymentRequest(BaseModel):
    ...
    __properties = ["paymentIdempotencyId", "payer", "reference", "contextType", "type", "payee", "periodicPayment", "internationalPayment", "amount", "paymentDateTime", "readRefundAccount"]
