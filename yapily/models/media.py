...
class Media(BaseModel):
    ...
    """
    source: Optional[StrictStr] = Field(None, description="__Mandatory__. URL from where the media can be retrieved.")
    type: Optional[StrictStr] = Field(None, description="__Mandatory__. The type of media e.g. (logo, icon).")
