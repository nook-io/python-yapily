...
class Balances(BaseModel):
    ...
    Balances
    """
    main_balance_amount: Optional[Amount] = Field(None, alias="mainBalanceAmount")
    balances: Optional[conlist(AccountBalance)] = None
    ...
    def from_dict(cls, obj: dict) -> Balances:
        ...
        _obj = Balances.parse_obj({
            "main_balance_amount": Amount.from_dict(obj.get("mainBalanceAmount")) if obj.get("mainBalanceAmount") is not None else None,
            "balances": [AccountBalance.from_dict(_item) for _item in obj.get("balances")] if obj.get("balances") is not None else None
        })
        return _obj
