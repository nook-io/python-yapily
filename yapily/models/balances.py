...
class Balances(BaseModel):
    ...
    Balances
    """ # noqa: E501
    main_balance_amount: Optional[Amount] = Field(default=None, alias="mainBalanceAmount")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "mainBalanceAmount": Amount.from_dict(obj.get("mainBalanceAmount")) if obj.get("mainBalanceAmount") is not None else None,
