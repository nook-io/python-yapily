...
class Balances(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mainBalanceAmount": Amount.from_dict(obj["mainBalanceAmount"]) if obj.get("mainBalanceAmount") is not None else None,
            "balances": [AccountBalance.from_dict(_item) for _item in obj["balances"]] if obj.get("balances") is not None else None
        })
        return _obj
