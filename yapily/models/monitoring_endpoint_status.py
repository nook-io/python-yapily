...
class MonitoringEndpointStatus(BaseModel):
    ...
    """ # noqa: E501
    last_tested: Optional[datetime] = Field(default=None, alias="lastTested")
    resource_endpoint: Optional[StrictStr] = Field(default=None, alias="resourceEndpoint")
    span: Optional[StrictStr] = None
    status: Optional[MonitoringStatusEnum] = None
    __properties: ClassVar[List[str]] = ["lastTested", "resourceEndpoint", "span", "status"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "lastTested": obj.get("lastTested"),
            "resourceEndpoint": obj.get("resourceEndpoint"),
            "span": obj.get("span"),
