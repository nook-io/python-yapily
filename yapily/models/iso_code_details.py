...
class IsoCodeDetails(BaseModel):
    ...
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default='UNKNOWN', description="__Mandatory__. Unique identifier of the ISO code.")
    name: Optional[StrictStr] = Field(default='UNKNOWN', description="__Mandatory__. Name of the ISO Code.")
