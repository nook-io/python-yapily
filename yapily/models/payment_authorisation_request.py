...
class PaymentAuthorisationRequest(BaseModel):
    ...
    callback: Optional[StrictStr] = Field(default=None, description="__Optional__. The URL to redirect the user to after the user complete the authorisation at the `Institution`.")
    ...
    __properties: ClassVar[List[str]] = ["userUuid", "applicationUserId", "forwardParameters", "institutionId", "callback", "redirect", "oneTimeToken", "paymentRequest"]
