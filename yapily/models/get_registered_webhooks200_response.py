...
class GetRegisteredWebhooks200Response(BaseModel):
    ...
    data: GetRegisteredWebhooks200ResponseData | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "GetRegisteredWebhooks200Response":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "GetRegisteredWebhooks200Response":
        """Create an instance of GetRegisteredWebhooks200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetRegisteredWebhooks200Response.model_validate(obj)

        return GetRegisteredWebhooks200Response.model_validate(
            {
                "metadata": Metadata.from_dict(obj.get("metadata")) if obj.get("metadata") is not None else None,
                "data": GetRegisteredWebhooks200ResponseData.from_dict(obj.get("data"))
