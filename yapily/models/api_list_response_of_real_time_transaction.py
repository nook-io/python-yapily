...
class ApiListResponseOfRealTimeTransaction(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "meta": ResponseMetaWithCount.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": [RealTimeTransaction.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "links": ApiListResponseOfRealTimeTransactionLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
