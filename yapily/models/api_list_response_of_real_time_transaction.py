...
class ApiListResponseOfRealTimeTransaction(BaseModel):
    ...
    data: Optional[List[RealTimeTransaction]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "meta": ResponseMetaWithCount.from_dict(obj["meta"])
                if obj.get("meta") is not None
                else None,
                "data": [RealTimeTransaction.from_dict(_item) for _item in obj["data"]]
