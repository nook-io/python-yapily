...
class ApiListResponseOfRealTimeTransaction(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ApiListResponseOfRealTimeTransaction:
        ...
        _obj = ApiListResponseOfRealTimeTransaction.parse_obj({
            ...
            "data": [RealTimeTransaction.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
            "links": ApiListResponseOfRealTimeTransactionLinks.from_dict(obj.get("links")) if obj.get("links") is not None else None,
