...
class HostedPaymentPhase(BaseModel):
    ...
    phase_created_at: Annotated[
        datetime | None,
        Field(alias="phaseCreatedAt", description="The date and time when phase of the hosted payment was inserted."),
    ] = None
    ...
    def from_dict(cls, obj: dict) -> "HostedPaymentPhase":
        ...
        if not isinstance(obj, dict):
            return HostedPaymentPhase.model_validate(obj)

        return HostedPaymentPhase.model_validate(
