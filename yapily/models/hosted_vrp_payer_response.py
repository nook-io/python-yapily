...
class HostedVrpPayerResponse(BaseModel):
    ...
    account_identifications: conlist(HostedVrpAccountIdentification, unique_items=True) = Field(..., alias="accountIdentifications", description="__Mandatory__. The account identifications that identify the `Payer` bank account.")
    ...
    def from_dict(cls, obj: dict) -> HostedVrpPayerResponse:
        ...
        _obj = HostedVrpPayerResponse.parse_obj({
            "name": obj.get("name"),
            "account_identifications": [HostedVrpAccountIdentification.from_dict(_item) for _item in obj.get("accountIdentifications")] if obj.get("accountIdentifications") is not None else None,
