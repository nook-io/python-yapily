...
class HostedVrpPayerResponse(BaseModel):
    ...
    account_identifications: List[HostedVrpAccountIdentification] = Field(description="__Mandatory__. The account identifications that identify the `Payer` bank account.", alias="accountIdentifications")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "accountIdentifications": [HostedVrpAccountIdentification.from_dict(_item) for _item in obj["accountIdentifications"]] if obj.get("accountIdentifications") is not None else None,
