...
class Beneficiary(BaseModel):
    ...
    """
    id: Optional[StrictStr] = Field(None, description="Unique identifier of the `beneficiary`.")
    reference: Optional[StrictStr] = Field(None, description="A creditor reference that is requested to be used for all payment instructions to this beneficiary.")
    payee: Optional[BeneficiaryPayee] = None
    trusted: Optional[StrictBool] = Field(None, description="Indicates whether the account owner has stated that this beneficiary should be trusted. This often results in reduced authentication and authorisation requirements on payments to the beneficiary.")
