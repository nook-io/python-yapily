...
class HostedPaymentIsoStatus(BaseModel):
    ...
    """
    code: Optional[StrictStr] = Field(None, description="The ISO 20022 `PaymentStatusCode`. One of : <br> ACSC <br> ACCC <br> ACCP  <br> ACSP <br> ACTC <br> ACWC <br> ACWP <br> ACFC <br> RCVD <br> PART <br> PATC <br> PDNG <br> RJCT <br> CANC")
    name: Optional[StrictStr] = Field(None, description="The full name of the ISO 20022 `PaymentStatusCode`.")
    ...
    def from_dict(cls, obj: dict) -> HostedPaymentIsoStatus:
        ...
        _obj = HostedPaymentIsoStatus.parse_obj({
            "code": obj.get("code"),
            "name": obj.get("name")
        })
        return _obj
