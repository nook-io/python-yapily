...
class EmbeddedAccountAuthorisationResponse(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the embedded account authorisation request.")
    ...
    created_at: Optional[datetime] = Field(default=None, description="Date and time the embedded authorisation was created by the application user.", alias="createdAt")
    ...
    expires_at: Optional[datetime] = Field(default=None, description="Date and time the embedded authorisation expires. Re-authorisation is needed to retain access.", alias="expiresAt")
    ...
    consent_token: Optional[StrictStr] = Field(default=None, description="Represents the authorisation to gain access to the requested features. Required to access account information.", alias="consentToken")
    state: Optional[StrictStr] = Field(default=None, description="Correlation ID used when handshaking with a new institution via OAuth2 registration.")
    ...
    sca_methods: Optional[List[ScaMethod]] = Field(default=None, description="List of `SCA methods` that the `Institution` supports and are available for selection.", alias="scaMethods")
