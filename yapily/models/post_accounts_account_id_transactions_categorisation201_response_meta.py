...
class PostAccountsAccountIdTransactionsCategorisation201ResponseMeta(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> "PostAccountsAccountIdTransactionsCategorisation201ResponseMeta":
        ...
        if not isinstance(obj, dict):
            return PostAccountsAccountIdTransactionsCategorisation201ResponseMeta.model_validate(obj)

        return PostAccountsAccountIdTransactionsCategorisation201ResponseMeta.model_validate(
