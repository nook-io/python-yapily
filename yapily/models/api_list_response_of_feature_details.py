...
class ApiListResponseOfFeatureDetails(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ApiListResponseOfFeatureDetails:
        ...
        _obj = ApiListResponseOfFeatureDetails.parse_obj({
            ...
            "paging": FilteredClientPayloadListFeatureDetails.from_dict(obj.get("paging")) if obj.get("paging") is not None else None,
