...
class AccountAuthorisationRequest(object):
    ...
    def __init__(self, user_uuid=None, application_user_id=None, forward_parameters=None, institution_id=None, callback=None, redirect=None, one_time_token=None, account_request=None, local_vars_configuration=None):  # noqa: E501
    ...
    def callback(self):
        ...
        __Optional__. The server to redirect the user to after the user completes the authorisation at the `Institution`. <br><br>See [Using a callback (Optional)](https://docs.yapily.com/pages/knowledge/yapily-concepts/callback_url/#using-a-callback-optional) for more information.  # noqa: E501
    ...
    @property
    def redirect(self):
        """Gets the redirect of this AccountAuthorisationRequest.  # noqa: E501


        :return: The redirect of this AccountAuthorisationRequest.  # noqa: E501
    ...
    def redirect(self, redirect):
        """Sets the redirect of this AccountAuthorisationRequest.


        :param redirect: The redirect of this AccountAuthorisationRequest.  # noqa: E501
