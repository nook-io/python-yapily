...
class FrequencyResponse(BaseModel):
    ...
    interval_week: Optional[StrictInt] = Field(None, alias="intervalWeek")
    interval_month: Optional[StrictInt] = Field(None, alias="intervalMonth")
    execution_day: Optional[StrictInt] = Field(None, alias="executionDay")
