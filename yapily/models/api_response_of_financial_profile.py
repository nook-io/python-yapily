...
class ApiResponseOfFinancialProfile(BaseModel):
    """
    ApiResponseOfFinancialProfile
    """

    meta: ResponseMeta | None = None
    data: FinancialProfile | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiResponseOfFinancialProfile":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiResponseOfFinancialProfile":
        """Create an instance of ApiResponseOfFinancialProfile from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfFinancialProfile.model_validate(obj)

        return ApiResponseOfFinancialProfile.model_validate(
            {
