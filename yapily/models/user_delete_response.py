...
class UserDeleteResponse(BaseModel):
    ...
    creation_date: Optional[datetime] = Field(default=None, description="Date and time that the user was created.", alias="creationDate")
    user_consents: Optional[List[ConsentDeleteResponse]] = Field(default=None, alias="userConsents")
    __properties: ClassVar[List[str]] = ["id", "deleteStatus", "creationDate", "userConsents"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "userConsents": [ConsentDeleteResponse.from_dict(_item) for _item in obj["userConsents"]] if obj.get("userConsents") is not None else None
        })
        return _obj
