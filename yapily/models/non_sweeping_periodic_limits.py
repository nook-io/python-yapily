...
class NonSweepingPeriodicLimits(BaseModel):
    ...
    max_number_of_payments: Annotated[
        StrictInt | None,
        Field(
    ...
    def from_dict(cls, obj: dict) -> "NonSweepingPeriodicLimits":
        ...
        if not isinstance(obj, dict):
            return NonSweepingPeriodicLimits.model_validate(obj)

        return NonSweepingPeriodicLimits.model_validate(
            {
