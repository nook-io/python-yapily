...
class GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerEnrichment(BaseModel):
    ...
    transaction_hash: Optional[GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerEnrichmentTransactionHash] = Field(default=None, alias="transactionHash")
    merchant: Optional[GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerEnrichmentMerchant] = None
    payment_processor: Optional[StrictStr] = Field(default=None, alias="paymentProcessor")
    __properties: ClassVar[List[str]] = ["categorisation", "recurrence", "transactionHash", "merchant", "paymentProcessor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "categorisation": GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerEnrichmentCategorisation.from_dict(obj["categorisation"]) if obj.get("categorisation") is not None else None,
            "recurrence": obj.get("recurrence"),
            "transactionHash": GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerEnrichmentTransactionHash.from_dict(obj["transactionHash"]) if obj.get("transactionHash") is not None else None,
            "merchant": GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerEnrichmentMerchant.from_dict(obj["merchant"]) if obj.get("merchant") is not None else None,
