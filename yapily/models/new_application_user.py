...
class NewApplicationUser(BaseModel):
    ...
    """
    application_user_id: Optional[StrictStr] = Field(None, alias="applicationUserId", description="__Optional__. The unique identifier of the `Application User` assigned by the Application Owner.")
    reference_id: Optional[StrictStr] = Field(None, alias="referenceId", description="__Deprecated__. A non-unique reference Id for the `Application User`.")
