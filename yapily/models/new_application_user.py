...
class NewApplicationUser(BaseModel):
    ...
    NewApplicationUser
    """
    application_user_id: Optional[StrictStr] = Field(None, alias="applicationUserId", description="__Optional__. An additional unique identifier that you can specify when creating a new `User` to more easily reference it")
    reference_id: Optional[StrictStr] = Field(None, alias="referenceId", description="__Deprecated__. A non-unique reference Id for the `User`")
