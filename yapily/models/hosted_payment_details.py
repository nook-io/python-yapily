...
class HostedPaymentDetails(BaseModel):
    ...
    payment_request_details: Optional[HostedPaymentRequestDetailsLink] = Field(
    ...
    payments: Optional[List[HostedPayment]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                ...
                "payments": [
                    HostedPayment.from_dict(_item) for _item in obj["payments"]
                ]
