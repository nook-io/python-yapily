...
class PaymentAuthorisationRequestResponse(BaseModel):
    ...
    id: Annotated[StrictStr | None, Field(description='Unique identifier for the payment authorisation request. <br><br>The `consentID` used to [retrieve a consent](/api/reference/#operation/getConsentById).')] = None
    ...
    consent_token: Annotated[StrictStr | None, Field(alias='consentToken', description='Represents the authorisation to gain access to the requested features. Required to make a payment request.')] = None
    ...
    exchange_rate_information: Annotated[ExchangeRateInformationResponse | None, Field(alias='exchangeRateInformation')] = None
    authorisation_url: Annotated[StrictStr | None, Field(alias='authorisationUrl')] = None
    qr_code_url: Annotated[StrictStr | None, Field(alias='qrCodeUrl', description='The URL for a QR code that may be scanned via a mobile device to make a authorisation redirect to the bank (authURL encoded).')] = None
    explanation: Annotated[StrictStr | None, Field(description='Message from the `Institution` received by Yapily, detailing the next action the user is required to take. This is used only for Decoupled flows.')] = None
    __properties = [
        "id",
        "userUuid",
        "applicationUserId",
