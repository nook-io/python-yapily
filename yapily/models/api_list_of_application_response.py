...
class ApiListOfApplicationResponse(BaseModel):
    ...
    data: Optional[conlist(ApplicationResponse)] = None
    ...
    def from_dict(cls, obj: dict) -> ApiListOfApplicationResponse:
        ...
        _obj = ApiListOfApplicationResponse.parse_obj({
            "meta": ApplicationResponseListMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [ApplicationResponse.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
