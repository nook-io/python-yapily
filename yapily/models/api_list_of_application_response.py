...
class ApiListOfApplicationResponse(BaseModel):
    meta: Optional[ApplicationResponseListMeta] = None
    data: Optional[List[ApplicationResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "meta": ApplicationResponseListMeta.from_dict(obj["meta"])
                if obj.get("meta") is not None
                else None,
                "data": [ApplicationResponse.from_dict(_item) for _item in obj["data"]]
