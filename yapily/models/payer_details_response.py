...
class PayerDetailsResponse(BaseModel):
    ...
    account_identifications: Optional[conlist(AccountIdentificationResponse, unique_items=True)] = Field(None, alias="accountIdentifications", description="The account identifications that identify the `Payer` bank account.")
    ...
    def from_dict(cls, obj: dict) -> PayerDetailsResponse:
        ...
        _obj = PayerDetailsResponse.parse_obj({
            "name": obj.get("name"),
