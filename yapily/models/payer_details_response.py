...
class PayerDetailsResponse(BaseModel):
    ...
    account_identifications: Optional[List[AccountIdentificationResponse]] = Field(default=None, description="The account identifications that identify the `Payer` bank account.", alias="accountIdentifications")
