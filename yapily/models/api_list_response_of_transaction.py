...
class ApiListResponseOfTransaction(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiListResponseOfTransaction":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiListResponseOfTransaction":
        """Create an instance of ApiListResponseOfTransaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiListResponseOfTransaction.model_validate(obj)

        return ApiListResponseOfTransaction.model_validate(
            {
