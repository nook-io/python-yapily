...
class ApiListResponseOfInstitution(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ApiListResponseOfInstitution:
        ...
        _obj = ApiListResponseOfInstitution.parse_obj({
            "meta": ResponseListMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [Institution.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
            "links": obj.get("links"),
            ...
            "paging": FilteredClientPayloadListInstitution.from_dict(obj.get("paging")) if obj.get("paging") is not None else None,
