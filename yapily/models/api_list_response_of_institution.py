...
class ApiListResponseOfInstitution(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiListResponseOfInstitution":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiListResponseOfInstitution":
        """Create an instance of ApiListResponseOfInstitution from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiListResponseOfInstitution.model_validate(obj)

        return ApiListResponseOfInstitution.model_validate(
            {
