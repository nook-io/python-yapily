...
class FilteredClientPayloadListPaymentResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "FilteredClientPayloadListPaymentResponse":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "FilteredClientPayloadListPaymentResponse":
        """Create an instance of FilteredClientPayloadListPaymentResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FilteredClientPayloadListPaymentResponse.model_validate(obj)

        return FilteredClientPayloadListPaymentResponse.model_validate(
            {
