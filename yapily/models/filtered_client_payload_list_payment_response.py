...
class FilteredClientPayloadListPaymentResponse(BaseModel):
    ...
    """
    api_call: Optional[Dict[str, Any]] = Field(None, alias="apiCall")
    data: Optional[conlist(PaymentResponse)] = None
    next_cursor_hash: Optional[StrictStr] = Field(None, alias="nextCursorHash")
    next_link: Optional[StrictStr] = Field(None, alias="nextLink")
    paging_map: Optional[Dict[str, FilterAndSort]] = Field(None, alias="pagingMap")
    ...
    def from_dict(cls, obj: dict) -> FilteredClientPayloadListPaymentResponse:
        ...
        _obj = FilteredClientPayloadListPaymentResponse.parse_obj({
