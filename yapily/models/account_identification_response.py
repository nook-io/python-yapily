...
class AccountIdentificationResponse(BaseModel):
    ...
    identification: Optional[StrictStr] = Field(None, description="The value associated with the account identification type.<br><br> See [Account Identification Combinations](https://docs.yapily.com/pages/payments/payments-resources/intro-to-payment-execution/#account-identifications-combinations) for more information on the format of the values.")
    ...
    def from_dict(cls, obj: dict) -> AccountIdentificationResponse:
        ...
        _obj = AccountIdentificationResponse.parse_obj({
            "type": obj.get("type"),
