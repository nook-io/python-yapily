...
class AccountIdentificationResponse(BaseModel):
    ...
    identification: Optional[StrictStr] = Field(default=None, description="The value associated with the account identification type.<br><br> See [Account Identification Combinations](https://docs.yapily.com/pages/payments/payments-resources/intro-to-payment-execution/#account-identifications-combinations) for more information on the format of the values.")
