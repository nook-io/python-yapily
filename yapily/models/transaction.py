...
class Transaction(object):
    ...
    def __init__(self, id=None, date=None, booking_date_time=None, value_date_time=None, status=None, amount=None, currency=None, transaction_amount=None, gross_amount=None, currency_exchange=None, charge_details=None, reference=None, statement_references=None, description=None, transaction_information=None, address_details=None, iso_bank_transaction_code=None, proprietary_bank_transaction_code=None, balance=None, payee_details=None, payer_details=None, merchant=None, enrichment=None, supplementary_data=None, transaction_mutability=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._transaction_mutability = None
        ...
        if transaction_mutability is not None:
            self.transaction_mutability = transaction_mutability
    ...
    @property
    def transaction_mutability(self):
        """Gets the transaction_mutability of this Transaction.  # noqa: E501

        __Optional__. Specifies the Mutability of the Transaction record.<ul><li>A transaction with a `Status` of `Pending` is mutable.</li><li>A transaction with a `Status` of `Booked` where the `TransactionMutability` flag is not specified is not guaranteed to be immutable (although in most instances it will be).</li><li>A transaction with a `Status` of `Booked` with the `TransactionMutability` flag set to `Immutable` is immutable.</li><li>A transaction with a `Status` of `Booked` with the `TransactionMutability` flag set to `Mutable` is mutable.</li></ul>  # noqa: E501

        :return: The transaction_mutability of this Transaction.  # noqa: E501
        :rtype: str
        """
        return self._transaction_mutability

    @transaction_mutability.setter
    def transaction_mutability(self, transaction_mutability):
        """Sets the transaction_mutability of this Transaction.

        __Optional__. Specifies the Mutability of the Transaction record.<ul><li>A transaction with a `Status` of `Pending` is mutable.</li><li>A transaction with a `Status` of `Booked` where the `TransactionMutability` flag is not specified is not guaranteed to be immutable (although in most instances it will be).</li><li>A transaction with a `Status` of `Booked` with the `TransactionMutability` flag set to `Immutable` is immutable.</li><li>A transaction with a `Status` of `Booked` with the `TransactionMutability` flag set to `Mutable` is mutable.</li></ul>  # noqa: E501

        :param transaction_mutability: The transaction_mutability of this Transaction.  # noqa: E501
        :type: str
        """

        self._transaction_mutability = transaction_mutability
