...
class Transaction(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the transaction.")
    var_date: Optional[datetime] = Field(default=None, alias="date")
    booking_date_time: Optional[datetime] = Field(default=None, description="Date and time in UTC format of when a transaction was booked.", alias="bookingDateTime")
    value_date_time: Optional[datetime] = Field(default=None, description="Date and time in UTC format when the funds either cease to be available (for debit transactions) or become available (for credit transactions) to the account owner.", alias="valueDateTime")
    status: Optional[TransactionStatusEnum] = None
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The transaction amount.")
    currency: Optional[StrictStr] = Field(default=None, description="Currency the transaction amount is denoted in. Specified as a 3-letter ISO 4217 code.")
    ...
    transaction_information: Optional[List[StrictStr]] = Field(default=None, description="Further details on the transaction. This is narrative data, caught as unstructured text.", alias="transactionInformation")
    ...
    payee_details: Optional[TransactionPayeeDetails] = Field(default=None, alias="payeeDetails")
    payer_details: Optional[TransactionPayerDetails] = Field(default=None, alias="payerDetails")
    merchant: Optional[Merchant] = None
    enrichment: Optional[Enrichment] = None
    supplementary_data: Optional[Dict[str, Any]] = Field(default=None, description="Additional information that cannot be captured in a structured field or block.", alias="supplementaryData")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payeeDetails": TransactionPayeeDetails.from_dict(obj["payeeDetails"]) if obj.get("payeeDetails") is not None else None,
            "payerDetails": TransactionPayerDetails.from_dict(obj["payerDetails"]) if obj.get("payerDetails") is not None else None,
