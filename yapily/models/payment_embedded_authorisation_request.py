...
class PaymentEmbeddedAuthorisationRequest(BaseModel):
    """
    The request body containing an `PaymentEmbeddedAuthorisationRequest` json payload  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "PaymentEmbeddedAuthorisationRequest":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "PaymentEmbeddedAuthorisationRequest":
        """Create an instance of PaymentEmbeddedAuthorisationRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymentEmbeddedAuthorisationRequest.model_validate(obj)

        return PaymentEmbeddedAuthorisationRequest.model_validate(
            {
