...
class AmountDetailsResponse(BaseModel):
    ...
    """
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="The monetary value")
    currency: Optional[StrictStr] = Field(None, description="The [ISO 4217](https://www.xe.com/iso4217.php) currency code")
    ...
    def from_dict(cls, obj: dict) -> AmountDetailsResponse:
        ...
        _obj = AmountDetailsResponse.parse_obj({
