...
class ApiListResponseOfConsent(BaseModel):
    ...
    data: Optional[List[Consent]] = None
    ...
    paging: Optional[FilteredClientPayloadListConsent] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": [Consent.from_dict(_item) for _item in obj["data"]]
                ...
                "paging": FilteredClientPayloadListConsent.from_dict(obj["paging"])
