...
class ApiListResponseOfConsent(BaseModel):
    ...
    paging: FilteredClientPayloadListConsent | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiListResponseOfConsent":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiListResponseOfConsent":
        """Create an instance of ApiListResponseOfConsent from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiListResponseOfConsent.model_validate(obj)

        return ApiListResponseOfConsent.model_validate(
            {
                "meta": ResponseListMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
                "data": [Consent.from_dict(_item) for _item in obj.get("data")]
                ...
                "paging": FilteredClientPayloadListConsent.from_dict(obj.get("paging"))
