...
class GetAccountsTransactionsCategorised200ResponseDataTransactionsInner(BaseModel):
    ...
    transaction_amount: Optional[GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerTransactionAmount] = Field(None, alias="transactionAmount")
    reference: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    transaction_information: Optional[conlist(StrictStr)] = Field(None, alias="transactionInformation")
    proprietary_bank_transaction_code: Optional[GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerProprietaryBankTransactionCode] = Field(None, alias="proprietaryBankTransactionCode")
    iso_bank_transaction_code: Optional[GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerIsoBankTransactionCode] = Field(None, alias="isoBankTransactionCode")
    ...
    __properties = ["id", "date", "bookingDateTime", "valueDateTime", "status", "amount", "currency", "transactionAmount", "reference", "description", "transactionInformation", "proprietaryBankTransactionCode", "isoBankTransactionCode", "balance", "enrichment", "hash"]
    ...
    def from_dict(cls, obj: dict) -> GetAccountsTransactionsCategorised200ResponseDataTransactionsInner:
        ...
        _obj = GetAccountsTransactionsCategorised200ResponseDataTransactionsInner.parse_obj({
            ...
            "transaction_amount": GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerTransactionAmount.from_dict(obj.get("transactionAmount")) if obj.get("transactionAmount") is not None else None,
            "reference": obj.get("reference"),
            "description": obj.get("description"),
            "transaction_information": obj.get("transactionInformation"),
            "proprietary_bank_transaction_code": GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerProprietaryBankTransactionCode.from_dict(obj.get("proprietaryBankTransactionCode")) if obj.get("proprietaryBankTransactionCode") is not None else None,
            "iso_bank_transaction_code": GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerIsoBankTransactionCode.from_dict(obj.get("isoBankTransactionCode")) if obj.get("isoBankTransactionCode") is not None else None,
            "balance": GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerBalance.from_dict(obj.get("balance")) if obj.get("balance") is not None else None,
            "enrichment": GetAccountsTransactionsCategorised200ResponseDataTransactionsInnerEnrichment.from_dict(obj.get("enrichment")) if obj.get("enrichment") is not None else None,
            "hash": obj.get("hash")
        })
        return _obj
