...
class DeleteWebhook200Response(BaseModel):
    """
    DeleteWebhook200Response
    """

    metadata: Metadata | None = None
    data: RegisteredWebhook | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "DeleteWebhook200Response":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "DeleteWebhook200Response":
        """Create an instance of DeleteWebhook200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteWebhook200Response.model_validate(obj)

        return DeleteWebhook200Response.model_validate(
            {
