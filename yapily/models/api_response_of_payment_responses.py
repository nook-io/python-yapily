...
class ApiResponseOfPaymentResponses(BaseModel):
    ...
    data: PaymentResponses | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiResponseOfPaymentResponses":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiResponseOfPaymentResponses":
        """Create an instance of ApiResponseOfPaymentResponses from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfPaymentResponses.model_validate(obj)

        return ApiResponseOfPaymentResponses.model_validate(
            {
                "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
                "data": PaymentResponses.from_dict(obj.get("data")) if obj.get("data") is not None else None,
                "links": obj.get("links"),
