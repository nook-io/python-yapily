...
class PaymentStatusDetails(BaseModel):
    ...
    status_reason_description: Optional[StrictStr] = Field(None, alias="statusReasonDescription")
    status_update_date: Optional[datetime] = Field(None, alias="statusUpdateDate")
    multi_authorisation_status: Optional[MultiAuthorisation] = Field(None, alias="multiAuthorisationStatus")
    iso_status: Optional[PaymentIsoStatus] = Field(None, alias="isoStatus")
    __properties = ["status", "statusReason", "statusReasonDescription", "statusUpdateDate", "multiAuthorisationStatus", "isoStatus"]
    ...
    def from_dict(cls, obj: dict) -> PaymentStatusDetails:
        ...
        _obj = PaymentStatusDetails.parse_obj({
            ...
            "multi_authorisation_status": MultiAuthorisation.from_dict(obj.get("multiAuthorisationStatus")) if obj.get("multiAuthorisationStatus") is not None else None,
            "iso_status": PaymentIsoStatus.from_dict(obj.get("isoStatus")) if obj.get("isoStatus") is not None else None
        })
        return _obj
