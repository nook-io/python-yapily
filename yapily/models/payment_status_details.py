...
class PaymentStatusDetails(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "multiAuthorisationStatus": MultiAuthorisation.from_dict(obj["multiAuthorisationStatus"]) if obj.get("multiAuthorisationStatus") is not None else None,
            "isoStatus": PaymentIsoStatus.from_dict(obj["isoStatus"]) if obj.get("isoStatus") is not None else None
        })
        return _obj
