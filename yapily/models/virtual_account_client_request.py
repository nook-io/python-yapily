...
class VirtualAccountClientRequest(BaseModel):
    """
    VirtualAccountClientRequest
    """
    type: VirtualAccountClientType = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VirtualAccountClientRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VirtualAccountClientRequest:
        """Create an instance of VirtualAccountClientRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VirtualAccountClientRequest.parse_obj(obj)

        _obj = VirtualAccountClientRequest.parse_obj({
            "type": obj.get("type"),
