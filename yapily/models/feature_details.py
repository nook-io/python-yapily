...
class FeatureDetails(BaseModel):
    ...
    endpoint: Optional[StrictStr] = Field(default=None, description="Endpoints that are associated with the feature e.g. (available for use if an Institution supports a feature).")
    documentation_url: Optional[StrictStr] = Field(default=None, description="The link to further documentation regarding the feature.", alias="documentationUrl")
