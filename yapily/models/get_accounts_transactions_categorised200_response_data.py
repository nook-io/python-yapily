...
class GetAccountsTransactionsCategorised200ResponseData(BaseModel):
    ...
    """ # noqa: E501
    transactions: Optional[List[GetAccountsTransactionsCategorised200ResponseDataTransactionsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transactions": [GetAccountsTransactionsCategorised200ResponseDataTransactionsInner.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None
        })
        return _obj
