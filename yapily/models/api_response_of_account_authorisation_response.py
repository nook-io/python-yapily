...
class ApiResponseOfAccountAuthorisationResponse(BaseModel):
    ...
    data: AccountAuthorisationResponse | None = None
    ...
    def from_dict(cls, obj: dict) -> "ApiResponseOfAccountAuthorisationResponse":
        ...
        if not isinstance(obj, dict):
            return ApiResponseOfAccountAuthorisationResponse.model_validate(obj)

        return ApiResponseOfAccountAuthorisationResponse.model_validate(
            {
                "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
                "data": AccountAuthorisationResponse.from_dict(obj.get("data"))
