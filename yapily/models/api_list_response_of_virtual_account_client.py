...
class ApiListResponseOfVirtualAccountClient(BaseModel):
    ...
    data: Optional[conlist(VirtualAccountClient)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiListResponseOfVirtualAccountClient:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiListResponseOfVirtualAccountClient:
        """Create an instance of ApiListResponseOfVirtualAccountClient from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiListResponseOfVirtualAccountClient.parse_obj(obj)

        _obj = ApiListResponseOfVirtualAccountClient.parse_obj({
