...
class SearchApplicationsPublicFilterValuesParameter(BaseModel):
    ...
    """
    application_ids: Optional[conlist(StrictStr, max_items=15)] = Field(None, alias="applicationIds", description="Sub-application ids to filter the results for. If provided, the results will only include sub-applications with the given ids. Non-existent ids will be ignored.")
    offset: Optional[conint(strict=True, ge=0)] = Field(0, description="The number of results to skip.")
    limit: Optional[conint(strict=True, le=1000, ge=1)] = Field(1000, description="The maximum number of results to return.")
    sort: Optional[StrictStr] = Field('name', description="The field to sort the results by.<br><br>Possible values:<ul><li>`last_updated` (ascending)</li><li>`-last_updated` (descending)</li><li>`name` (ascending)</li><li>`-name` (descending)</li><li>`uuid` (ascending)</li><li>`-uuid` (descending)</li></ul>")
