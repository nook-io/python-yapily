...
class SweepingPeriodicLimits(BaseModel):
    ...
    frequency: Annotated[StrictStr, Field(description='__Mandatory__. Frequency for which the payment limits are enforced. Allowed values are [DAILY, WEEKLY, EVERY_TWO_WEEKS, MONTHLY, YEARLY].')] = ...
