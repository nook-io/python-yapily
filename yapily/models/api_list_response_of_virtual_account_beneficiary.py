...
class ApiListResponseOfVirtualAccountBeneficiary(BaseModel):
    """
    ApiListResponseOfVirtualAccountBeneficiary
    """
    meta: Optional[ResponseListMeta] = None
    links: Optional[Links] = None
    data: Optional[conlist(VirtualAccountBeneficiary)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiListResponseOfVirtualAccountBeneficiary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiListResponseOfVirtualAccountBeneficiary:
        """Create an instance of ApiListResponseOfVirtualAccountBeneficiary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiListResponseOfVirtualAccountBeneficiary.parse_obj(obj)

        _obj = ApiListResponseOfVirtualAccountBeneficiary.parse_obj({
            ...
            "data": [VirtualAccountBeneficiary.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
