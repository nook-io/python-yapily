...
class HostedVRPConsentDetails(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "HostedVRPConsentDetails":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "HostedVRPConsentDetails":
        """Create an instance of HostedVRPConsentDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HostedVRPConsentDetails.model_validate(obj)

        return HostedVRPConsentDetails.model_validate(
            {
                "id": obj.get("id"),
