...
class HostedVRPConsentDetails(BaseModel):
    ...
    user_id: Optional[StrictStr] = Field(None, alias="userId", description="Represents the Unique Identifier for the `User` assigned by Yapily.")
    ...
    application_id: StrictStr = Field(..., alias="applicationId", description="Represens the Unique Identifier of the `Application` the user is associated with.")
    ...
    consent_token: Optional[StrictStr] = Field(None, alias="consentToken", description="Represents the authorisation to make VRP payments")
    consent_status: StrictStr = Field(..., alias="consentStatus", description="Current status of the authorisation. Can be one of [AWAITING_AUTHORIZATION, AUTHORIZED, REJECTED, REVOKED, FAILED, EXPIRED]")
    phases: Optional[conlist(HostedVRPPhase)] = None
    __properties = ["id", "userId", "applicationUserId", "applicationId", "institutionIdentifiers", "userSettings", "redirectUrl", "vrpSetup", "createdAt", "authorisationExpiresAt", "consentToken", "consentStatus", "phases"]
    ...
    def from_dict(cls, obj: dict) -> HostedVRPConsentDetails:
        ...
        _obj = HostedVRPConsentDetails.parse_obj({
            "id": obj.get("id"),
            ...
            "phases": [HostedVRPPhase.from_dict(_item) for _item in obj.get("phases")] if obj.get("phases") is not None else None
        })
        return _obj
