...
class EventSubscriptionResponse(BaseModel):
    ...
    """
    event_type_id: StrictStr = Field(..., alias="eventTypeId", description="Unique identifier of the event type (for which notifications will be sent)")
    application_id: StrictStr = Field(..., alias="applicationId", description="Application related to event subscription.")
