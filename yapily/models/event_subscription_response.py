...
class EventSubscriptionResponse(BaseModel):
    ...
    """ # noqa: E501
    event_type_id: StrictStr = Field(description="Unique identifier of the event type (for which notifications will be sent)", alias="eventTypeId")
    application_id: StrictStr = Field(description="Application related to event subscription.", alias="applicationId")
    created: StrictStr = Field(description="Creation date of event subscription.")
    notification: Notification
    __properties: ClassVar[List[str]] = ["eventTypeId", "applicationId", "created", "notification"]
