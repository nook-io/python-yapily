...
class VirtualAccountBeneficiaryAccount(BaseModel):
    ...
    account_identifications: List[AccountIdentification] = Field(description="The account identifications that identify the Beneficiary bank account.", alias="accountIdentifications")
    __properties: ClassVar[List[str]] = ["currency", "bankName", "bankAddress", "bankCountry", "accountIdentifications"]
