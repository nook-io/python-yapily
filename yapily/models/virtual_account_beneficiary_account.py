...
class VirtualAccountBeneficiaryAccount(BaseModel):
    """
    ...
    account_identifications: conlist(AccountIdentification, unique_items=True) = Field(..., alias="accountIdentifications", description="The account identifications that identify the Beneficiary bank account.")
    __properties = ["currency", "bankName", "bankAddress", "bankCountry", "accountIdentifications"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VirtualAccountBeneficiaryAccount:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VirtualAccountBeneficiaryAccount:
        """Create an instance of VirtualAccountBeneficiaryAccount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VirtualAccountBeneficiaryAccount.parse_obj(obj)

        _obj = VirtualAccountBeneficiaryAccount.parse_obj({
