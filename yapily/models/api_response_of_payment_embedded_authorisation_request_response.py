...
class ApiResponseOfPaymentEmbeddedAuthorisationRequestResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ApiResponseOfPaymentEmbeddedAuthorisationRequestResponse:
        ...
        _obj = ApiResponseOfPaymentEmbeddedAuthorisationRequestResponse.parse_obj({
            "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": PaymentEmbeddedAuthorisationRequestResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "links": obj.get("links"),
