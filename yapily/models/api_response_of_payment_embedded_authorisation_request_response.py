...
class ApiResponseOfPaymentEmbeddedAuthorisationRequestResponse(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> "ApiResponseOfPaymentEmbeddedAuthorisationRequestResponse":
        ...
        if not isinstance(obj, dict):
            return ApiResponseOfPaymentEmbeddedAuthorisationRequestResponse.model_validate(obj)

        return ApiResponseOfPaymentEmbeddedAuthorisationRequestResponse.model_validate(
            {
