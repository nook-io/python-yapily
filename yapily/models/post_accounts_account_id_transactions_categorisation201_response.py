...
class PostAccountsAccountIdTransactionsCategorisation201Response(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "meta": GetBulkPaymentStatus200ResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "data": PostAccountsAccountIdTransactionsCategorisation201ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
