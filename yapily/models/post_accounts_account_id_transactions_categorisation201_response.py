...
class PostAccountsAccountIdTransactionsCategorisation201Response(BaseModel):
    ...
    """
    meta: Optional[PostAccountsAccountIdTransactionsCategorisation201ResponseMeta] = None
    data: Optional[PostAccountsAccountIdTransactionsCategorisation201ResponseData] = None
    ...
    def from_dict(cls, obj: dict) -> PostAccountsAccountIdTransactionsCategorisation201Response:
        ...
        _obj = PostAccountsAccountIdTransactionsCategorisation201Response.parse_obj({
            "meta": PostAccountsAccountIdTransactionsCategorisation201ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": PostAccountsAccountIdTransactionsCategorisation201ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
