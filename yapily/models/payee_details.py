...
class PayeeDetails(BaseModel):
    ...
    country: StrictStr = Field(..., description="__Conditional__. The 2-letter ISO 3166 country code for the address. <br><br>An `Institution` may require you to specify the `country` when used in the context of the `Payee` to be able to make a payment")
