...
class ApiResponseOfFinancialProfileBalancePrediction(BaseModel):
    """
    ApiResponseOfFinancialProfileBalancePrediction
    """

    meta: ResponseMeta | None = None
    data: BalancePredictionProfile | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiResponseOfFinancialProfileBalancePrediction":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiResponseOfFinancialProfileBalancePrediction":
        """Create an instance of ApiResponseOfFinancialProfileBalancePrediction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfFinancialProfileBalancePrediction.model_validate(obj)

        return ApiResponseOfFinancialProfileBalancePrediction.model_validate(
            {
                "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
                "data": BalancePredictionProfile.from_dict(obj.get("data")) if obj.get("data") is not None else None,
                "links": obj.get("links"),
            }
        )
