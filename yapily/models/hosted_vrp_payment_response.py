...
class HostedVRPPaymentResponse(BaseModel):
    ...
    refund_account: Optional[HostedVrpRefundAccount] = Field(default=None, alias="refundAccount")
    ...
    institution_payment_id: Optional[StrictStr] = Field(default=None, alias="institutionPaymentId")
    status_details: Optional[HostedPaymentStatusDetails] = Field(default=None, alias="statusDetails")
    __properties: ClassVar[List[str]] = ["id", "paymentIdempotencyId", "amount", "reference", "payee", "payer", "refundAccount", "risk", "paymentLifecycleId", "expectedExecutionTime", "expectedSettlementTime", "institutionPaymentId", "statusDetails"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "payer": HostedVrpPayerResponse.from_dict(obj["payer"]) if obj.get("payer") is not None else None,
            "refundAccount": HostedVrpRefundAccount.from_dict(obj["refundAccount"]) if obj.get("refundAccount") is not None else None,
            ...
            "statusDetails": HostedPaymentStatusDetails.from_dict(obj["statusDetails"]) if obj.get("statusDetails") is not None else None
        })
        return _obj
