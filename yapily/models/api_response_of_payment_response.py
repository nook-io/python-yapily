...
class ApiResponseOfPaymentResponse(BaseModel):
    ...
    data: PaymentResponse | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiResponseOfPaymentResponse":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiResponseOfPaymentResponse":
        """Create an instance of ApiResponseOfPaymentResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfPaymentResponse.model_validate(obj)

        return ApiResponseOfPaymentResponse.model_validate(
            {
                "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
                "data": PaymentResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None,
                "links": obj.get("links"),
