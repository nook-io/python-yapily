...
class ApiResponseOfApplicationResponse(BaseModel):
    ...
    data: ApplicationResponse | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiResponseOfApplicationResponse":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiResponseOfApplicationResponse":
        """Create an instance of ApiResponseOfApplicationResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfApplicationResponse.model_validate(obj)

        return ApiResponseOfApplicationResponse.model_validate(
            {
                "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
                "data": ApplicationResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            }
        )
