...
class Identity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "firstName", "lastName", "fullName", "gender", "birthdate", "email", "phone", "addresses"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "email": obj.get("email"),
            "phone": obj.get("phone"),
            "addresses": [IdentityAddress.from_dict(_item) for _item in obj["addresses"]] if obj.get("addresses") is not None else None
        })
        return _obj
