...
class ApiListResponseOfDataConstraints(BaseModel):
    ...
    data: list[DataConstraintsResponse] | None = None
    ...
    def from_dict(cls, obj: dict) -> "ApiListResponseOfDataConstraints":
        ...
        if not isinstance(obj, dict):
            return ApiListResponseOfDataConstraints.model_validate(obj)

        return ApiListResponseOfDataConstraints.model_validate(
            {
                "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
                "data": [DataConstraintsResponse.from_dict(_item) for _item in obj.get("data")]
