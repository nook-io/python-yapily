...
class HostedPaymentResponseDetails(BaseModel):
    ...
    """ # noqa: E501
    payment_idempotency_id: Optional[StrictStr] = Field(default=None, description="A unique identifier provided to identify the payment. This can be any alpha-numeric string but is limited to a maximum of 35 characters.", alias="paymentIdempotencyId")
    ...
    payment_due_date: Optional[date] = Field(default=None, description="The date that the payment is due.", alias="paymentDueDate")
    __properties: ClassVar[List[str]] = ["paymentIdempotencyId", "reference", "contextType", "type", "payee", "payer", "amountDetails", "paymentDueDate"]
