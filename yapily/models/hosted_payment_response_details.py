...
class HostedPaymentResponseDetails(BaseModel):
    ...
    """
    payment_idempotency_id: Optional[StrictStr] = Field(None, alias="paymentIdempotencyId", description="A unique identifier provided to identify the payment. This can be any alpha-numeric string but is limited to a maximum of 35 characters.")
    ...
    amount_details: Optional[AmountDetailsResponse] = Field(None, alias="amountDetails")
    payment_due_date: Optional[date] = Field(None, alias="paymentDueDate", description="The date that the payment is due.")
    __properties = ["paymentIdempotencyId", "reference", "contextType", "type", "payee", "payer", "amountDetails", "paymentDueDate"]
    ...
    def from_dict(cls, obj: dict) -> HostedPaymentResponseDetails:
        ...
        _obj = HostedPaymentResponseDetails.parse_obj({
            ...
            "amount_details": AmountDetailsResponse.from_dict(obj.get("amountDetails")) if obj.get("amountDetails") is not None else None,
