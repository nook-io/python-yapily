...
class ApiResponseOfRevokeHostedVRPConsentRequest(BaseModel):
    """
    ApiResponseOfRevokeHostedVRPConsentRequest
    """

    meta: ResponseMeta | None = None
    data: HostedVRPConsentDetails | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiResponseOfRevokeHostedVRPConsentRequest":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiResponseOfRevokeHostedVRPConsentRequest":
        """Create an instance of ApiResponseOfRevokeHostedVRPConsentRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfRevokeHostedVRPConsentRequest.model_validate(obj)

        return ApiResponseOfRevokeHostedVRPConsentRequest.model_validate(
            {
