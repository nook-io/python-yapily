...
class ApiResponseOfCreateHostedVRPConsentRequest(BaseModel):
    """
    ApiResponseOfCreateHostedVRPConsentRequest
    """

    meta: ResponseMeta | None = None
    data: HostedVRPConsentRequestResponse | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiResponseOfCreateHostedVRPConsentRequest":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiResponseOfCreateHostedVRPConsentRequest":
        """Create an instance of ApiResponseOfCreateHostedVRPConsentRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfCreateHostedVRPConsentRequest.model_validate(obj)

        return ApiResponseOfCreateHostedVRPConsentRequest.model_validate(
            {
                "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
                "data": HostedVRPConsentRequestResponse.from_dict(obj.get("data"))
