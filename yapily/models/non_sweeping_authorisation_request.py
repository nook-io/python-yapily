...
class NonSweepingAuthorisationRequest(BaseModel):
    ...
    control_parameters: Annotated[NonSweepingControlParameters, Field(alias="controlParameters")]
    ...
    def from_dict(cls, obj: dict) -> "NonSweepingAuthorisationRequest":
        ...
        if not isinstance(obj, dict):
            return NonSweepingAuthorisationRequest.model_validate(obj)

        return NonSweepingAuthorisationRequest.model_validate(
            {
