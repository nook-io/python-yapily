...
class NonSweepingAuthorisationRequest(BaseModel):
    ...
    context_type: Optional[StrictStr] = Field(None, alias="contextType", description="__Optional__. The payment context code. Allowed values are [BILL_IN_ADVANCE, BILL_IN_ARREARS, ECOMMERCE_MERCHANT, FACE_TO_FACE_POS, TRANSFER_TO_SELF,TRANSFER_TO_THIRD_PARTY, PISP_PAYEE ].")
    ...
    compliance_data: Optional[ComplianceData] = Field(None, alias="complianceData")
    __properties = ["userId", "applicationUserId", "forwardParameters", "contextType", "institutionId", "callback", "redirect", "oneTimeToken", "controlParameters", "initiationDetails", "complianceData"]
    ...
    def from_dict(cls, obj: dict) -> NonSweepingAuthorisationRequest:
        ...
        _obj = NonSweepingAuthorisationRequest.parse_obj({
            ...
            "compliance_data": ComplianceData.from_dict(obj.get("complianceData")) if obj.get("complianceData") is not None else None
        })
        return _obj
