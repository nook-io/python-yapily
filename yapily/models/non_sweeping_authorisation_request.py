...
class NonSweepingAuthorisationRequest(BaseModel):
    ...
    context_type: Optional[StrictStr] = Field(default=None, description="__Optional__. The payment context code. Allowed values are [BILL_IN_ADVANCE, BILL_IN_ARREARS, ECOMMERCE_MERCHANT, FACE_TO_FACE_POS, TRANSFER_TO_SELF,TRANSFER_TO_THIRD_PARTY, PISP_PAYEE ].", alias="contextType")
    ...
    compliance_data: Optional[ComplianceData] = Field(default=None, alias="complianceData")
    __properties: ClassVar[List[str]] = ["userId", "applicationUserId", "forwardParameters", "contextType", "institutionId", "callback", "redirect", "oneTimeToken", "controlParameters", "initiationDetails", "complianceData"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "complianceData": ComplianceData.from_dict(obj["complianceData"]) if obj.get("complianceData") is not None else None
        })
        return _obj
