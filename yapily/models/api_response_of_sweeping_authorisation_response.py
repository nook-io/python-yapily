...
class ApiResponseOfSweepingAuthorisationResponse(BaseModel):
    ...
    __properties = ["meta", "data", "links", "forwardedData", "tracingId"]
    ...
    def from_dict(cls, obj: dict) -> ApiResponseOfSweepingAuthorisationResponse:
        ...
        _obj = ApiResponseOfSweepingAuthorisationResponse.parse_obj({
            "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": SweepingAuthorisationResponse.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "links": obj.get("links"),
