...
class ApiResponseOfSweepingAuthorisationResponse(BaseModel):
    """
    ApiResponseOfSweepingAuthorisationResponse
    """

    meta: ResponseMeta | None = None
    data: SweepingAuthorisationResponse | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiResponseOfSweepingAuthorisationResponse":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiResponseOfSweepingAuthorisationResponse":
        """Create an instance of ApiResponseOfSweepingAuthorisationResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiResponseOfSweepingAuthorisationResponse.model_validate(obj)

        return ApiResponseOfSweepingAuthorisationResponse.model_validate(
            {
                "meta": ResponseMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
                "data": SweepingAuthorisationResponse.from_dict(obj.get("data"))
