...
class ApiResponseOfSweepingAuthorisationResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["meta", "data", "links", "forwardedData", "tracingId", "raw"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": SweepingAuthorisationResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "links": obj.get("links"),
