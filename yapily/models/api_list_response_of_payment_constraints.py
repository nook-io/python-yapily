...
class ApiListResponseOfPaymentConstraints(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "ApiListResponseOfPaymentConstraints":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "ApiListResponseOfPaymentConstraints":
        """Create an instance of ApiListResponseOfPaymentConstraints from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiListResponseOfPaymentConstraints.model_validate(obj)

        return ApiListResponseOfPaymentConstraints.model_validate(
            {
                "meta": ResponseListMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
                "data": [PaymentConstraintsResponse.from_dict(_item) for _item in obj.get("data")]
