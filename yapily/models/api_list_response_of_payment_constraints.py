...
class ApiListResponseOfPaymentConstraints(BaseModel):
    ...
    data: Optional[conlist(PaymentConstraintsResponse)] = None
    ...
    def from_dict(cls, obj: dict) -> ApiListResponseOfPaymentConstraints:
        ...
        _obj = ApiListResponseOfPaymentConstraints.parse_obj({
            "meta": ResponseListMeta.from_dict(obj.get("meta")) if obj.get("meta") is not None else None,
            "data": [PaymentConstraintsResponse.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
