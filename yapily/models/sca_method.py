...
class ScaMethod(object):
    ...
    def id(self):
        ...
        __Mandatory__. The id of the sca method provided by the `Institution`  # noqa: E501
    ...
    def description(self):
        ...
        __Optional__. A description of the sca method if provided by the `Institution`  # noqa: E501
