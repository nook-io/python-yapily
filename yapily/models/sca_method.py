...
class ScaMethod(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="__Optional__. A description of the sca method if provided by the `Institution`")
    information: Optional[StrictStr] = Field(default=None, description="Additional information from the institution to provide to the PSU to help with the selected SCA method. The language is determined by the institution and may vary.")
    data: Optional[List[StrictStr]] = Field(default=None, description="Data from the institution to provide to the PSU to complete authorisation. The language is determined by the institution and may vary.")
    __properties: ClassVar[List[str]] = ["id", "type", "description", "information", "data"]
