...
class GetCategorisationAccountType200Response(BaseModel):
    ...
    data: Optional[GetCategorisationAccountType200ResponseData] = None
    ...
    def from_dict(cls, obj: dict) -> GetCategorisationAccountType200Response:
        ...
        _obj = GetCategorisationAccountType200Response.parse_obj({
            ...
            "data": GetCategorisationAccountType200ResponseData.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
