...
class HostedPaymentRequestDetails(BaseModel):
    ...
    """ # noqa: E501
    payment_idempotency_id: StrictStr = Field(description="A unique identifier that you must provide to identify the payment. This can be any alpha-numeric string but is limited to a maximum of 35 characters.", alias="paymentIdempotencyId")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "amountDetails": HostedAmountDetails.from_dict(obj["amountDetails"]) if obj.get("amountDetails") is not None else None,
