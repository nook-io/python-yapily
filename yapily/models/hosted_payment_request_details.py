...
class HostedPaymentRequestDetails(BaseModel):
    ...
    """
    payment_idempotency_id: StrictStr = Field(..., alias="paymentIdempotencyId", description="A unique identifier that you must provide to identify the payment. This can be any alpha-numeric string but is limited to a maximum of 35 characters.")
    ...
    payment_due_date: Optional[date] = Field(None, alias="paymentDueDate", description="The date that the payment is due. Displayed to the end user in the payment summary screen.")
    ...
    def from_dict(cls, obj: dict) -> HostedPaymentRequestDetails:
        ...
        _obj = HostedPaymentRequestDetails.parse_obj({
            ...
            "amount_details": HostedAmountDetails.from_dict(obj.get("amountDetails")) if obj.get("amountDetails") is not None else None,
