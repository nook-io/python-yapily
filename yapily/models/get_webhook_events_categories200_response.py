...
class GetWebhookEventsCategories200Response(BaseModel):
    """
    GetWebhookEventsCategories200Response
    """

    metadata: Metadata | None = None
    data: GetWebhookEventsCategories200ResponseData | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> "GetWebhookEventsCategories200Response":
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> "GetWebhookEventsCategories200Response":
        """Create an instance of GetWebhookEventsCategories200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetWebhookEventsCategories200Response.model_validate(obj)

        return GetWebhookEventsCategories200Response.model_validate(
            {
