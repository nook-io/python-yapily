...
class InternationalPaymentRequest(BaseModel):
    ...
    """
    currency_of_transfer: StrictStr = Field(..., alias="currencyOfTransfer", description="__Mandatory__. The 3-letter currency code for the currency of the payment to be transferred which can differ from the currency of the payer's account.")
