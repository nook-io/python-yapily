...
class InternationalPaymentRequest(BaseModel):
    ...
    """ # noqa: E501
    currency_of_transfer: StrictStr = Field(description="__Mandatory__. The 3-letter currency code for the currency of the payment to be transferred which can differ from the currency of the payer's account.", alias="currencyOfTransfer")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "exchangeRateInformation": ExchangeRateInformation.from_dict(obj.get("exchangeRateInformation")) if obj.get("exchangeRateInformation") is not None else None,
