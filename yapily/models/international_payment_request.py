...
class InternationalPaymentRequest(BaseModel):
    ...
    """ # noqa: E501
    currency_of_transfer: StrictStr = Field(description="__Mandatory__. The currency to be transferred to the payee. This may differ from the currency the payment is denoted in and the currency of the payer's account. Specified as a 3-letter code (ISO 4217).", alias="currencyOfTransfer")
    exchange_rate_information: Optional[ExchangeRateInformation] = Field(default=None, alias="exchangeRateInformation")
    purpose: Optional[StrictStr] = Field(default=None, description="__Optional__. Used to indicate the external purpose as a [ISO20022 purpose code](https://www.rba.hr/documents/20182/183267/External+purpose+codes+list/8a28f888-1f83-5e29-d6ed-fce05f428689?version=1.1) value.")
    priority: Optional[PriorityCodeEnum] = None
    charge_bearer: Optional[ChargeBearerType] = Field(default=None, alias="chargeBearer")
    __properties: ClassVar[List[str]] = ["currencyOfTransfer", "exchangeRateInformation", "purpose", "priority", "chargeBearer"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "exchangeRateInformation": ExchangeRateInformation.from_dict(obj["exchangeRateInformation"]) if obj.get("exchangeRateInformation") is not None else None,
