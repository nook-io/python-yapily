...
class EventSubscriptionRequest(BaseModel):
    ...
    """
    event_type_id: StrictStr = Field(..., alias="eventTypeId", description="Unique identifier of the event type (for which notifications will be sent).<br><br>Allowed values: payment.status, payment.status.completed, payment.isoStatus ")
