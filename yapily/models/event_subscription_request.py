...
class EventSubscriptionRequest(BaseModel):
    ...
    """ # noqa: E501
    event_type_id: StrictStr = Field(description="Unique identifier of the event type (for which notifications will be sent).<br><br>Allowed values: payment.status, payment.status.completed, payment.isoStatus ", alias="eventTypeId")
