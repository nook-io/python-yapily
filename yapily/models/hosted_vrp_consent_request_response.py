...
class HostedVRPConsentRequestResponse(BaseModel):
    ...
    user_id: Optional[StrictStr] = Field(default=None, description="Represents the Unique Id for the `User` assigned by Yapily.", alias="userId")
    ...
    application_id: StrictStr = Field(description="Represents the Unique Id of the `Application` the user is associated with.", alias="applicationId")
    ...
    hosted_url: StrictStr = Field(description="Represents the URL of Hosted UI page for the applicationId which initiates the user journey for the Consent. <br> URL would be appended with authToken, applicationId and userSettings.", alias="hostedUrl")
    auth_token: StrictStr = Field(description="Represents the JWT Token signed by the certificate-vault using Yapily's keys.", alias="authToken")
    created_at: datetime = Field(description="Represents the date and time at which the Consent was created.", alias="createdAt")
    ...
    __properties: ClassVar[List[str]] = ["id", "userId", "applicationUserId", "applicationId", "institutionIdentifiers", "userSettings", "redirectUrl", "vrpSetup", "hostedUrl", "authToken", "createdAt", "authorisationExpiresAt"]
