...
class ApiClient:
    ...
    def __deserialize_date(self, string):
        ...
        try:
            ...
            raise rest.ApiException(status=0, reason=f"Failed to parse `{string}` as date object") from exc
    ...
    def __deserialize_datetime(self, string):
        ...
        try:
            ...
            raise rest.ApiException(status=0, reason=f"Failed to parse `{string}` as datetime object") from exc
