...
class FinancialDataApi:
    ...
    @validate_arguments
    def get_categories(self, country : Annotated[StrictStr, Field(..., description="__Mandatory__. The 2 letter country code e.g. 'GB'.")], **kwargs) -> ApiListResponseOfCategory:  # noqa: E501
