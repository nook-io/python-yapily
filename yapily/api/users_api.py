...
class UsersApi:
    ...
    @validate_arguments
    def add_user(self, new_application_user : NewApplicationUser, **kwargs) -> ApplicationUser:  # noqa: E501
    ...
    @validate_arguments
    def delete_user(self, user_uuid : Annotated[StrictStr, Field(..., description="__Mandatory__. The Yapily generated UUID for the user.")], **kwargs) -> ApiResponseOfUserDeleteResponse:  # noqa: E501
    ...
    def delete_user_with_http_info(self, user_uuid : Annotated[StrictStr, Field(..., description="__Mandatory__. The Yapily generated UUID for the user.")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        # process the path parameters
        _path_params = {}
        if _params['user_uuid'] is not None:
    ...
    @validate_arguments
    def get_user(self, user_uuid : Annotated[StrictStr, Field(..., description="__Mandatory__. The Yapily generated UUID for the user.")], **kwargs) -> ApplicationUser:  # noqa: E501
        """Get User  # noqa: E501
    ...
    @validate_arguments
    def get_users(self, filter_application_user_id : Annotated[Optional[conlist(StrictStr, unique_items=True)], Field(description="__Optional__. Filter records based on the list of `applicationUserId` users provided.")] = None, **kwargs) -> List[ApplicationUser]:  # noqa: E501
        """Get Users  # noqa: E501
