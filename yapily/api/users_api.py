...
class UsersApi:
    ...
    async def add_user(
        ...
        return await self.add_user_with_http_info(new_application_user, **kwargs)  # noqa: E501
    ...
    async def add_user_with_http_info(
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s' to method add_user" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def delete_user(
        ...
        **kwargs,
    ) -> ApiResponseOfUserDeleteResponse:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.delete_user_with_http_info(user_uuid, **kwargs)  # noqa: E501
    ...
    async def get_user(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.get_user_with_http_info(user_uuid, **kwargs)  # noqa: E501
    ...
    async def get_users(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.get_users_with_http_info(filter_application_user_id, **kwargs)  # noqa: E501
