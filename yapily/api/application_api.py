...
class ApplicationApi:
    ...
    async def get_application_me(
        ...
        _param = self._get_application_me_serialize(
    ...
    @validate_call
    async def get_application_me_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_application_me_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_application_me_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
