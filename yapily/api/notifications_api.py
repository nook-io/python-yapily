...
class NotificationsApi:
    ...
    async def delete_event_subscription_by_id(
        self,
        event_type_id: Annotated[StrictStr, Field(description="Unique identifier of the event type (for which notifications will be sent). ")],
        sub_application: Annotated[Optional[StrictStr], Field(description="The sub-application ID for which event type will be deleted")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def get_event_subscriptions(
        self,
        sub_application: Annotated[Optional[StrictStr], Field(description="The sub-application ID for which all event subscriptions will be returned")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
