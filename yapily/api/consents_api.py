...
class ConsentsApi(object):
    ...
    def extend_consent(self, consent_id, extend_consent_request, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str consent_id: __Mandatory__. The consent Id of the `Consent` to update. (required)
        :param ExtendConsentRequest extend_consent_request: (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def extend_consent_with_http_info(self, consent_id, extend_consent_request, **kwargs):  # noqa: E501
        """Extend Consent  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('consent_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['consent_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `consent_id` when calling `extend_consent`")  # noqa: E501
        # verify the required parameter 'extend_consent_request' is set
        if self.api_client.client_side_validation and ('extend_consent_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['extend_consent_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `extend_consent_request` when calling `extend_consent`")  # noqa: E501
        ...
        body_params = None
        if 'extend_consent_request' in local_var_params:
            body_params = local_var_params['extend_consent_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json;charset=UTF-8'])  # noqa: E501
    ...
    def get_consents(self, **kwargs):  # noqa: E501
        ...
        :param list[str] filter_status: __Optional__. Filter records based on the list of `Consent` [statuses](https://docs.yapily.com/api/reference/#operation/getConsents!c=200&path=data/status&t=response).
