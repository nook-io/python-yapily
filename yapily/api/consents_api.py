...
class ConsentsApi:
    ...
    async def delete(
        ...
        **kwargs,
    ) -> ApiResponseOfConsentDeleteResponse:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.delete_with_http_info(consent_id, force_delete, **kwargs)  # noqa: E501
    ...
    async def extend_consent(
        ...
        **kwargs,
    ) -> ApiResponseOfConsent:  # noqa: E501
    ...
    async def get_consent_by_id(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.get_consent_by_id_with_http_info(consent_id, **kwargs)  # noqa: E501
