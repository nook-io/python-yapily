...
class ConsentsApi:
    ...
    @validate_arguments
    def create_consent_with_code(self, consent_auth_code_request : ConsentAuthCodeRequest, **kwargs) -> Consent:  # noqa: E501
    ...
    @validate_arguments
    def delete(self, consent_id : Annotated[StrictStr, Field(..., description="__Mandatory__. The consent Id of the `Consent` to update.")], force_delete : Annotated[Optional[StrictBool], Field(description="__Optional__. Whether to force the deletion.")] = None, **kwargs) -> ApiResponseOfConsentDeleteResponse:  # noqa: E501
    ...
    @validate_arguments
    def extend_consent(self, consent_id : Annotated[StrictStr, Field(..., description="__Mandatory__. The consent Id of the `Consent` to update.")], extend_consent_request : ExtendConsentRequest, **kwargs) -> ApiResponseOfConsent:  # noqa: E501
    ...
    @validate_arguments
    def get_consent_by_id(self, consent_id : Annotated[StrictStr, Field(..., description="__Mandatory__. The consent Id of the `Consent` to update.")], **kwargs) -> ApiResponseOfConsent:  # noqa: E501
    ...
    @validate_arguments
    def get_consent_by_single_access_consent(self, one_time_token_request : OneTimeTokenRequest, **kwargs) -> Consent:  # noqa: E501
