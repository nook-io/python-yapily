...
class ConsentsApi:
    ...
    async def create_consent_with_code_with_http_info(
        ...
        _all_params = ["consent_auth_code_request"]
        _all_params.extend(
            [
    ...
    async def delete(
        ...
        **kwargs,
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the delete_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
    ...
    async def delete_with_http_info(
        ...
        **kwargs,
        ...
        _all_params = ["consent_id", "force_delete"]
        _all_params.extend(
            [
                "_return_http_data_only",
                "_preload_content",
        ...
        # process the query parameters
        _query_params = []
        if _params.get("force_delete") is not None:
    ...
    async def extend_consent_with_http_info(
        ...
        **kwargs,
        ...
        _all_params = ["consent_id", "extend_consent_request"]
        _all_params.extend(
            [
                "_return_http_data_only",
                "_preload_content",
    ...
    async def get_consent_by_id(
        ...
        **kwargs,
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_consent_by_id_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
    ...
    async def get_consent_by_single_access_consent_with_http_info(
        ...
        _all_params = ["one_time_token_request"]
        _all_params.extend(
            [
                "_return_http_data_only",
                "_preload_content",
    ...
    async def get_consents(
        ...
        **kwargs,
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_consents_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.get_consents_with_http_info(
