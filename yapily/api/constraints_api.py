...
class ConstraintsApi:
    ...
    async def get_account_constraints_rules_by_institution_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_account_constraints_rules_by_institution"
                )
            _params[_key] = _val
        del _params["kwargs"]
        ...
        _query_params = []
        if _params.get("institution_ids") is not None:
        ...
        if _params.get("endpoint_method") is not None:
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    f"Got an unexpected keyword argument '{_key}'"
                    " to method get_payment_constraints_rules_by_institution"
                )
            _params[_key] = _val
        del _params["kwargs"]
