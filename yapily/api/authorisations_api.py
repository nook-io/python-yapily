...
class AuthorisationsApi:
    ...
    @overload
    async def create_payment_pre_authorisation_request(self, payment_pre_authorisation_request : PaymentPreAuthorisationRequest, raw : Annotated[Optional[StrictBool], Field(description="__Optional__. Used to obtain the raw request and response to and from the <code>Institution</code>.")] = None, psu_ip_address : Annotated[Optional[StrictStr], Field(description="__Conditional__. The IP address of the PSU. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.")] = None, **kwargs) -> ApiResponseOfPreAuthorisationResponse:  # noqa: E501
        ...

    @overload
    def create_payment_pre_authorisation_request(self, payment_pre_authorisation_request : PaymentPreAuthorisationRequest, raw : Annotated[Optional[StrictBool], Field(description="__Optional__. Used to obtain the raw request and response to and from the <code>Institution</code>.")] = None, psu_ip_address : Annotated[Optional[StrictStr], Field(description="__Conditional__. The IP address of the PSU. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.")] = None, async_req: Optional[bool]=True, **kwargs) -> ApiResponseOfPreAuthorisationResponse:  # noqa: E501
        ...

    @validate_arguments
    def create_payment_pre_authorisation_request(self, payment_pre_authorisation_request : PaymentPreAuthorisationRequest, raw : Annotated[Optional[StrictBool], Field(description="__Optional__. Used to obtain the raw request and response to and from the <code>Institution</code>.")] = None, psu_ip_address : Annotated[Optional[StrictStr], Field(description="__Conditional__. The IP address of the PSU. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[ApiResponseOfPreAuthorisationResponse, Awaitable[ApiResponseOfPreAuthorisationResponse]]:  # noqa: E501
        """Create Payment Pre-authorisation  # noqa: E501

        Used to initiate the pre-authorisation process for payments for CBI Globe institutions that contain the `INITIATE_ONETIME_PRE_AUTHORISATION_PAYMENTS` feature to authenticate the user. <br><br>Feature: `INITIATE_ONETIME_PRE_AUTHORISATION_PAYMENTS`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_payment_pre_authorisation_request(payment_pre_authorisation_request, raw, psu_ip_address, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ApiResponseOfPreAuthorisationResponse
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
        ...
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.create_payment_pre_authorisation_request_with_http_info(payment_pre_authorisation_request, raw, psu_ip_address, **kwargs)  # noqa: E501

    @validate_arguments
    def create_payment_pre_authorisation_request_with_http_info(self, payment_pre_authorisation_request : PaymentPreAuthorisationRequest, raw : Annotated[Optional[StrictBool], Field(description="__Optional__. Used to obtain the raw request and response to and from the <code>Institution</code>.")] = None, psu_ip_address : Annotated[Optional[StrictStr], Field(description="__Conditional__. The IP address of the PSU. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create Payment Pre-authorisation  # noqa: E501
        ...
        >>> thread = api.create_payment_pre_authorisation_request_with_http_info(payment_pre_authorisation_request, raw, psu_ip_address, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ApiResponseOfPreAuthorisationResponse, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    @overload
    async def create_pre_authorisation_request(self, pre_authorisation_request : PreAuthorisationRequest, raw : Annotated[Optional[StrictBool], Field(description="__Optional__. Used to obtain the raw request and response to and from the <code>Institution</code>.")] = None, psu_id : Annotated[Optional[StrictStr], Field(description="__Conditional__. Represents the user's login ID for the `Institution` to a personal account. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.")] = None, psu_corporate_id : Annotated[Optional[StrictStr], Field(description="__Conditional__. Represents the user's login ID for the `Institution` to a business account. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.")] = None, psu_ip_address : Annotated[Optional[StrictStr], Field(description="__Conditional__. The IP address of the PSU. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.")] = None, **kwargs) -> ApiResponseOfPreAuthorisationResponse:  # noqa: E501
        ...

    @overload
    def create_pre_authorisation_request(self, pre_authorisation_request : PreAuthorisationRequest, raw : Annotated[Optional[StrictBool], Field(description="__Optional__. Used to obtain the raw request and response to and from the <code>Institution</code>.")] = None, psu_id : Annotated[Optional[StrictStr], Field(description="__Conditional__. Represents the user's login ID for the `Institution` to a personal account. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.")] = None, psu_corporate_id : Annotated[Optional[StrictStr], Field(description="__Conditional__. Represents the user's login ID for the `Institution` to a business account. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.")] = None, psu_ip_address : Annotated[Optional[StrictStr], Field(description="__Conditional__. The IP address of the PSU. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.")] = None, async_req: Optional[bool]=True, **kwargs) -> ApiResponseOfPreAuthorisationResponse:  # noqa: E501
        ...
    ...
    def create_pre_authorisation_request(self, pre_authorisation_request : PreAuthorisationRequest, raw : Annotated[Optional[StrictBool], Field(description="__Optional__. Used to obtain the raw request and response to and from the <code>Institution</code>.")] = None, psu_id : Annotated[Optional[StrictStr], Field(description="__Conditional__. Represents the user's login ID for the `Institution` to a personal account. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.")] = None, psu_corporate_id : Annotated[Optional[StrictStr], Field(description="__Conditional__. Represents the user's login ID for the `Institution` to a business account. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.")] = None, psu_ip_address : Annotated[Optional[StrictStr], Field(description="__Conditional__. The IP address of the PSU. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.")] = None, async_req: Optional[bool]=None, **kwargs) -> Union[ApiResponseOfPreAuthorisationResponse, Awaitable[ApiResponseOfPreAuthorisationResponse]]:  # noqa: E501
        ...
        >>> thread = api.create_pre_authorisation_request(pre_authorisation_request, raw, psu_id, psu_corporate_id, psu_ip_address, async_req=True)
        >>> result = thread.get()
        ...
        if async_req is not None:
            kwargs['async_req'] = async_req
        return self.create_pre_authorisation_request_with_http_info(pre_authorisation_request, raw, psu_id, psu_corporate_id, psu_ip_address, **kwargs)  # noqa: E501

    @validate_arguments
    def create_pre_authorisation_request_with_http_info(self, pre_authorisation_request : PreAuthorisationRequest, raw : Annotated[Optional[StrictBool], Field(description="__Optional__. Used to obtain the raw request and response to and from the <code>Institution</code>.")] = None, psu_id : Annotated[Optional[StrictStr], Field(description="__Conditional__. Represents the user's login ID for the `Institution` to a personal account. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.")] = None, psu_corporate_id : Annotated[Optional[StrictStr], Field(description="__Conditional__. Represents the user's login ID for the `Institution` to a business account. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.")] = None, psu_ip_address : Annotated[Optional[StrictStr], Field(description="__Conditional__. The IP address of the PSU. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create Pre-authorisation  # noqa: E501
        ...
        >>> thread = api.create_pre_authorisation_request_with_http_info(pre_authorisation_request, raw, psu_id, psu_corporate_id, psu_ip_address, async_req=True)
        >>> result = thread.get()
