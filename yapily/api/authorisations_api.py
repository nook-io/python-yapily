...
class AuthorisationsApi:
    ...
    async def create_bulk_payment_authorisation_with_http_info(
        ...
        **kwargs,
        ...
        _query_params = []
        if _params.get("raw") is not None:
    ...
    async def create_embedded_payment_authorisation(
        ...
        **kwargs,
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the create_embedded_payment_authorisation_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.create_embedded_payment_authorisation_with_http_info(
    ...
    async def initiate_embedded_account_request(
        ...
        **kwargs,
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the initiate_embedded_account_request_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.initiate_embedded_account_request_with_http_info(
    ...
    async def update_embedded_account_request(
        ...
        **kwargs,
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the update_embedded_account_request_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.update_embedded_account_request_with_http_info(
            consent_id,
            embedded_account_authorisation_request,
            psu_id,
            psu_corporate_id,
    ...
    async def update_embedded_bulk_payment_authorisation(
        ...
        **kwargs,
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the update_embedded_bulk_payment_authorisation_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.update_embedded_bulk_payment_authorisation_with_http_info(
            consent_id,
            bulk_payment_embedded_authorisation_request,
            psu_id,
            psu_corporate_id,
    ...
    async def update_embedded_payment_authorisation(
        ...
        **kwargs,
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the update_embedded_payment_authorisation_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.update_embedded_payment_authorisation_with_http_info(
            consent_id,
            payment_embedded_authorisation_request,
            psu_id,
            psu_corporate_id,
    ...
    async def update_pre_authorise_account_consent(
        ...
        **kwargs,
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the update_pre_authorise_account_consent_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.update_pre_authorise_account_consent_with_http_info(
            consent,
            account_authorisation_request,
            psu_id,
            psu_corporate_id,
