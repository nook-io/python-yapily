...
class AuthorisationsApi(object):
    ...
    def create_payment_pre_authorisation_request_with_http_info(self, payment_pre_authorisation_request, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ApiResponseOfAccountAuthorisationResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ApiResponseOfAccountAuthorisationResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def initiate_embedded_account_request(self, embedded_account_authorisation_request, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param EmbeddedAccountAuthorisationRequest embedded_account_authorisation_request: (required)
        :param str psu_id: __Conditional__. Represents the user's login ID for the `Institution` to a personal account. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.
        :param str psu_corporate_id: __Conditional__. Represents the user's login ID for the `Institution` to a business account. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.
        :param str psu_ip_address: __Conditional__. The IP address of the PSU. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.
        :param bool raw: __Optional__. Used to obtain the raw request and response to and from the <code>Institution</code>.
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.initiate_embedded_account_request_with_http_info(embedded_account_authorisation_request, **kwargs)  # noqa: E501

    def initiate_embedded_account_request_with_http_info(self, embedded_account_authorisation_request, **kwargs):  # noqa: E501
        """Create Embedded Account Authorisation  # noqa: E501

        Used to initiate the embedded authorisation process for an `Institution` that contains the `INITIATE_EMBEDDED_ACCOUNT_REQUEST` feature in order to obtain the the user's authorisation to access their account information. <br><br>See [Embedded Account Flows](https://docs.yapily.com/pages/key-concepts/account-data/account-authorisation/embedded-account-flows/) for more information about this flow.<br><br>Feature: `INITIATE_EMBEDDED_ACCOUNT_REQUEST`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.initiate_embedded_account_request_with_http_info(embedded_account_authorisation_request, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ApiResponseOfEmbeddedAccountAuthorisationResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            ...
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'embedded_account_authorisation_request' is set
        if self.api_client.client_side_validation and ('embedded_account_authorisation_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['embedded_account_authorisation_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `embedded_account_authorisation_request` when calling `initiate_embedded_account_request`")  # noqa: E501
        ...
        body_params = None
        if 'embedded_account_authorisation_request' in local_var_params:
            body_params = local_var_params['embedded_account_authorisation_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json;charset=UTF-8'])  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ApiResponseOfEmbeddedAccountAuthorisationResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def update_embedded_account_request(self, consent_id, embedded_account_authorisation_request, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_embedded_account_request_with_http_info(consent_id, embedded_account_authorisation_request, **kwargs)  # noqa: E501

    def update_embedded_account_request_with_http_info(self, consent_id, embedded_account_authorisation_request, **kwargs):  # noqa: E501
        """Update Embedded Account Authorisation  # noqa: E501

        Used to pass the SCA Code received from the `Institution` (and the SCA method selected by the user where multiple SCA methods are supported by the `Institution`) in order to complete the embedded authorisation to access the user's financial data. <br><br>See [Embedded Account Flows](https://docs.yapily.com/pages/key-concepts/account-data/account-authorisation/embedded-account-flows/) for more information about this flow.<br><br>Feature: `INITIATE_EMBEDDED_ACCOUNT_REQUEST`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_embedded_account_request_with_http_info(consent_id, embedded_account_authorisation_request, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('embedded_account_authorisation_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['embedded_account_authorisation_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `embedded_account_authorisation_request` when calling `update_embedded_account_request`")  # noqa: E501
