...
class InstitutionsApi:
    ...
    async def get_feature_details(self, **kwargs) -> ApiListResponseOfFeatureDetails:
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_feature_details_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
    ...
    async def get_institution(
        ...
        **kwargs,
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_institution_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
    ...
    async def get_institutions(self, **kwargs) -> ApiListResponseOfInstitution:
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_institutions_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
