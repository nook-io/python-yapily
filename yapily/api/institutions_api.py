...
class InstitutionsApi:
    ...
    @validate_arguments
    def get_feature_details(self, **kwargs) -> ApiListResponseOfFeatureDetails:  # noqa: E501
    ...
    @validate_arguments
    def get_institution(self, institution_id : Annotated[StrictStr, Field(..., description="__Mandatory__. The Yapily institution Id for the `Institution`.")], **kwargs) -> Institution:  # noqa: E501
    ...
    def get_institution_with_http_info(self, institution_id : Annotated[StrictStr, Field(..., description="__Mandatory__. The Yapily institution Id for the `Institution`.")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        # process the path parameters
        _path_params = {}
        if _params['institution_id'] is not None:
    ...
    @validate_arguments
    def get_institutions(self, **kwargs) -> ApiListResponseOfInstitution:  # noqa: E501
