...
class HostedPaymentPagesApi:
    ...
    async def create_hosted_payment_request_link(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.create_hosted_payment_request_link_with_http_info(
    ...
    async def create_hosted_vrp_consent_request(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.create_hosted_vrp_consent_request_with_http_info(
    ...
    async def get_hosted_vrp_consent_request(
        ...
        **kwargs,
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_hosted_vrp_consent_request_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_hosted_vrp_consent_request" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def get_hosted_vrp_payment_request(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.get_hosted_vrp_payment_request_with_http_info(
