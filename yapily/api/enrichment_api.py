...
class EnrichmentApi:
    ...
    async def get_accounts_transactions_categorised(
        ...
        categorisation_id: Annotated[StrictStr, Field(description="Unique identifier for transaction categorisation request")],
        ...
        limit: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=100)]], Field(description="__Optional__. The maximum number of transaction records to be returned. Must be between 100 and 1000. If not specified will default to 100.")] = None,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=1)]], Field(description="__Optional__. The page number to be returned. If not specified will default to 1.")] = None,
    ...
    async def post_accounts_account_id_transactions_categorisation(
        ...
        sub_application: Annotated[Optional[StrictStr], Field(description="The sub-application ID to which event type is being subscribed to")] = None,
        post_accounts_account_id_transactions_categorisation_request: Optional[PostAccountsAccountIdTransactionsCategorisationRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
