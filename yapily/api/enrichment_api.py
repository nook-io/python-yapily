...
class EnrichmentApi:
    ...
    def get_accounts_transactions_categorised(self, consent : Annotated[StrictStr, Field(..., description="__Mandatory__. The `consent-token` containing the user's authorisation to make the request.")], account_id : Annotated[StrictStr, Field(..., description="Unique identifier for account")], categorisation_id : Annotated[StrictStr, Field(..., description="Unique identifier for transaction categorisation request")], limit : Annotated[Optional[StrictInt], Field(description="__Optional__. The maximum number of transaction records to be returned. Must be between 1 and 1000.")] = None, **kwargs) -> GetAccountsTransactionsCategorised200Response:  # noqa: E501
        ...
        >>> thread = api.get_accounts_transactions_categorised(consent, account_id, categorisation_id, limit, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_accounts_transactions_categorised_with_http_info(consent, account_id, categorisation_id, limit, **kwargs)  # noqa: E501

    @validate_arguments
    def get_accounts_transactions_categorised_with_http_info(self, consent : Annotated[StrictStr, Field(..., description="__Mandatory__. The `consent-token` containing the user's authorisation to make the request.")], account_id : Annotated[StrictStr, Field(..., description="Unique identifier for account")], categorisation_id : Annotated[StrictStr, Field(..., description="Unique identifier for transaction categorisation request")], limit : Annotated[Optional[StrictInt], Field(description="__Optional__. The maximum number of transaction records to be returned. Must be between 1 and 1000.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get Categorised Transactions  # noqa: E501
        ...
        >>> thread = api.get_accounts_transactions_categorised_with_http_info(consent, account_id, categorisation_id, limit, async_req=True)
        >>> result = thread.get()
        ...
        _response_types_map = {
            ...
            '400': "PostAccountsAccountIdTransactionsCategorisation400Response",
            '401': "PostAccountsAccountIdTransactionsCategorisation401Response",
            '500': "GetAccountsTransactionsCategorised500Response",
        }

        return self.api_client.call_api(
            '/accounts/{accountId}/transactions/categorisation/{categorisationId}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_categorisation_account_type(self, account_type : Annotated[StrictStr, Field(..., description="type of bank account (consumer or business)")], **kwargs) -> GetCategorisationAccountType200Response:  # noqa: E501
        ...
        >>> thread = api.get_categorisation_account_type(account_type, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.get_categorisation_account_type_with_http_info(account_type, **kwargs)  # noqa: E501

    @validate_arguments
    def get_categorisation_account_type_with_http_info(self, account_type : Annotated[StrictStr, Field(..., description="type of bank account (consumer or business)")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get the list of all categories for a specific account type  # noqa: E501
        ...
        >>> thread = api.get_categorisation_account_type_with_http_info(account_type, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            '/transactions/categorisation/categories/{accountType}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def post_accounts_account_id_transactions_categorisation(self, consent : Annotated[StrictStr, Field(..., description="__Mandatory__. The `consent-token` containing the user's authorisation to make the request.")], account_id : Annotated[StrictStr, Field(..., description="Unique identifier for account")], psu_id : Annotated[Optional[StrictStr], Field(description="__Conditional__. Represents the user's login ID for the `Institution` to a personal account. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.")] = None, psu_corporate_id : Annotated[Optional[StrictStr], Field(description="__Conditional__. Represents the user's login ID for the `Institution` to a business account. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.")] = None, psu_ip_address : Annotated[Optional[StrictStr], Field(description="__Conditional__. The IP address of the PSU. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.")] = None, post_accounts_account_id_transactions_categorisation_request : Optional[PostAccountsAccountIdTransactionsCategorisationRequest] = None, **kwargs) -> PostAccountsAccountIdTransactionsCategorisation201Response:  # noqa: E501
        ...
        >>> thread = api.post_accounts_account_id_transactions_categorisation(consent, account_id, psu_id, psu_corporate_id, psu_ip_address, post_accounts_account_id_transactions_categorisation_request, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.post_accounts_account_id_transactions_categorisation_with_http_info(consent, account_id, psu_id, psu_corporate_id, psu_ip_address, post_accounts_account_id_transactions_categorisation_request, **kwargs)  # noqa: E501

    @validate_arguments
    def post_accounts_account_id_transactions_categorisation_with_http_info(self, consent : Annotated[StrictStr, Field(..., description="__Mandatory__. The `consent-token` containing the user's authorisation to make the request.")], account_id : Annotated[StrictStr, Field(..., description="Unique identifier for account")], psu_id : Annotated[Optional[StrictStr], Field(description="__Conditional__. Represents the user's login ID for the `Institution` to a personal account. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.")] = None, psu_corporate_id : Annotated[Optional[StrictStr], Field(description="__Conditional__. Represents the user's login ID for the `Institution` to a business account. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.")] = None, psu_ip_address : Annotated[Optional[StrictStr], Field(description="__Conditional__. The IP address of the PSU. <br><br>See [PSU identifiers](https://docs.yapily.com/pages/knowledge/open-banking/psu_identifiers/) to see if this header is required.")] = None, post_accounts_account_id_transactions_categorisation_request : Optional[PostAccountsAccountIdTransactionsCategorisationRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Trigger transaction categorisation  # noqa: E501
        ...
        >>> thread = api.post_accounts_account_id_transactions_categorisation_with_http_info(consent, account_id, psu_id, psu_corporate_id, psu_ip_address, post_accounts_account_id_transactions_categorisation_request, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_accounts_account_id_transactions_categorisation" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            ...
            '400': "PostAccountsAccountIdTransactionsCategorisation400Response",
            '401': "PostAccountsAccountIdTransactionsCategorisation401Response",
            '500': "PostAccountsAccountIdTransactionsCategorisation500Response",
        }

        return self.api_client.call_api(
            '/accounts/{accountId}/transactions/categorisation', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
