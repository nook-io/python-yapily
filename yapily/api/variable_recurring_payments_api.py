...
class VariableRecurringPaymentsApi:
    ...
    @validate_call
    async def getp_non_sweeping_vrp_consent_by_id(
        self,
        consent_id: Annotated[StrictStr, Field(description="__Mandatory__. The consent Id of the `Variable Recurring Payments Consent` to retrieve.")],
        _request_timeout: Union[
            None,
        ...
        _param = self._getp_non_sweeping_vrp_consent_by_id_serialize(
            consent_id=consent_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def getp_non_sweeping_vrp_consent_by_id_with_http_info(
        self,
        consent_id: Annotated[StrictStr, Field(description="__Mandatory__. The consent Id of the `Variable Recurring Payments Consent` to retrieve.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def getp_non_sweeping_vrp_consent_by_id_without_preload_content(
        self,
        consent_id: Annotated[StrictStr, Field(description="__Mandatory__. The consent Id of the `Variable Recurring Payments Consent` to retrieve.")],
        _request_timeout: Union[
            None,
    ...
    def _getp_non_sweeping_vrp_consent_by_id_serialize(
        self,
        consent_id,
        _request_auth,
        _content_type,
