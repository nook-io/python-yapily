...
class VariableRecurringPaymentsApi:
    ...
    @overload
    async def get_non_sweeping_vrp_consent_by_id(self, consent_id : Annotated[StrictStr, Field(..., description="__Mandatory__. The consent Id of the `Variable Recurring Payments Consent` to retrieve.")], **kwargs) -> ApiResponseOfNonSweepingAuthorisationResponse:  # noqa: E501
        ...

    @overload
    def get_non_sweeping_vrp_consent_by_id(self, consent_id : Annotated[StrictStr, Field(..., description="__Mandatory__. The consent Id of the `Variable Recurring Payments Consent` to retrieve.")], async_req: Optional[bool]=True, **kwargs) -> ApiResponseOfNonSweepingAuthorisationResponse:  # noqa: E501
        ...

    @validate_arguments
    def get_non_sweeping_vrp_consent_by_id(self, consent_id : Annotated[StrictStr, Field(..., description="__Mandatory__. The consent Id of the `Variable Recurring Payments Consent` to retrieve.")], async_req: Optional[bool]=None, **kwargs) -> Union[ApiResponseOfNonSweepingAuthorisationResponse, Awaitable[ApiResponseOfNonSweepingAuthorisationResponse]]:  # noqa: E501
