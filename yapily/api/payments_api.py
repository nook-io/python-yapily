...
class PaymentsApi:
    ...
    async def create_bulk_payment(
        ...
        **kwargs,
    ) -> ApiResponseOfPaymentResponse:  # noqa: E501
    ...
    async def create_bulk_payment_with_http_info(
        ...
        **kwargs,
        ...
        _body_params = None
        if _params["submit_bulk_payment_request"] is not None:
    ...
    async def get_bulk_payment_status(
        ...
        **kwargs,
    ) -> GetBulkPaymentStatus200Response:  # noqa: E501
        """Get Bulk Payment File Status  # noqa: E501

        Returns the bulk file status of the bulk payment for given bulkPaymentId  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetBulkPaymentStatus200Response
        """
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_bulk_payment_status_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
    ...
    async def get_bulk_payment_status_with_http_info(
        ...
        **kwargs,
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetBulkPaymentStatus200Response, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = ["consent", "bulk_payment_id"]
        _all_params.extend(
            [
                "_return_http_data_only",
                "_preload_content",
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_bulk_payment_status" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
        ...
        # process the path parameters
        _path_params = {}
        if _params["bulk_payment_id"] is not None:
            _path_params["bulkPaymentId"] = _params["bulk_payment_id"]
    ...
    async def get_payments(
        ...
        **kwargs,
    ) -> ApiResponseOfPaymentResponses:  # noqa: E501
