...
class HostedPagesApi:
    ...
    @validate_arguments
    def create_hosted_payment_request(self, create_hosted_payment_request : CreateHostedPaymentRequest, **kwargs) -> ApiResponseOfCreateHostedPaymentRequest:  # noqa: E501
    ...
    @validate_arguments
    def create_hosted_payment_request_link(self, create_hosted_payment_request_link : CreateHostedPaymentRequestLink, **kwargs) -> ApiResponseOfCreateHostedPaymentRequestLink:  # noqa: E501
    ...
    @validate_arguments
    def create_hosted_vrp_consent_request(self, sub_application : Annotated[StrictStr, Field(..., description="__Mandatory__. The unique identifier of the sub application the request is being submitted on behalf of (e.g. an underlying merchant)")], create_hosted_vrp_consent_request : CreateHostedVRPConsentRequest, **kwargs) -> ApiResponseOfCreateHostedVRPConsentRequest:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.create_hosted_vrp_consent_request_with_http_info(sub_application, create_hosted_vrp_consent_request, **kwargs)  # noqa: E501

    @validate_arguments
    def create_hosted_vrp_consent_request_with_http_info(self, sub_application : Annotated[StrictStr, Field(..., description="__Mandatory__. The unique identifier of the sub application the request is being submitted on behalf of (e.g. an underlying merchant)")], create_hosted_vrp_consent_request : CreateHostedVRPConsentRequest, **kwargs) -> ApiResponse:  # noqa: E501
        """Create VRP Consent  # noqa: E501
        ...
        return self.api_client.call_api(
            '/hosted/vrp/consent-requests', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def create_hosted_vrp_funds_confirmation(self, consent_request_id : Annotated[StrictStr, Field(..., description="Unique Identifier of the Consent Request")], consent_token : Annotated[StrictStr, Field(..., description="__Mandatory__. The `consent-token` containing the user's authorisation to make the request.")], funds_confirmation_request : FundsConfirmationRequest, sub_application : Annotated[Optional[StrictStr], Field(description="The unique identifier of the sub application the request is being submitted on behalf of (e.g. an underlying merchant)")] = None, **kwargs) -> ApiResponseOfFundsConfirmationResponse:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.create_hosted_vrp_funds_confirmation_with_http_info(consent_request_id, consent_token, funds_confirmation_request, sub_application, **kwargs)  # noqa: E501

    @validate_arguments
    def create_hosted_vrp_funds_confirmation_with_http_info(self, consent_request_id : Annotated[StrictStr, Field(..., description="Unique Identifier of the Consent Request")], consent_token : Annotated[StrictStr, Field(..., description="__Mandatory__. The `consent-token` containing the user's authorisation to make the request.")], funds_confirmation_request : FundsConfirmationRequest, sub_application : Annotated[Optional[StrictStr], Field(description="The unique identifier of the sub application the request is being submitted on behalf of (e.g. an underlying merchant)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Check Funds Availability  # noqa: E501
        ...
        return self.api_client.call_api(
            '/hosted/vrp/consent-requests/{consentRequestId}/funds-confirmation', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def create_hosted_vrp_payment(self, consent_request_id : Annotated[StrictStr, Field(..., description="Unique Identifier of the Consent Request")], consent_token : Annotated[StrictStr, Field(..., description="__Mandatory__. The `consent-token` containing the user's authorisation to make the request.")], create_hosted_vrp_payment_request : CreateHostedVRPPaymentRequest, sub_application : Annotated[Optional[StrictStr], Field(description="The unique identifier of the sub application the request is being submitted on behalf of (e.g. an underlying merchant)")] = None, **kwargs) -> ApiResponseOfCreateHostedVRPPaymentRequest:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.create_hosted_vrp_payment_with_http_info(consent_request_id, consent_token, create_hosted_vrp_payment_request, sub_application, **kwargs)  # noqa: E501

    @validate_arguments
    def create_hosted_vrp_payment_with_http_info(self, consent_request_id : Annotated[StrictStr, Field(..., description="Unique Identifier of the Consent Request")], consent_token : Annotated[StrictStr, Field(..., description="__Mandatory__. The `consent-token` containing the user's authorisation to make the request.")], create_hosted_vrp_payment_request : CreateHostedVRPPaymentRequest, sub_application : Annotated[Optional[StrictStr], Field(description="The unique identifier of the sub application the request is being submitted on behalf of (e.g. an underlying merchant)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create VRP Payment  # noqa: E501
        ...
        return self.api_client.call_api(
            '/hosted/vrp/consent-requests/{consentRequestId}/payments', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_hosted_consent_request(self, consent_request_id : Annotated[StrictStr, Field(..., description="Unique Identifier of the Consent Request")], sub_application : Annotated[Optional[StrictStr], Field(description="The unique identifier of the sub application the request is being submitted on behalf of (e.g. an underlying merchant)")] = None, **kwargs) -> ApiResponseOfGetHostedVRPConsentRequest:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.get_hosted_consent_request_with_http_info(consent_request_id, sub_application, **kwargs)  # noqa: E501

    @validate_arguments
    def get_hosted_consent_request_with_http_info(self, consent_request_id : Annotated[StrictStr, Field(..., description="Unique Identifier of the Consent Request")], sub_application : Annotated[Optional[StrictStr], Field(description="The unique identifier of the sub application the request is being submitted on behalf of (e.g. an underlying merchant)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get Hosted VRP Consent Request  # noqa: E501
        ...
        return self.api_client.call_api(
            '/hosted/vrp/consent-requests/{consentRequestId}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_hosted_payment_request(self, payment_request_id : Annotated[StrictStr, Field(..., description="Unique Identifier of the payment request")], **kwargs) -> ApiResponseOfGetHostedPaymentRequest:  # noqa: E501
    ...
    @validate_arguments
    def get_hosted_vrp_consent_requests(self, sub_application : Annotated[StrictStr, Field(..., description="__Mandatory__. The unique identifier of the sub application the request is being submitted on behalf of (e.g. an underlying merchant)")], **kwargs) -> ApiResponseOfGetHostedVRPConsentsRequest:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.get_hosted_vrp_consent_requests_with_http_info(sub_application, **kwargs)  # noqa: E501

    @validate_arguments
    def get_hosted_vrp_consent_requests_with_http_info(self, sub_application : Annotated[StrictStr, Field(..., description="__Mandatory__. The unique identifier of the sub application the request is being submitted on behalf of (e.g. an underlying merchant)")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get Hosted VRP Consent Requests  # noqa: E501
        ...
        return self.api_client.call_api(
            '/hosted/vrp/consent-requests', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_hosted_vrp_payment_request(self, consent_request_id : Annotated[StrictStr, Field(..., description="Unique Identifier of the Consent Request")], payment_id : Annotated[StrictStr, Field(..., description="Unique Identifier of the Consent Request")], sub_application : Annotated[Optional[StrictStr], Field(description="The unique identifier of the sub application the request is being submitted on behalf of (e.g. an underlying merchant)")] = None, **kwargs) -> ApiResponseOfGetHostedVRPPaymentRequest:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.get_hosted_vrp_payment_request_with_http_info(consent_request_id, payment_id, sub_application, **kwargs)  # noqa: E501

    @validate_arguments
    def get_hosted_vrp_payment_request_with_http_info(self, consent_request_id : Annotated[StrictStr, Field(..., description="Unique Identifier of the Consent Request")], payment_id : Annotated[StrictStr, Field(..., description="Unique Identifier of the Consent Request")], sub_application : Annotated[Optional[StrictStr], Field(description="The unique identifier of the sub application the request is being submitted on behalf of (e.g. an underlying merchant)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get VRP payment  # noqa: E501
        ...
        return self.api_client.call_api(
            '/hosted/vrp/consent-requests/{consentRequestId}/payments/{paymentId}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def revoke_hosted_consent_request(self, consent_request_id : Annotated[StrictStr, Field(..., description="Unique Identifier of the Consent Request")], sub_application : Annotated[Optional[StrictStr], Field(description="The unique identifier of the sub application the request is being submitted on behalf of (e.g. an underlying merchant)")] = None, **kwargs) -> ApiResponseOfRevokeHostedVRPConsentRequest:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.revoke_hosted_consent_request_with_http_info(consent_request_id, sub_application, **kwargs)  # noqa: E501

    @validate_arguments
    def revoke_hosted_consent_request_with_http_info(self, consent_request_id : Annotated[StrictStr, Field(..., description="Unique Identifier of the Consent Request")], sub_application : Annotated[Optional[StrictStr], Field(description="The unique identifier of the sub application the request is being submitted on behalf of (e.g. an underlying merchant)")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Revoke Hosted VRP Consent Request  # noqa: E501
        ...
        return self.api_client.call_api(
            '/hosted/vrp/consent-requests/{consentRequestId}/revoke', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
