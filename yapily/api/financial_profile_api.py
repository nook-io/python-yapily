...
class FinancialProfileApi:
    ...
    @validate_arguments
    def delete_profile_consent(self, user_uuid : Annotated[StrictStr, Field(..., description="__Mandatory__. The Yapily generated UUID for the user.")], profile_consent_id : Annotated[StrictStr, Field(..., description="__Mandatory__. The ID of the ProfileConsent")], **kwargs) -> ApiResponseOfFinancialProfileConsentRemoveResponse:  # noqa: E501
    ...
    def delete_profile_consent_with_http_info(self, user_uuid : Annotated[StrictStr, Field(..., description="__Mandatory__. The Yapily generated UUID for the user.")], profile_consent_id : Annotated[StrictStr, Field(..., description="__Mandatory__. The ID of the ProfileConsent")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        if _params['profile_consent_id'] is not None:
    ...
    @validate_arguments
    def get_balance_prediction(self, user_uuid : Annotated[StrictStr, Field(..., description="__Mandatory__. The Yapily generated UUID for the user.")], **kwargs) -> ApiResponseOfFinancialProfileBalancePrediction:  # noqa: E501
    ...
    @validate_arguments
    def get_profile_consent(self, user_uuid : Annotated[StrictStr, Field(..., description="__Mandatory__. The Yapily generated UUID for the user.")], profile_consent_id : Annotated[StrictStr, Field(..., description="__Mandatory__. The ID of the ProfileConsent")], **kwargs) -> ApiResponseOfFinancialProfileConsent:  # noqa: E501
        """Get Profile Consent  # noqa: E501

        Used to retrieve a specific ProfileConsent for a User.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    @validate_arguments
    def get_user_profile(self, user_uuid : Annotated[StrictStr, Field(..., description="__Mandatory__. The Yapily generated UUID for the user.")], **kwargs) -> ApiResponseOfFinancialProfile:  # noqa: E501
        """Get Transaction Groups  # noqa: E501

        Used to retrieve a `TransactionGroups` for a `User`.  Status will be `PENDING` until all ProfileConsents are `COMPLETED`.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_user_profile_with_http_info(self, user_uuid : Annotated[StrictStr, Field(..., description="__Mandatory__. The Yapily generated UUID for the user.")], **kwargs) -> ApiResponse:  # noqa: E501
        ...
        return self.api_client.call_api(
            '/users/{userUuid}/profile/transaction-groups', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
