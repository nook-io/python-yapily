...
class FinancialProfileApi:
    ...
    async def create_profile_consent(
        ...
        **kwargs,
    ) -> ApiResponseOfFinancialProfileAuthorisationResponse:  # noqa: E501
    ...
    async def delete_profile_consent_with_http_info(
        ...
        **kwargs,
        ...
        _all_params = ["user_uuid", "profile_consent_id"]
        _all_params.extend(
            [
                "_return_http_data_only",
                "_preload_content",
    ...
    async def get_balance_prediction(
        ...
        **kwargs,
    ) -> ApiResponseOfFinancialProfileBalancePrediction:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.get_balance_prediction_with_http_info(user_uuid, **kwargs)  # noqa: E501
    ...
    async def get_profile_consent(
        ...
        **kwargs,
    ) -> ApiResponseOfFinancialProfileConsent:  # noqa: E501
    ...
    async def get_user_profile(
        ...
        **kwargs,
    ) -> ApiResponseOfFinancialProfile:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.get_user_profile_with_http_info(user_uuid, **kwargs)  # noqa: E501
