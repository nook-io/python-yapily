...
class FinancialDataApi(object):
    ...
    def get_categories(self, country, **kwargs):  # noqa: E501
        ...
        Used to retrieve the list of categories returned by the Yapily Categorisation engine for a given locale. <br><br>See [Data Enrichment](https://docs.yapily.com/guides/financial-data/data-enrichment) for more information.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
