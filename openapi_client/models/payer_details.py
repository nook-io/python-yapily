...
class PayerDetails(object):
    ...
    def __init__(self, account_identifications=None, local_vars_configuration=None):  # noqa: E501
        """PayerDetails - a model defined in OpenAPI"""  # noqa: E501
    ...
    def account_identifications(self):
        """Gets the account_identifications of this PayerDetails.  # noqa: E501

        __Mandatory__. The account identifications that identify the `Payer` bank account.  # noqa: E501

        :return: The account_identifications of this PayerDetails.  # noqa: E501
    ...
    def account_identifications(self, account_identifications):
        """Sets the account_identifications of this PayerDetails.

        __Mandatory__. The account identifications that identify the `Payer` bank account.  # noqa: E501

        :param account_identifications: The account_identifications of this PayerDetails.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PayerDetails):
            return False
