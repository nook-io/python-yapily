...
class TestApiListResponseOfFeatureDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiListResponseOfFeatureDetails:
        """Test ApiListResponseOfFeatureDetails
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiListResponseOfFeatureDetails`
        """
        model = ApiListResponseOfFeatureDetails()  # noqa: E501
        if include_optional:
            return ApiListResponseOfFeatureDetails(
                ...
                paging = yapily.models.filtered_client_payload_list_feature_details.FilteredClientPayloadListFeatureDetails(
