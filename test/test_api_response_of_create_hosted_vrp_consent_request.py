...
from yapily.models.api_response_of_create_hosted_vrp_consent_request import ApiResponseOfCreateHostedVRPConsentRequest  # noqa: E501

class TestApiResponseOfCreateHostedVRPConsentRequest(unittest.TestCase):
    """ApiResponseOfCreateHostedVRPConsentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseOfCreateHostedVRPConsentRequest:
        """Test ApiResponseOfCreateHostedVRPConsentRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseOfCreateHostedVRPConsentRequest`
        """
        model = ApiResponseOfCreateHostedVRPConsentRequest()  # noqa: E501
        if include_optional:
            return ApiResponseOfCreateHostedVRPConsentRequest(
                meta = yapily.models.response_meta.ResponseMeta(
                    tracing_id = '', ),
                data = yapily.models.hosted_vrp_consent_request_response.HostedVRPConsentRequestResponse(
                    id = '', 
                    user_id = '', 
                    application_user_id = '', 
                    application_id = '', 
                    ...
                    vrp_setup = yapily.models.vrp_setup_request.VRPSetupRequest(
                        ...
                        limits = yapily.models.hosted_vrp_limits_request.HostedVRPLimitsRequest(
                            periodic_limits = [
    ...
    def testApiResponseOfCreateHostedVRPConsentRequest(self):
        """Test ApiResponseOfCreateHostedVRPConsentRequest"""
