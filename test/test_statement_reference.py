...
class TestStatementReference(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> StatementReference:
        """Test StatementReference
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatementReference`
        """
        model = StatementReference()  # noqa: E501
        if include_optional:
