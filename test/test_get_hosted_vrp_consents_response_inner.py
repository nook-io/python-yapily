...
from yapily.models.get_hosted_vrp_consents_response_inner import GetHostedVRPConsentsResponseInner  # noqa: E501

class TestGetHostedVRPConsentsResponseInner(unittest.TestCase):
    """GetHostedVRPConsentsResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetHostedVRPConsentsResponseInner:
        """Test GetHostedVRPConsentsResponseInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetHostedVRPConsentsResponseInner`
        """
        model = GetHostedVRPConsentsResponseInner()  # noqa: E501
        if include_optional:
            return GetHostedVRPConsentsResponseInner(
                id = '',
                application_id = '',
    ...
    def testGetHostedVRPConsentsResponseInner(self):
        """Test GetHostedVRPConsentsResponseInner"""
