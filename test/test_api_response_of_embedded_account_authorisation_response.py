...
from yapily.models.api_response_of_embedded_account_authorisation_response import ApiResponseOfEmbeddedAccountAuthorisationResponse  # noqa: E501

class TestApiResponseOfEmbeddedAccountAuthorisationResponse(unittest.TestCase):
    """ApiResponseOfEmbeddedAccountAuthorisationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseOfEmbeddedAccountAuthorisationResponse:
        """Test ApiResponseOfEmbeddedAccountAuthorisationResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseOfEmbeddedAccountAuthorisationResponse`
        """
        model = ApiResponseOfEmbeddedAccountAuthorisationResponse()  # noqa: E501
        if include_optional:
            return ApiResponseOfEmbeddedAccountAuthorisationResponse(
                meta = yapily.models.response_meta.ResponseMeta(
                    tracing_id = '', ),
                data = yapily.models.embedded_account_authorisation_response.EmbeddedAccountAuthorisationResponse(
                    id = '', 
                    user_uuid = '', 
                    application_user_id = '', 
                    reference_id = '', 
    ...
    def testApiResponseOfEmbeddedAccountAuthorisationResponse(self):
        """Test ApiResponseOfEmbeddedAccountAuthorisationResponse"""
