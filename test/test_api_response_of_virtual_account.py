...
class TestApiResponseOfVirtualAccount(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiResponseOfVirtualAccount:
        """Test ApiResponseOfVirtualAccount
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseOfVirtualAccount`
        """
        model = ApiResponseOfVirtualAccount()
        if include_optional:
