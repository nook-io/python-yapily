...
from yapily.models.vrp_setup_request import VRPSetupRequest  # noqa: E501


class TestVRPSetupRequest(unittest.TestCase):
    """VRPSetupRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VRPSetupRequest:
        """Test VRPSetupRequest
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `VRPSetupRequest`
        """
        model = VRPSetupRequest()  # noqa: E501
        if include_optional:
            return VRPSetupRequest(
