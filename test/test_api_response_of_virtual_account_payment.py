...
class TestApiResponseOfVirtualAccountPayment(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiResponseOfVirtualAccountPayment:
        """Test ApiResponseOfVirtualAccountPayment
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseOfVirtualAccountPayment`
        """
        model = ApiResponseOfVirtualAccountPayment()
        if include_optional:
