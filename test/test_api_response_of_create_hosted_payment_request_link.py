...
from yapily.models.api_response_of_create_hosted_payment_request_link import ApiResponseOfCreateHostedPaymentRequestLink  # noqa: E501

class TestApiResponseOfCreateHostedPaymentRequestLink(unittest.TestCase):
    """ApiResponseOfCreateHostedPaymentRequestLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseOfCreateHostedPaymentRequestLink:
        """Test ApiResponseOfCreateHostedPaymentRequestLink
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseOfCreateHostedPaymentRequestLink`
        """
        model = ApiResponseOfCreateHostedPaymentRequestLink()  # noqa: E501
        if include_optional:
            return ApiResponseOfCreateHostedPaymentRequestLink(
                meta = yapily.models.response_meta.ResponseMeta(
                    tracing_id = '', ),
                data = yapily.models.hosted_payment_request_response.HostedPaymentRequestResponse(
                    payment_request_id = '', 
                    user_id = '', 
                    application_user_id = '', 
                    application_id = '', 
    ...
    def testApiResponseOfCreateHostedPaymentRequestLink(self):
        """Test ApiResponseOfCreateHostedPaymentRequestLink"""
