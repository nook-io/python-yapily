...
class TestVirtualAccountClientRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VirtualAccountClientRequest:
        """Test VirtualAccountClientRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VirtualAccountClientRequest`
        """
        model = VirtualAccountClientRequest()
        if include_optional:
