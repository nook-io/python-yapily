...
class TestBalancePredictionProfile(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BalancePredictionProfile:
        """Test BalancePredictionProfile
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BalancePredictionProfile`
        """
        model = BalancePredictionProfile()
        if include_optional:
