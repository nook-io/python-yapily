...
from yapily.models.terminated_transaction_stream import TerminatedTransactionStream  # noqa: E501
...
class TestTerminatedTransactionStream(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TerminatedTransactionStream:
        """Test TerminatedTransactionStream
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `TerminatedTransactionStream`
        """
        model = TerminatedTransactionStream()  # noqa: E501
        if include_optional:
