...
from yapily.models.transaction_charge_details import TransactionChargeDetails  # noqa: E501
...
class TestTransactionChargeDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TransactionChargeDetails:
        """Test TransactionChargeDetails
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionChargeDetails`
        """
