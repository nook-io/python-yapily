...
class TestFilteredClientPayloadListCategory(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FilteredClientPayloadListCategory:
        """Test FilteredClientPayloadListCategory
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `FilteredClientPayloadListCategory`
        """
        model = FilteredClientPayloadListCategory()  # noqa: E501
        if include_optional:
    ...
    def testFilteredClientPayloadListCategory(self):
        """Test FilteredClientPayloadListCategory"""
