...
class TestVirtualAccountPayInDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VirtualAccountPayInDetails:
        """Test VirtualAccountPayInDetails
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VirtualAccountPayInDetails`
        """
        model = VirtualAccountPayInDetails()
        if include_optional:
