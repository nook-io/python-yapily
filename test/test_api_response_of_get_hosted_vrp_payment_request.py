...
from yapily.models.api_response_of_get_hosted_vrp_payment_request import ApiResponseOfGetHostedVRPPaymentRequest  # noqa: E501

class TestApiResponseOfGetHostedVRPPaymentRequest(unittest.TestCase):
    """ApiResponseOfGetHostedVRPPaymentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseOfGetHostedVRPPaymentRequest:
        """Test ApiResponseOfGetHostedVRPPaymentRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseOfGetHostedVRPPaymentRequest`
        """
        model = ApiResponseOfGetHostedVRPPaymentRequest()  # noqa: E501
        if include_optional:
            return ApiResponseOfGetHostedVRPPaymentRequest(
    ...
    def testApiResponseOfGetHostedVRPPaymentRequest(self):
        """Test ApiResponseOfGetHostedVRPPaymentRequest"""
