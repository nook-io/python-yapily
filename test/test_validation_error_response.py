...
from yapily.models.validation_error_response import ValidationErrorResponse  # noqa: E501
...
class TestValidationErrorResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ValidationErrorResponse:
        ...
        """
        model = ValidationErrorResponse()  # noqa: E501
        if include_optional:
            return ValidationErrorResponse(
                errors = [
                    yapily.models.validation_error.ValidationError(
                        field_name = '', 
                        error = 'MANDATORY', )
                    ]
            )
