...
class TestPaymentEmbeddedAuthorisationRequestResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentEmbeddedAuthorisationRequestResponse:
        """Test PaymentEmbeddedAuthorisationRequestResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentEmbeddedAuthorisationRequestResponse`
        """
        model = PaymentEmbeddedAuthorisationRequestResponse()
        if include_optional:
