...
from yapily.models.hosted_vrp_consent_request_response import HostedVRPConsentRequestResponse  # noqa: E501

class TestHostedVRPConsentRequestResponse(unittest.TestCase):
    """HostedVRPConsentRequestResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HostedVRPConsentRequestResponse:
        """Test HostedVRPConsentRequestResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HostedVRPConsentRequestResponse`
        """
        model = HostedVRPConsentRequestResponse()  # noqa: E501
        if include_optional:
            return HostedVRPConsentRequestResponse(
                id = '',
                user_id = '',
                application_user_id = '',
                application_id = '',
    ...
    def testHostedVRPConsentRequestResponse(self):
        """Test HostedVRPConsentRequestResponse"""
