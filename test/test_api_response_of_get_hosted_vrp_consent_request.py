...
from yapily.models.api_response_of_get_hosted_vrp_consent_request import ApiResponseOfGetHostedVRPConsentRequest  # noqa: E501

class TestApiResponseOfGetHostedVRPConsentRequest(unittest.TestCase):
    """ApiResponseOfGetHostedVRPConsentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseOfGetHostedVRPConsentRequest:
        """Test ApiResponseOfGetHostedVRPConsentRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseOfGetHostedVRPConsentRequest`
        """
        model = ApiResponseOfGetHostedVRPConsentRequest()  # noqa: E501
        if include_optional:
            return ApiResponseOfGetHostedVRPConsentRequest(
    ...
    def testApiResponseOfGetHostedVRPConsentRequest(self):
        """Test ApiResponseOfGetHostedVRPConsentRequest"""
