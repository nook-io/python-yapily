...
from yapily.models.hosted_vrp_consent_details import HostedVRPConsentDetails  # noqa: E501


class TestHostedVRPConsentDetails(unittest.TestCase):
    """HostedVRPConsentDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HostedVRPConsentDetails:
        """Test HostedVRPConsentDetails
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HostedVRPConsentDetails`
        """
        model = HostedVRPConsentDetails()  # noqa: E501
        if include_optional:
            return HostedVRPConsentDetails(
                id = '',
                user_id = '',
                application_user_id = '',
                application_id = '',
    ...
    def testHostedVRPConsentDetails(self):
        """Test HostedVRPConsentDetails"""
