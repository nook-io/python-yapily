...
class TestApiListResponseOfConsent(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiListResponseOfConsent:
        """Test ApiListResponseOfConsent
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiListResponseOfConsent`
        """
        model = ApiListResponseOfConsent()  # noqa: E501
        if include_optional:
            return ApiListResponseOfConsent(
                ...
                paging = yapily.models.filtered_client_payload_list_consent.FilteredClientPayloadListConsent(
