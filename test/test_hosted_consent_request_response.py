...
class TestHostedConsentRequestResponse(unittest.TestCase):
    """HostedConsentRequestResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HostedConsentRequestResponse:
        """Test HostedConsentRequestResponse
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HostedConsentRequestResponse`
        """
        model = HostedConsentRequestResponse()
        if include_optional:
            return HostedConsentRequestResponse(
                consent_request_id = '',
                user_id = '',
                application_user_id = '',
                application_id = '',
    ...
    def testHostedConsentRequestResponse(self):
        """Test HostedConsentRequestResponse"""
