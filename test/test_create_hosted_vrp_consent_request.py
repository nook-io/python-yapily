...
from yapily.models.create_hosted_vrp_consent_request import CreateHostedVRPConsentRequest  # noqa: E501

class TestCreateHostedVRPConsentRequest(unittest.TestCase):
    """CreateHostedVRPConsentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateHostedVRPConsentRequest:
        """Test CreateHostedVRPConsentRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateHostedVRPConsentRequest`
        """
        model = CreateHostedVRPConsentRequest()  # noqa: E501
        if include_optional:
            return CreateHostedVRPConsentRequest(
                user_id = '',
                application_user_id = '',
    ...
    def testCreateHostedVRPConsentRequest(self):
        """Test CreateHostedVRPConsentRequest"""
