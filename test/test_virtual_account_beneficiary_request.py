...
class TestVirtualAccountBeneficiaryRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VirtualAccountBeneficiaryRequest:
        """Test VirtualAccountBeneficiaryRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VirtualAccountBeneficiaryRequest`
        """
        model = VirtualAccountBeneficiaryRequest()
        if include_optional:
