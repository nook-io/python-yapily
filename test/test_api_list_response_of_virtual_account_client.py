...
class TestApiListResponseOfVirtualAccountClient(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiListResponseOfVirtualAccountClient:
        """Test ApiListResponseOfVirtualAccountClient
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiListResponseOfVirtualAccountClient`
        """
        model = ApiListResponseOfVirtualAccountClient()
        if include_optional:
