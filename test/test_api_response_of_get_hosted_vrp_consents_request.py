...
from yapily.models.api_response_of_get_hosted_vrp_consents_request import ApiResponseOfGetHostedVRPConsentsRequest  # noqa: E501

class TestApiResponseOfGetHostedVRPConsentsRequest(unittest.TestCase):
    """ApiResponseOfGetHostedVRPConsentsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseOfGetHostedVRPConsentsRequest:
        """Test ApiResponseOfGetHostedVRPConsentsRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseOfGetHostedVRPConsentsRequest`
        """
        model = ApiResponseOfGetHostedVRPConsentsRequest()  # noqa: E501
        if include_optional:
            return ApiResponseOfGetHostedVRPConsentsRequest(
                meta = yapily.models.response_meta.ResponseMeta(
                    tracing_id = '', ),
                data = [
                    yapily.models.get_hosted_vrp_consents_response_inner.GetHostedVRPConsentsResponse_inner(
                        id = '', 
                        application_id = '', 
    ...
    def testApiResponseOfGetHostedVRPConsentsRequest(self):
        """Test ApiResponseOfGetHostedVRPConsentsRequest"""
