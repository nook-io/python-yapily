...
class TestPaymentAuthorisationRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentAuthorisationRequest:
        """Test PaymentAuthorisationRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentAuthorisationRequest`
        """
        model = PaymentAuthorisationRequest()  # noqa: E501
        if include_optional:
