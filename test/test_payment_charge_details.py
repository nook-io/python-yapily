...
class TestPaymentChargeDetails(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaymentChargeDetails:
        """Test PaymentChargeDetails
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentChargeDetails`
        """
        model = PaymentChargeDetails()  # noqa: E501
        if include_optional:
