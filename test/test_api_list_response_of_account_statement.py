...
class TestApiListResponseOfAccountStatement(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiListResponseOfAccountStatement:
        """Test ApiListResponseOfAccountStatement
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiListResponseOfAccountStatement`
        """
        model = ApiListResponseOfAccountStatement()  # noqa: E501
        if include_optional:
            return ApiListResponseOfAccountStatement(
                ...
                paging = yapily.models.filtered_client_payload_list_account_statement.FilteredClientPayloadListAccountStatement(
