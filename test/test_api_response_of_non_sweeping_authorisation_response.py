...
from yapily.models.api_response_of_non_sweeping_authorisation_response import ApiResponseOfNonSweepingAuthorisationResponse  # noqa: E501
...
class TestApiResponseOfNonSweepingAuthorisationResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiResponseOfNonSweepingAuthorisationResponse:
        """Test ApiResponseOfNonSweepingAuthorisationResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseOfNonSweepingAuthorisationResponse`
        """
        ...
        if include_optional:
            return ApiResponseOfNonSweepingAuthorisationResponse(
                meta = yapily.models.response_meta.ResponseMeta(
                    tracing_id = '', ),
                data = yapily.models.non_sweeping_authorisation_response.NonSweepingAuthorisationResponse(
                    id = '', 
                    user_id = '', 
                    application_user_id = '', 
                    institution_id = '', 
