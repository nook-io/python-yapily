...
from yapily.models.hosted_payment_details import HostedPaymentDetails  # noqa: E501


class TestHostedPaymentDetails(unittest.TestCase):
    """HostedPaymentDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HostedPaymentDetails:
        """Test HostedPaymentDetails
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `HostedPaymentDetails`
        """
        model = HostedPaymentDetails()  # noqa: E501
        if include_optional:
            return HostedPaymentDetails(
                payment_request_id = '',
                user_id = '',
                application_user_id = '',
                application_id = '',
    ...
    def testHostedPaymentDetails(self):
        """Test HostedPaymentDetails"""
