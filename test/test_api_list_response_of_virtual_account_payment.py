...
class TestApiListResponseOfVirtualAccountPayment(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ApiListResponseOfVirtualAccountPayment:
        """Test ApiListResponseOfVirtualAccountPayment
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiListResponseOfVirtualAccountPayment`
        """
        model = ApiListResponseOfVirtualAccountPayment()
        if include_optional:
