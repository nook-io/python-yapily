...
from yapily.models.post_accounts_account_id_transactions_categorisation400_response_error import PostAccountsAccountIdTransactionsCategorisation400ResponseError  # noqa: E501
...
class TestPostAccountsAccountIdTransactionsCategorisation400ResponseError(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PostAccountsAccountIdTransactionsCategorisation400ResponseError:
        ...
        # uncomment below to create an instance of `PostAccountsAccountIdTransactionsCategorisation400ResponseError`
        """
        model = PostAccountsAccountIdTransactionsCategorisation400ResponseError()  # noqa: E501
        if include_optional:
            return PostAccountsAccountIdTransactionsCategorisation400ResponseError(
                tracing_id = '',
                code = 1.337,
                status = '',
                support_url = '',
    ...
    def testPostAccountsAccountIdTransactionsCategorisation400ResponseError(self):
        """Test PostAccountsAccountIdTransactionsCategorisation400ResponseError"""
