...
from yapily.models.filtered_client_payload_list_payment_response import FilteredClientPayloadListPaymentResponse  # noqa: E501

class TestFilteredClientPayloadListPaymentResponse(unittest.TestCase):
    """FilteredClientPayloadListPaymentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilteredClientPayloadListPaymentResponse:
        """Test FilteredClientPayloadListPaymentResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilteredClientPayloadListPaymentResponse`
        """
        model = FilteredClientPayloadListPaymentResponse()  # noqa: E501
        if include_optional:
            return FilteredClientPayloadListPaymentResponse(
    ...
    def testFilteredClientPayloadListPaymentResponse(self):
        """Test FilteredClientPayloadListPaymentResponse"""
