...
class TestAccountIdentification(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AccountIdentification:
        """Test AccountIdentification
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountIdentification`
        """
        model = AccountIdentification()  # noqa: E501
        if include_optional:
