...
from openapi_client.models.api_response_of_user_delete_response import ApiResponseOfUserDeleteResponse  # noqa: E501
...
class TestApiResponseOfUserDeleteResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.api_response_of_user_delete_response.ApiResponseOfUserDeleteResponse()  # noqa: E501
        if include_optional :
            return ApiResponseOfUserDeleteResponse(
                meta = openapi_client.models.response_meta.ResponseMeta(
                    tracing_id = '0', ), 
                data = openapi_client.models.user_delete_response.UserDeleteResponse(
                    id = '0', 
                    delete_status = 'SUCCESS', 
                    creation_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    user_consents = [
                        openapi_client.models.consent_delete_response.ConsentDeleteResponse(
                            id = '0', 
                            institution_id = '0', 
