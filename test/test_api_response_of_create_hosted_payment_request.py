...
from yapily.models.api_response_of_create_hosted_payment_request import ApiResponseOfCreateHostedPaymentRequest  # noqa: E501

class TestApiResponseOfCreateHostedPaymentRequest(unittest.TestCase):
    """ApiResponseOfCreateHostedPaymentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiResponseOfCreateHostedPaymentRequest:
        """Test ApiResponseOfCreateHostedPaymentRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiResponseOfCreateHostedPaymentRequest`
        """
        model = ApiResponseOfCreateHostedPaymentRequest()  # noqa: E501
        if include_optional:
            return ApiResponseOfCreateHostedPaymentRequest(
    ...
    def testApiResponseOfCreateHostedPaymentRequest(self):
        """Test ApiResponseOfCreateHostedPaymentRequest"""
