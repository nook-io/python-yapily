...
from yapily.models.request_constraints import RequestConstraints  # noqa: E501

class TestRequestConstraints(unittest.TestCase):
    """RequestConstraints unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RequestConstraints:
        """Test RequestConstraints
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RequestConstraints`
        """
        model = RequestConstraints()  # noqa: E501
        if include_optional:
            return RequestConstraints(
                headers = yapily.models.schema.Schema(
                    ...
                    x_yapily_validations = yapily.models.schema_x_yapily_validations.Schema_x_yapily_validations(
                        max_duration_from_now = '', ), ),
                body = yapily.models.schema.Schema(
                    title = '', 
                    maximum = 1.337, 
                    exclusive_maximum = 1.337, 
                    minimum = 1.337, 
    ...
    def testRequestConstraints(self):
        """Test RequestConstraints"""
