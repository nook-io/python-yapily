...
class TestMonitoringEndpointStatus(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MonitoringEndpointStatus:
        """Test MonitoringEndpointStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonitoringEndpointStatus`
        """
        model = MonitoringEndpointStatus()
        if include_optional:
